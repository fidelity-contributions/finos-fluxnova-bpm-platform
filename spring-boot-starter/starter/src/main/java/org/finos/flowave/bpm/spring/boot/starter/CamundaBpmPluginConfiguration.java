...
import org.finos.flowave.bpm.spring.boot.starter.plugin.ApplicationContextClassloaderSwitchPlugin;
import org.finos.flowave.bpm.spring.boot.starter.spin.CamundaJacksonFormatConfiguratorJSR310;
import org.finos.flowave.bpm.spring.boot.starter.spin.CamundaJacksonFormatConfiguratorJdk8;
import org.finos.flowave.bpm.spring.boot.starter.spin.CamundaJacksonFormatConfiguratorParameterNames;
import org.finos.flowave.bpm.spring.boot.starter.spin.SpringBootSpinProcessEnginePlugin;
import org.finos.flowave.connect.plugin.impl.ConnectProcessEnginePlugin;
import org.finos.flowave.spin.impl.json.jackson.format.JacksonJsonDataFormat;
import org.finos.flowave.spin.plugin.impl.SpinProcessEnginePlugin;
