 ...
 */
package org.finos.flowave.bpm.spring.boot.starter.util;

import org.finos.flowave.bpm.engine.filter.Filter;
import org.finos.flowave.bpm.engine.identity.User;
import org.finos.flowave.bpm.spring.boot.starter.property.GenericProperties;
...
public class SpringBootProcessEngineLogger extends BaseLogger {
  ...
  public static final String PACKAGE = "org.finos.flowave.bpm.spring.boot";
