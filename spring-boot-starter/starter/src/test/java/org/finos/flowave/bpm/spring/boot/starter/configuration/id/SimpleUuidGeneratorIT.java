 ...
 */
package org.finos.flowave.bpm.spring.boot.starter.configuration.id;
...
import static org.finos.flowave.bpm.spring.boot.starter.configuration.id.IdGeneratorConfiguration.SIMPLE;

@RunWith(SpringRunner.class)
@SpringBootTest(classes = { TestApplication.class }, properties = "flowave.bpm.id-generator=" + SIMPLE)
