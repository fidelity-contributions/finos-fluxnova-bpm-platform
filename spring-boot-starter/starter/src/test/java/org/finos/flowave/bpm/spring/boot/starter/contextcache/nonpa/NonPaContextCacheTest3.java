 ...
 */
package org.finos.flowave.bpm.spring.boot.starter.contextcache.nonpa;

import org.finos.flowave.bpm.engine.runtime.ProcessInstance;
import org.finos.flowave.bpm.spring.boot.starter.contextcache.AbstractContextCacheTest;
...
public class NonPaContextCacheTest3 extends AbstractContextCacheTest {
  ...
  public void testContextCaching() {
    ...
    assertThat(appContextHash).isEqualTo(contextMap.get("nonPaTest1"));
    assertThat(appContextHash).isNotEqualTo(contextMap.get("nonPaTest2"));
  }
