 ...
 */
package org.finos.flowave.bpm.spring.boot.starter.jdbc;
...
public class HistoryLevelDeterminatorJdbcTemplateImplTestApplication {
  ...
  public DataSource dataSource() {
    ...
    EmbeddedDatabase db = builder.setName("testdbForHistoryLevelDetermination").setType(EmbeddedDatabaseType.H2)
        .addScript("/org/finos/flowave/bpm/engine/db/create/activiti.h2.create.engine.sql").addScript("db/sql/insert-history-data.sql").continueOnError(true).build();
    return db;
  }
