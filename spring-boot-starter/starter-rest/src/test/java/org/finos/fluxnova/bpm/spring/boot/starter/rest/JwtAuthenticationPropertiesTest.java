...
class JwtAuthenticationPropertiesTest {
  ...
  @Test
  void shouldHaveSubClaimByDefault() {
    assertThat(new JwtAuthenticationProperties().getUserClaimName()).isEqualTo("sub");
  }

  @Test
  void shouldHaveNoGroupsClaimByDefault() {
    assertThat(new JwtAuthenticationProperties().getGroupsClaimName()).isNull();
  }
}
