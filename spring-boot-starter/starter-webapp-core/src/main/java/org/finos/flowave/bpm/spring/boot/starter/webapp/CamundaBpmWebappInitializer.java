 ...
 */
package org.finos.flowave.bpm.spring.boot.starter.webapp;
...
import org.finos.flowave.bpm.admin.impl.web.AdminApplication;
import org.finos.flowave.bpm.admin.impl.web.bootstrap.AdminContainerBootstrap;
import org.finos.flowave.bpm.cockpit.impl.web.CockpitApplication;
import org.finos.flowave.bpm.cockpit.impl.web.bootstrap.CockpitContainerBootstrap;
import org.finos.flowave.bpm.engine.rest.filter.CacheControlFilter;
import org.finos.flowave.bpm.engine.rest.filter.EmptyBodyFilter;
import org.finos.flowave.bpm.spring.boot.starter.property.CamundaBpmProperties;
import org.finos.flowave.bpm.spring.boot.starter.property.WebappProperty;
import org.finos.flowave.bpm.spring.boot.starter.webapp.filter.AppendTrailingSlashFilter;
import org.finos.flowave.bpm.spring.boot.starter.webapp.filter.LazyProcessEnginesFilter;
import org.finos.flowave.bpm.spring.boot.starter.webapp.filter.LazySecurityFilter;
import org.finos.flowave.bpm.tasklist.impl.web.TasklistApplication;
import org.finos.flowave.bpm.tasklist.impl.web.bootstrap.TasklistContainerBootstrap;
import org.finos.flowave.bpm.webapp.impl.engine.EngineRestApplication;
import org.finos.flowave.bpm.webapp.impl.security.auth.AuthenticationFilter;
import org.finos.flowave.bpm.webapp.impl.security.filter.CsrfPreventionFilter;
import org.finos.flowave.bpm.webapp.impl.security.filter.SessionCookieFilter;
import org.finos.flowave.bpm.webapp.impl.security.filter.headersec.HttpHeaderSecurityFilter;
import org.finos.flowave.bpm.webapp.impl.security.filter.util.HttpSessionMutexListener;
import org.finos.flowave.bpm.webapp.impl.util.ServletContextUtil;
import org.finos.flowave.bpm.welcome.impl.web.WelcomeApplication;
import org.finos.flowave.bpm.welcome.impl.web.bootstrap.WelcomeContainerBootstrap;
