 ...
 */
package org.finos.flowave.bpm.spring.boot.starter.webapp.apppath;

import org.finos.flowave.bpm.spring.boot.starter.webapp.WebappTestApp;
import org.finos.flowave.bpm.spring.boot.starter.webapp.filter.util.HttpClientRule;
...
import static org.finos.flowave.bpm.webapp.impl.security.filter.headersec.provider.impl.ContentSecurityPolicyProvider.HEADER_DEFAULT_VALUE;
import static org.finos.flowave.bpm.webapp.impl.security.filter.headersec.provider.impl.ContentSecurityPolicyProvider.HEADER_NAME;
import static org.finos.flowave.bpm.webapp.impl.security.filter.headersec.provider.impl.ContentSecurityPolicyProvider.HEADER_NONCE_PLACEHOLDER;
...
@TestPropertySource(properties = {
    "flowave.bpm.webapp.applicationPath=" + ChangedAppPathIT.MY_APP_PATH
})
