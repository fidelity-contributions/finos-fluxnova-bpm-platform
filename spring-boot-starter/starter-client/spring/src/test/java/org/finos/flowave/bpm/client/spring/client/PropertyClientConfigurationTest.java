...
import org.finos.flowave.bpm.client.spring.client.configuration.PropertyPlaceholderConfiguration;
...
public class PropertyClientConfigurationTest extends MockedTest {
  ...
  public void shouldVerifyPropertiesSet() {
    ...
    verify(clientBuilder).defaultSerializationFormat("serialization-format");
