 ...
 */
package org.finos.flowave.bpm.client.spring.client;
...
import org.finos.flowave.bpm.client.spring.MockedTest;
import org.finos.flowave.bpm.client.spring.client.configuration.RequestInterceptorConfiguration;
import org.finos.flowave.bpm.client.spring.configuration.SimpleClientConfiguration;
...
public class RequestInterceptorConfigurationTest extends MockedTest {
  ...
  @Autowired
  @Qualifier("interceptorOne")
  public ClientRequestInterceptor interceptorOne;

  @Autowired
  @Qualifier("interceptorTwo")
