...
public class EngineRule implements BeforeEachCallback, AfterEachCallback {
  ...
  protected String getEngineUrl() {
    return properties.get("fluxnova.engine.rest").toString() +
        properties.get("fluxnova.engine.name").toString();
  }
