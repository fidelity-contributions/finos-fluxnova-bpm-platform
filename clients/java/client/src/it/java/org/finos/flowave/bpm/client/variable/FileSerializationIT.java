 ...
 */
package org.finos.flowave.bpm.client.variable;

import static org.assertj.core.api.Assertions.assertThat;
import static org.finos.flowave.bpm.client.util.ProcessModels.EXTERNAL_TASK_TOPIC_BAR;
import static org.finos.flowave.bpm.client.util.ProcessModels.EXTERNAL_TASK_TOPIC_FOO;
import static org.finos.flowave.bpm.client.util.ProcessModels.PROCESS_KEY_2;
import static org.finos.flowave.bpm.client.util.ProcessModels.TWO_EXTERNAL_TASK_PROCESS;
import static org.finos.flowave.bpm.client.util.ProcessModels.USER_TASK_ID;
import static org.finos.flowave.bpm.client.util.ProcessModels.createProcessWithExclusiveGateway;
import static org.finos.flowave.bpm.engine.variable.type.ValueType.FILE;
...
import org.finos.flowave.bpm.client.dto.ProcessDefinitionDto;
import org.finos.flowave.bpm.client.dto.ProcessInstanceDto;
import org.finos.flowave.bpm.client.dto.TaskDto;
import org.finos.flowave.bpm.client.dto.VariableInstanceDto;
import org.finos.flowave.bpm.client.exception.ValueMapperException;
import org.finos.flowave.bpm.client.rule.ClientRule;
import org.finos.flowave.bpm.client.rule.EngineRule;
import org.finos.flowave.bpm.client.task.ExternalTask;
import org.finos.flowave.bpm.client.task.ExternalTaskService;
import org.finos.flowave.bpm.client.util.RecordingExternalTaskHandler;
import org.finos.flowave.bpm.client.util.RecordingInvocationHandler;
import org.finos.flowave.bpm.client.util.RecordingInvocationHandler.RecordedInvocation;
import org.finos.flowave.bpm.client.variable.impl.value.DeferredFileValueImpl;
import org.finos.flowave.bpm.client.variable.value.DeferredFileValue;
