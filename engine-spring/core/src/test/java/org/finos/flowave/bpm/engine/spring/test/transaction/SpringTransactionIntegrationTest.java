 ...
 */
package org.finos.flowave.bpm.engine.spring.test.transaction;
...
import org.finos.flowave.bpm.engine.spring.test.SpringProcessEngineTestCase;
 ...
 * @author Tom Baeyens
 */
@ContextConfiguration("classpath:org/finos/flowave/bpm/engine/spring/test/transaction/SpringTransactionIntegrationTest-context.xml")
public class SpringTransactionIntegrationTest extends SpringProcessEngineTestCase {
  ...
  @Deployment(resources={
          "org/finos/flowave/bpm/engine/spring/test/transaction/SpringTransactionIntegrationTest.testErrorPropagationOnExceptionInTransaction.bpmn20.xml",
          "org/finos/flowave/bpm/engine/spring/test/transaction/SpringTransactionIntegrationTest.throwExceptionProcess.bpmn20.xml"
  })
