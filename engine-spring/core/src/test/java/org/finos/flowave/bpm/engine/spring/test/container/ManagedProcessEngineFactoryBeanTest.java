 ...
 */
package org.finos.flowave.bpm.engine.spring.test.container;

import org.finos.flowave.bpm.BpmPlatform;
import org.finos.flowave.bpm.engine.spring.container.ManagedProcessEngineFactoryBean;
...
public class ManagedProcessEngineFactoryBeanTest {
  ...
  public void testProcessApplicationDeployment() {
    ...
    AbstractApplicationContext applicationContext = new ClassPathXmlApplicationContext("org/finos/flowave/bpm/engine/spring/test/container/ManagedProcessEngineFactoryBean-context.xml");
