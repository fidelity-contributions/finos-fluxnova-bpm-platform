 ...
 */
package org.finos.flowave.bpm.engine.spring.test.dmn;
...
@ContextConfiguration(locations = {
        "classpath:org/finos/flowave/bpm/engine/spring/test/dmn/DmnJuelTest-applicationContext.xml"})
public class DmnJuelTest {
  ...
  public void deploy() {
    deploymentId = repositoryService.createDeployment()
        .addClasspathResource("org/finos/flowave/bpm/engine/spring/test/dmn/JuelTest.dmn")
        .deploy()
        .getId();
  }
