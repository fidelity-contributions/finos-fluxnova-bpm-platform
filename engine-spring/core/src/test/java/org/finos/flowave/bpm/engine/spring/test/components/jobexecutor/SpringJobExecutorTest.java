 ...
 */
package org.finos.flowave.bpm.engine.spring.test.components.jobexecutor;
 ...
 * @author Pablo Ganga
 */
@ContextConfiguration("classpath:org/finos/flowave/bpm/engine/spring/test/components/SpringjobExecutorTest-context.xml")
public class SpringJobExecutorTest extends SpringProcessEngineTestCase {

  @Deployment(resources={"org/finos/flowave/bpm/engine/spring/test/components/SpringTimersProcess.bpmn20.xml",
          "org/finos/flowave/bpm/engine/spring/test/components/SpringJobExecutorRollBack.bpmn20.xml"})
