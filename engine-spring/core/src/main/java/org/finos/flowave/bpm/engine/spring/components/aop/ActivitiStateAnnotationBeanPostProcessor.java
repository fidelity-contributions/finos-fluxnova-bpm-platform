 ...
 */
package org.finos.flowave.bpm.engine.spring.components.aop;
...
import org.finos.flowave.bpm.engine.spring.annotations.ProcessId;
import org.finos.flowave.bpm.engine.spring.annotations.ProcessVariable;
import org.finos.flowave.bpm.engine.spring.annotations.ProcessVariables;
import org.finos.flowave.bpm.engine.spring.annotations.State;
import org.finos.flowave.bpm.engine.spring.components.registry.ActivitiStateHandlerRegistration;
import org.finos.flowave.bpm.engine.spring.components.registry.ActivitiStateHandlerRegistry;
 ...
 * that have the {@link org.finos.flowave.bpm.engine.annotations.State} annotation.
 *
 * @author Josh Long
 * @since 5.3
 */
...
public class ActivitiStateAnnotationBeanPostProcessor implements BeanPostProcessor, BeanClassLoaderAware, BeanFactoryAware, InitializingBean, Ordered {
	...
	public Object postProcessAfterInitialization(final Object bean,
		...
		final org.finos.flowave.bpm.engine.spring.annotations.ProcessEngineComponent component = targetClass.getAnnotation(org.finos.flowave.bpm.engine.spring.annotations.ProcessEngineComponent.class);
