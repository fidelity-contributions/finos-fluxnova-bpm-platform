 ...
 */
package org.finos.flowave.bpm.engine.spring.application;

import java.util.logging.Level;
import java.util.logging.Logger;
import javax.servlet.ServletContext;
import org.finos.flowave.bpm.application.AbstractProcessApplication;
import org.finos.flowave.bpm.application.ProcessApplicationElResolver;
import org.finos.flowave.bpm.application.impl.EjbProcessApplication;
import org.finos.flowave.bpm.engine.spring.ApplicationContextElResolver;
 ...
 *    <li>Bootstrapping through {@link org.finos.flowave.bpm.application.impl.ServletProcessApplication}. In this case we have access to the {@link ServletContext}
...
public class SpringProcessApplicationElResolver implements ProcessApplicationElResolver {
  ...
  public ELResolver getElResolver(AbstractProcessApplication processApplication) {
    ...
    } else if (processApplication instanceof org.finos.flowave.bpm.application.impl.ServletProcessApplication) {
      // Using fully-qualified class name instead of import statement to allow for automatic transformation
      org.finos.flowave.bpm.application.impl.ServletProcessApplication servletProcessApplication = (org.finos.flowave.bpm.application.impl.ServletProcessApplication) processApplication;
