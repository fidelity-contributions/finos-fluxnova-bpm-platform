 ...
 */
package org.finos.flowave.bpm.engine.cdi.test.bpmn;
...
public class SignalEventTest extends CdiProcessEngineTestCase {
  ...
  @Test
  @Deployment(resources = {"org/finos/flowave/bpm/engine/cdi/test/bpmn/SignalEventTests.catchAlertSignalBoundaryWithReceiveTask.bpmn20.xml",
          "org/finos/flowave/bpm/engine/cdi/test/bpmn/SignalEventTests.throwAlertSignalWithDelegate.bpmn20.xml"})
