 ...
 */
package org.finos.flowave.bpm.engine.cdi.test.api;
...
import org.finos.flowave.bpm.engine.cdi.ProcessEngineCdiException;
...
public class BusinessProcessBeanTest extends CdiProcessEngineTestCase {
  ...
  @Test
  @Deployment(resources = "org/finos/flowave/bpm/engine/cdi/test/api/BusinessProcessBeanTest.test.bpmn20.xml")
