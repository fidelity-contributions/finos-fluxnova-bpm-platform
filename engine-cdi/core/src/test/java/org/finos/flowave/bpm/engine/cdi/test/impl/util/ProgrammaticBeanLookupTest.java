 ...
 */
package org.finos.flowave.bpm.engine.cdi.test.impl.util;
...
import org.finos.flowave.bpm.engine.cdi.impl.ProcessEngineServicesProducer;
import org.finos.flowave.bpm.engine.cdi.impl.util.ProgrammaticBeanLookup;
import org.finos.flowave.bpm.engine.cdi.test.impl.beans.SpecializedTestBean;
...
public class ProgrammaticBeanLookupTest {
  ...
  public static JavaArchive createDeployment() {
    return ShrinkWrap.create(JavaArchive.class)
        ...
        .addAsManifestResource("org/finos/flowave/bpm/engine/cdi/test/impl/util/beans.xml", "beans.xml");
  }
  ...
  public static JavaArchive createDeploymentWithAlternative() {
    return ShrinkWrap.create(JavaArchive.class)
        ...
        .addAsManifestResource("org/finos/flowave/bpm/engine/cdi/test/impl/util/beansWithAlternative.xml", "beans.xml");
  }
