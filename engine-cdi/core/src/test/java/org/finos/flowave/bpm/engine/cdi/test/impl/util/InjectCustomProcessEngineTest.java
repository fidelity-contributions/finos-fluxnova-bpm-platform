...
import org.finos.flowave.bpm.engine.cdi.test.impl.beans.InjectedProcessEngineBean;
...
public class InjectCustomProcessEngineTest extends CdiProcessEngineTestCase {
  ...
  @Before
  public void init() {
    processEngine = TestHelper.getProcessEngine("org/finos/flowave/bpm/engine/cdi/test/impl/util/camunda.cfg.xml");
