 ...
 */
package org.finos.flowave.bpm.container.impl.threading.ra.inflow;
...
import org.finos.flowave.bpm.container.impl.threading.ra.JcaExecutorServiceConnector;
...
import org.finos.flowave.bpm.engine.impl.jobexecutor.ExecuteJobsRunnable;
...
public class JcaInflowExecuteJobsRunnable extends ExecuteJobsRunnable {
   ...
   * @see org.finos.flowave.bpm.engine.impl.jobexecutor.ExecuteJobsRunnable#switchClassLoader()
   *
