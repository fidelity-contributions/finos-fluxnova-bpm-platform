...
import org.finos.flowave.bpm.dmn.feel.impl.scala.function.CustomFunctionTransformer;
import org.finos.flowave.bpm.dmn.feel.impl.scala.function.FeelCustomFunctionProvider;
import org.finos.flowave.bpm.dmn.feel.impl.scala.spin.SpinValueMapperFactory;
import org.finos.flowave.bpm.engine.variable.context.VariableContext;
import org.finos.flowave.feel.FeelEngine$;
import org.finos.flowave.feel.FeelEngine.Builder;
import org.finos.flowave.feel.FeelEngine.Failure;
import org.finos.flowave.feel.context.CustomContext;
import org.finos.flowave.feel.context.VariableProvider;
import org.finos.flowave.feel.context.VariableProvider.StaticVariableProvider;
import org.finos.flowave.feel.impl.JavaValueMapper;
import org.finos.flowave.feel.valuemapper.CustomValueMapper;
import org.finos.flowave.feel.valuemapper.ValueMapper.CompositeValueMapper;
import flowavejar.impl.scala.collection.immutable.List;
import flowavejar.impl.scala.collection.immutable.Map;
import flowavejar.impl.scala.runtime.BoxesRunTime;
import flowavejar.impl.scala.util.Either;
import flowavejar.impl.scala.util.Left;
import flowavejar.impl.scala.util.Right;

import java.util.Arrays;

import static org.finos.flowave.feel.context.VariableProvider.CompositeVariableProvider;
import static flowavejar.impl.scala.jdk.CollectionConverters.ListHasAsScala;
...
public class ScalaFeelEngine implements FeelEngine {
  ...
  protected org.finos.flowave.feel.FeelEngine feelEngine;
  ...
  protected org.finos.flowave.feel.FeelEngine buildFeelEngine(CustomFunctionTransformer transformer,
