 ...
 */
package org.finos.flowave.bpm.engine.variable;
...
import org.finos.flowave.bpm.engine.variable.impl.context.EmptyVariableContext;
import org.finos.flowave.bpm.engine.variable.impl.value.AbstractTypedValue;
import org.finos.flowave.bpm.engine.variable.impl.value.FileValueImpl;
import org.finos.flowave.bpm.engine.variable.impl.value.NullValueImpl;
import org.finos.flowave.bpm.engine.variable.impl.value.UntypedValueImpl;
import org.finos.flowave.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.BooleanValueImpl;
import org.finos.flowave.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.BytesValueImpl;
import org.finos.flowave.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.DateValueImpl;
import org.finos.flowave.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.DoubleValueImpl;
import org.finos.flowave.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.IntegerValueImpl;
import org.finos.flowave.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.LongValueImpl;
import org.finos.flowave.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.NumberValueImpl;
import org.finos.flowave.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.ShortValueImpl;
import org.finos.flowave.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.StringValueImpl;
import org.finos.flowave.bpm.engine.variable.impl.value.builder.FileValueBuilderImpl;
import org.finos.flowave.bpm.engine.variable.impl.value.builder.ObjectVariableBuilderImpl;
import org.finos.flowave.bpm.engine.variable.impl.value.builder.SerializedObjectValueBuilderImpl;
import org.finos.flowave.bpm.engine.variable.type.ValueType;
import org.finos.flowave.bpm.engine.variable.value.BooleanValue;
import org.finos.flowave.bpm.engine.variable.value.BytesValue;
import org.finos.flowave.bpm.engine.variable.value.DateValue;
import org.finos.flowave.bpm.engine.variable.value.DoubleValue;
import org.finos.flowave.bpm.engine.variable.value.FileValue;
import org.finos.flowave.bpm.engine.variable.value.IntegerValue;
import org.finos.flowave.bpm.engine.variable.value.LongValue;
import org.finos.flowave.bpm.engine.variable.value.NumberValue;
import org.finos.flowave.bpm.engine.variable.value.ObjectValue;
import org.finos.flowave.bpm.engine.variable.value.SerializationDataFormat;
import org.finos.flowave.bpm.engine.variable.value.ShortValue;
...
import org.finos.flowave.bpm.engine.variable.value.builder.FileValueBuilder;
import org.finos.flowave.bpm.engine.variable.value.builder.ObjectValueBuilder;
import org.finos.flowave.bpm.engine.variable.value.builder.SerializedObjectValueBuilder;
import org.finos.flowave.bpm.engine.variable.value.builder.TypedValueBuilder;
