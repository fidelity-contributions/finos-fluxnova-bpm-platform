...
drop index ACT_RU_TASK.ACT_IDX_TASK_PARENT_TASK_ID;
...
drop index ACT_RU_JOB.ACT_IDX_JOB_ROOT_PROCINST;
...
if exists (select TABLE_NAME from INFORMATION_SCHEMA.TABLES where TABLE_NAME = 'ACT_GE_CONFIGURATION') drop table ACT_GE_CONFIGURATION;
