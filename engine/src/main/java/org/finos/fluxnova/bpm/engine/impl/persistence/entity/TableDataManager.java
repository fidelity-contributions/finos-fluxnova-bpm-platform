...
import org.finos.fluxnova.bpm.engine.history.HistoricFormProperty;
...
import org.finos.fluxnova.bpm.engine.impl.TablePageQueryImpl;
...
import org.finos.fluxnova.bpm.engine.impl.cmmn.entity.runtime.CaseSentryPartEntity;
import org.finos.fluxnova.bpm.engine.impl.db.DbEntity;
import org.finos.fluxnova.bpm.engine.impl.db.EnginePersistenceLogger;
...
import org.finos.fluxnova.bpm.engine.impl.history.event.HistoricDecisionInstanceEntity;
import org.finos.fluxnova.bpm.engine.impl.history.event.HistoricDecisionOutputInstanceEntity;
import org.finos.fluxnova.bpm.engine.impl.history.event.HistoricDetailEventEntity;
...
import org.finos.fluxnova.bpm.engine.impl.util.DatabaseUtil;
import org.finos.fluxnova.bpm.engine.management.TableMetaData;
import org.finos.fluxnova.bpm.engine.management.TablePage;
...
public class TableDataManager extends AbstractManager {
  ...
  static {
    ...
    persistentObjectToTableNameMap.put(ConfigurationEntity.class, "ACT_GE_CONFIGURATION");
