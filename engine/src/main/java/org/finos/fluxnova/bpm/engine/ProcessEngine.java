 ...
 * <ul>
 * <li>
 * <b>{@link org.finos.fluxnova.bpm.engine.RuntimeService}: </b> Allows the creation of
 * {@link org.finos.fluxnova.bpm.engine.repository.Deployment}s and the starting of and searching on
 * {@link org.finos.fluxnova.bpm.engine.runtime.ProcessInstance}s.</li>
 * <li>
 * <b>{@link org.finos.fluxnova.bpm.engine.TaskService}: </b> Exposes operations to manage human
 * (standalone) {@link org.finos.fluxnova.bpm.engine.task.Task}s, such as claiming, completing and
 * assigning tasks</li>
 * <li>
 * <b>{@link org.finos.fluxnova.bpm.engine.IdentityService}: </b> Used for managing
 * {@link org.finos.fluxnova.bpm.engine.identity.User}s, {@link org.finos.fluxnova.bpm.engine.identity.Group}s and
 * the relations between them<</li>
 * <li>
 * <b>{@link org.finos.fluxnova.bpm.engine.ManagementService}: </b> Exposes engine admin and
 * maintenance operations</li>
 *  <li>
 * <b>{@link org.finos.fluxnova.bpm.engine.HistoryService}: </b> Service exposing information about
 * ongoing and past process instances.</li>
 *
 * <li><b>{@link org.finos.fluxnova.bpm.engine.AuthorizationService}:</b> Service allowing
