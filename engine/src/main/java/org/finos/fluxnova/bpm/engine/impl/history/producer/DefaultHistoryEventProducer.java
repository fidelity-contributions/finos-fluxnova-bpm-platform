 ...
 */
package org.finos.fluxnova.bpm.engine.impl.history.producer;

import static org.finos.fluxnova.bpm.engine.ProcessEngineConfiguration.HISTORY_REMOVAL_TIME_STRATEGY_END;
import static org.finos.fluxnova.bpm.engine.ProcessEngineConfiguration.HISTORY_REMOVAL_TIME_STRATEGY_START;
import static org.finos.fluxnova.bpm.engine.impl.util.ExceptionUtil.createJobExceptionByteArray;
import static org.finos.fluxnova.bpm.engine.impl.util.ExceptionUtil.getExceptionStacktrace;
import static org.finos.fluxnova.bpm.engine.impl.util.StringUtil.toByteArray;
...
import org.finos.fluxnova.bpm.engine.history.ExternalTaskState;
import org.finos.fluxnova.bpm.engine.history.HistoricProcessInstance;
import org.finos.fluxnova.bpm.engine.history.IncidentState;
import org.finos.fluxnova.bpm.engine.history.JobState;
import org.finos.fluxnova.bpm.engine.impl.ProcessEngineLogger;
import org.finos.fluxnova.bpm.engine.impl.batch.BatchEntity;
import org.finos.fluxnova.bpm.engine.impl.batch.history.HistoricBatchEntity;
import org.finos.fluxnova.bpm.engine.impl.cfg.ConfigurationLogger;
...
import org.finos.fluxnova.bpm.engine.impl.history.event.HistoricActivityInstanceEventEntity;
import org.finos.fluxnova.bpm.engine.impl.history.event.HistoricExternalTaskLogEntity;
import org.finos.fluxnova.bpm.engine.impl.history.event.HistoricFormPropertyEventEntity;
import org.finos.fluxnova.bpm.engine.impl.history.event.HistoricIdentityLinkLogEventEntity;
import org.finos.fluxnova.bpm.engine.impl.history.event.HistoricIncidentEventEntity;
import org.finos.fluxnova.bpm.engine.impl.history.event.HistoricProcessInstanceEventEntity;
import org.finos.fluxnova.bpm.engine.impl.history.event.HistoricTaskInstanceEventEntity;
...
import org.finos.fluxnova.bpm.engine.impl.history.event.UserOperationLogEntryEventEntity;
import org.finos.fluxnova.bpm.engine.impl.jobexecutor.historycleanup.HistoryCleanupJobHandler;
import org.finos.fluxnova.bpm.engine.impl.migration.instance.MigratingActivityInstance;
import org.finos.fluxnova.bpm.engine.impl.oplog.UserOperationLogContext;
...
import org.finos.fluxnova.bpm.engine.impl.pvm.runtime.CompensationBehavior;
