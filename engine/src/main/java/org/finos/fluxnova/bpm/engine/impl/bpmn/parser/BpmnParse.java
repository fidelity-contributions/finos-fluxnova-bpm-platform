 ...
 */
package org.finos.fluxnova.bpm.engine.impl.bpmn.parser;

import static org.finos.fluxnova.bpm.engine.impl.bpmn.parser.BpmnParseUtil.findFluxnovaExtensionElement;
import static org.finos.fluxnova.bpm.engine.impl.bpmn.parser.BpmnParseUtil.parseFluxnovaExtensionProperties;
import static org.finos.fluxnova.bpm.engine.impl.bpmn.parser.BpmnParseUtil.parseFluxnovaScript;
import static org.finos.fluxnova.bpm.engine.impl.bpmn.parser.BpmnParseUtil.parseInputOutput;
import static org.finos.fluxnova.bpm.engine.impl.util.ClassDelegateUtil.instantiateDelegate;
...
import org.finos.fluxnova.bpm.engine.impl.bpmn.behavior.CallableElementActivityBehavior;
import org.finos.fluxnova.bpm.engine.impl.bpmn.behavior.CancelBoundaryEventActivityBehavior;
import org.finos.fluxnova.bpm.engine.impl.bpmn.behavior.CancelEndEventActivityBehavior;
import org.finos.fluxnova.bpm.engine.impl.bpmn.behavior.CaseCallActivityBehavior;
import org.finos.fluxnova.bpm.engine.impl.bpmn.behavior.ClassDelegateActivityBehavior;
import org.finos.fluxnova.bpm.engine.impl.bpmn.behavior.CompensationEventActivityBehavior;
...
import org.finos.fluxnova.bpm.engine.impl.bpmn.behavior.ExclusiveGatewayActivityBehavior;
import org.finos.fluxnova.bpm.engine.impl.bpmn.behavior.ExternalTaskActivityBehavior;
import org.finos.fluxnova.bpm.engine.impl.bpmn.behavior.InclusiveGatewayActivityBehavior;
import org.finos.fluxnova.bpm.engine.impl.bpmn.behavior.IntermediateCatchEventActivityBehavior;
import org.finos.fluxnova.bpm.engine.impl.bpmn.behavior.IntermediateCatchLinkEventActivityBehavior;
import org.finos.fluxnova.bpm.engine.impl.bpmn.behavior.IntermediateConditionalEventBehavior;
import org.finos.fluxnova.bpm.engine.impl.bpmn.behavior.IntermediateThrowNoneEventActivityBehavior;
import org.finos.fluxnova.bpm.engine.impl.bpmn.behavior.MailActivityBehavior;
import org.finos.fluxnova.bpm.engine.impl.bpmn.behavior.ManualTaskActivityBehavior;
import org.finos.fluxnova.bpm.engine.impl.bpmn.behavior.MultiInstanceActivityBehavior;
import org.finos.fluxnova.bpm.engine.impl.bpmn.behavior.NoneEndEventActivityBehavior;
import org.finos.fluxnova.bpm.engine.impl.bpmn.behavior.NoneStartEventActivityBehavior;
import org.finos.fluxnova.bpm.engine.impl.bpmn.behavior.ParallelGatewayActivityBehavior;
import org.finos.fluxnova.bpm.engine.impl.bpmn.behavior.ParallelMultiInstanceActivityBehavior;
import org.finos.fluxnova.bpm.engine.impl.bpmn.behavior.ReceiveTaskActivityBehavior;
import org.finos.fluxnova.bpm.engine.impl.bpmn.behavior.ScriptTaskActivityBehavior;
import org.finos.fluxnova.bpm.engine.impl.bpmn.behavior.SequentialMultiInstanceActivityBehavior;
...
import org.finos.fluxnova.bpm.engine.impl.bpmn.behavior.ShellActivityBehavior;
import org.finos.fluxnova.bpm.engine.impl.bpmn.behavior.SubProcessActivityBehavior;
import org.finos.fluxnova.bpm.engine.impl.bpmn.behavior.TaskActivityBehavior;
import org.finos.fluxnova.bpm.engine.impl.bpmn.behavior.TerminateEndEventActivityBehavior;
import org.finos.fluxnova.bpm.engine.impl.bpmn.behavior.ThrowEscalationEventActivityBehavior;
import org.finos.fluxnova.bpm.engine.impl.bpmn.behavior.ThrowSignalEventActivityBehavior;
...
import org.finos.fluxnova.bpm.engine.impl.bpmn.listener.ClassDelegateExecutionListener;
import org.finos.fluxnova.bpm.engine.impl.bpmn.listener.DelegateExpressionExecutionListener;
import org.finos.fluxnova.bpm.engine.impl.bpmn.listener.ExpressionExecutionListener;
import org.finos.fluxnova.bpm.engine.impl.bpmn.listener.ScriptExecutionListener;
import org.finos.fluxnova.bpm.engine.impl.context.Context;
import org.finos.fluxnova.bpm.engine.impl.core.model.BaseCallableElement;
import org.finos.fluxnova.bpm.engine.impl.core.model.BaseCallableElement.CallableElementBinding;
...
import org.finos.fluxnova.bpm.engine.impl.core.model.Properties;
...
import org.finos.fluxnova.bpm.engine.impl.dmn.result.DecisionResultMapper;
...
import org.finos.fluxnova.bpm.engine.impl.el.UelExpressionCondition;
import org.finos.fluxnova.bpm.engine.impl.event.EventType;
import org.finos.fluxnova.bpm.engine.impl.form.FormDefinition;
import org.finos.fluxnova.bpm.engine.impl.form.handler.DefaultStartFormHandler;
import org.finos.fluxnova.bpm.engine.impl.form.handler.DefaultTaskFormHandler;
import org.finos.fluxnova.bpm.engine.impl.form.handler.DelegateStartFormHandler;
import org.finos.fluxnova.bpm.engine.impl.form.handler.DelegateTaskFormHandler;
...
import org.finos.fluxnova.bpm.engine.impl.jobexecutor.AsyncAfterMessageJobDeclaration;
import org.finos.fluxnova.bpm.engine.impl.jobexecutor.AsyncBeforeMessageJobDeclaration;
import org.finos.fluxnova.bpm.engine.impl.jobexecutor.EventSubscriptionJobDeclaration;
import org.finos.fluxnova.bpm.engine.impl.jobexecutor.JobDeclaration;
import org.finos.fluxnova.bpm.engine.impl.jobexecutor.MessageJobDeclaration;
...
import org.finos.fluxnova.bpm.engine.impl.jobexecutor.TimerDeclarationType;
import org.finos.fluxnova.bpm.engine.impl.jobexecutor.TimerEventJobHandler;
...
import org.finos.fluxnova.bpm.engine.impl.pvm.process.ActivityStartBehavior;
import org.finos.fluxnova.bpm.engine.impl.pvm.process.HasDIBounds;
import org.finos.fluxnova.bpm.engine.impl.pvm.process.Lane;
import org.finos.fluxnova.bpm.engine.impl.pvm.process.LaneSet;
import org.finos.fluxnova.bpm.engine.impl.pvm.process.ParticipantProcess;
...
import org.finos.fluxnova.bpm.engine.impl.scripting.ScriptCondition;
import org.finos.fluxnova.bpm.engine.impl.scripting.engine.ScriptingEngines;
import org.finos.fluxnova.bpm.engine.impl.task.TaskDecorator;
import org.finos.fluxnova.bpm.engine.impl.task.TaskDefinition;
import org.finos.fluxnova.bpm.engine.impl.task.listener.ClassDelegateTaskListener;
import org.finos.fluxnova.bpm.engine.impl.task.listener.DelegateExpressionTaskListener;
import org.finos.fluxnova.bpm.engine.impl.task.listener.ExpressionTaskListener;
import org.finos.fluxnova.bpm.engine.impl.task.listener.ScriptTaskListener;
import org.finos.fluxnova.bpm.engine.impl.util.DecisionEvaluationUtil;
import org.finos.fluxnova.bpm.engine.impl.util.ReflectUtil;
import org.finos.fluxnova.bpm.engine.impl.util.ScriptUtil;
...
public class BpmnParse extends Parse {
  ...
  protected void parseExternalServiceTask(ActivityImpl activity,
    ...
    Map<String, String> properties = parseFluxnovaExtensionProperties(camundaPropertiesElement);
    activity.getProperties().set(BpmnProperties.EXTENSION_PROPERTIES, properties);
    List<FluxnovaErrorEventDefinition> camundaErrorEventDefinitions = parseFluxnovaErrorEventDefinitions(activity, serviceTaskElement);
  ...
  protected FormDefinition parseFormDefinition(Element flowNodeElement) {
    ...
    if(formRefAttribute != null) {
      formDefinition.setFluxnovaFormDefinitionKey(expressionManager.createExpression(formRefAttribute));
      ...
      if(formRefBindingAttribute != null) {
        formDefinition.setFluxnovaFormDefinitionBinding(formRefBindingAttribute);
      }
      ...
      if(DefaultTaskFormHandler.FORM_REF_BINDING_VERSION.equals(formRefBindingAttribute)) {
        ...
        if(formRefVersionAttribute != null) {
          formDefinition.setFluxnovaFormDefinitionVersion(camundaFormDefinitionVersion);
        }
      }
    }
  ...
  protected TaskListener parseTaskListener(Element taskListenerElement, String taskElementId) {
    ...
    if (className != null) {
      ...
      try {
        ExecutableScript executableScript = parseFluxnovaScript(scriptElement);
  ...
  public List<FluxnovaErrorEventDefinition> parseFluxnovaErrorEventDefinitions(ActivityImpl activity, Element scopeElement) {
    List<FluxnovaErrorEventDefinition> errorEventDefinitions = new ArrayList<>();
    ...
    if (extensionElements != null) {
      ...
      for (Element errorEventDefinitionElement : errorEventDefinitionElements) {
        ...
        if (errorRef != null) {
          ...
          error = errors.get(errorRef);
          FluxnovaErrorEventDefinition definition = new FluxnovaErrorEventDefinition(activity.getId(), expressionManager.createExpression(camundaExpression));
  ...
  protected void ensureNoIoMappingDefined(Element element) {
    Element inputOutput = findFluxnovaExtensionElement(element, "inputOutput");
    if (inputOutput != null) {
