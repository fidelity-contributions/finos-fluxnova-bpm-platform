...
import static org.finos.fluxnova.bpm.engine.impl.cmd.HistoryCleanupCmd.MAX_THREADS_NUMBER;
...
import org.finos.fluxnova.bpm.engine.impl.AuthorizationServiceImpl;
...
import org.finos.fluxnova.bpm.engine.impl.IdentityServiceImpl;
import org.finos.fluxnova.bpm.engine.impl.ManagementServiceImpl;
import org.finos.fluxnova.bpm.engine.impl.ModificationBatchJobHandler;
import org.finos.fluxnova.bpm.engine.impl.OptimizeService;
import org.finos.fluxnova.bpm.engine.impl.PriorityProvider;
...
import org.finos.fluxnova.bpm.engine.impl.RestartProcessInstancesJobHandler;
import org.finos.fluxnova.bpm.engine.impl.RuntimeServiceImpl;
import org.finos.fluxnova.bpm.engine.impl.ServiceImpl;
...
import org.finos.fluxnova.bpm.engine.impl.batch.deletion.DeleteHistoricProcessInstancesJobHandler;
import org.finos.fluxnova.bpm.engine.impl.batch.deletion.DeleteProcessInstancesJobHandler;
import org.finos.fluxnova.bpm.engine.impl.batch.externaltask.SetExternalTaskRetriesJobHandler;
import org.finos.fluxnova.bpm.engine.impl.batch.job.SetJobRetriesJobHandler;
import org.finos.fluxnova.bpm.engine.impl.batch.message.MessageCorrelationBatchJobHandler;
import org.finos.fluxnova.bpm.engine.impl.batch.removaltime.BatchSetRemovalTimeJobHandler;
import org.finos.fluxnova.bpm.engine.impl.batch.removaltime.DecisionSetRemovalTimeJobHandler;
import org.finos.fluxnova.bpm.engine.impl.batch.removaltime.ProcessSetRemovalTimeJobHandler;
import org.finos.fluxnova.bpm.engine.impl.batch.update.UpdateProcessInstancesSuspendStateJobHandler;
import org.finos.fluxnova.bpm.engine.impl.batch.variables.BatchSetVariablesHandler;
import org.finos.fluxnova.bpm.engine.impl.bpmn.behavior.ExternalTaskActivityBehavior;
import org.finos.fluxnova.bpm.engine.impl.bpmn.deployer.BpmnDeployer;
import org.finos.fluxnova.bpm.engine.impl.bpmn.parser.BpmnParseListener;
import org.finos.fluxnova.bpm.engine.impl.bpmn.parser.BpmnParser;
import org.finos.fluxnova.bpm.engine.impl.bpmn.parser.DefaultFailedJobParseListener;
import org.finos.fluxnova.bpm.engine.impl.calendar.BusinessCalendarManager;
import org.finos.fluxnova.bpm.engine.impl.calendar.CycleBusinessCalendar;
import org.finos.fluxnova.bpm.engine.impl.calendar.DueDateBusinessCalendar;
import org.finos.fluxnova.bpm.engine.impl.calendar.DurationBusinessCalendar;
import org.finos.fluxnova.bpm.engine.impl.calendar.MapBusinessCalendarManager;
import org.finos.fluxnova.bpm.engine.impl.cfg.auth.AuthorizationCommandChecker;
...
import org.finos.fluxnova.bpm.engine.impl.cfg.auth.PermissionProvider;
import org.finos.fluxnova.bpm.engine.impl.cfg.auth.ResourceAuthorizationProvider;
import org.finos.fluxnova.bpm.engine.impl.cfg.multitenancy.TenantCommandChecker;
import org.finos.fluxnova.bpm.engine.impl.cfg.multitenancy.TenantIdProvider;
import org.finos.fluxnova.bpm.engine.impl.cfg.standalone.StandaloneTransactionContextFactory;
import org.finos.fluxnova.bpm.engine.impl.cmd.HistoryCleanupCmd;
import org.finos.fluxnova.bpm.engine.impl.cmmn.CaseServiceImpl;
import org.finos.fluxnova.bpm.engine.impl.cmmn.deployer.CmmnDeployer;
import org.finos.fluxnova.bpm.engine.impl.cmmn.entity.repository.CaseDefinitionManager;
import org.finos.fluxnova.bpm.engine.impl.cmmn.entity.runtime.CaseExecutionManager;
import org.finos.fluxnova.bpm.engine.impl.cmmn.entity.runtime.CaseSentryPartManager;
import org.finos.fluxnova.bpm.engine.impl.cmmn.handler.DefaultCmmnElementHandlerRegistry;
import org.finos.fluxnova.bpm.engine.impl.cmmn.transformer.CmmnTransformFactory;
import org.finos.fluxnova.bpm.engine.impl.cmmn.transformer.CmmnTransformListener;
import org.finos.fluxnova.bpm.engine.impl.cmmn.transformer.CmmnTransformer;
import org.finos.fluxnova.bpm.engine.impl.cmmn.transformer.DefaultCmmnTransformFactory;
import org.finos.fluxnova.bpm.engine.impl.db.DbIdGenerator;
import org.finos.fluxnova.bpm.engine.impl.db.entitymanager.DbEntityManagerFactory;
import org.finos.fluxnova.bpm.engine.impl.db.entitymanager.cache.DbEntityCacheKeyMapping;
import org.finos.fluxnova.bpm.engine.impl.db.sql.DbSqlPersistenceProviderFactory;
import org.finos.fluxnova.bpm.engine.impl.db.sql.DbSqlSessionFactory;
import org.finos.fluxnova.bpm.engine.impl.delegate.DefaultDelegateInterceptor;
import org.finos.fluxnova.bpm.engine.impl.diagnostics.DiagnosticsCollector;
import org.finos.fluxnova.bpm.engine.impl.diagnostics.DiagnosticsRegistry;
import org.finos.fluxnova.bpm.engine.impl.digest.Default16ByteSaltGenerator;
import org.finos.fluxnova.bpm.engine.impl.digest.PasswordEncryptor;
import org.finos.fluxnova.bpm.engine.impl.digest.PasswordManager;
import org.finos.fluxnova.bpm.engine.impl.digest.SaltGenerator;
import org.finos.fluxnova.bpm.engine.impl.digest.Sha512HashDigest;
import org.finos.fluxnova.bpm.engine.impl.dmn.batch.DeleteHistoricDecisionInstancesJobHandler;
import org.finos.fluxnova.bpm.engine.impl.dmn.configuration.DmnEngineConfigurationBuilder;
import org.finos.fluxnova.bpm.engine.impl.dmn.deployer.DecisionDefinitionDeployer;
import org.finos.fluxnova.bpm.engine.impl.dmn.deployer.DecisionRequirementsDefinitionDeployer;
import org.finos.fluxnova.bpm.engine.impl.dmn.entity.repository.DecisionDefinitionManager;
import org.finos.fluxnova.bpm.engine.impl.dmn.entity.repository.DecisionRequirementsDefinitionManager;
...
import org.finos.fluxnova.bpm.engine.impl.el.ElProviderCompatible;
...
import org.finos.fluxnova.bpm.engine.impl.event.CompensationEventHandler;
import org.finos.fluxnova.bpm.engine.impl.event.ConditionalEventHandler;
import org.finos.fluxnova.bpm.engine.impl.event.EventHandler;
import org.finos.fluxnova.bpm.engine.impl.event.EventHandlerImpl;
import org.finos.fluxnova.bpm.engine.impl.event.EventType;
import org.finos.fluxnova.bpm.engine.impl.event.SignalEventHandler;
import org.finos.fluxnova.bpm.engine.impl.externaltask.DefaultExternalTaskPriorityProvider;
import org.finos.fluxnova.bpm.engine.impl.form.deployer.FluxnovaFormDefinitionDeployer;
import org.finos.fluxnova.bpm.engine.impl.form.engine.FormEngine;
import org.finos.fluxnova.bpm.engine.impl.form.engine.HtmlFormEngine;
import org.finos.fluxnova.bpm.engine.impl.form.engine.JuelFormEngine;
import org.finos.fluxnova.bpm.engine.impl.form.entity.FluxnovaFormDefinitionManager;
import org.finos.fluxnova.bpm.engine.impl.form.type.AbstractFormFieldType;
import org.finos.fluxnova.bpm.engine.impl.form.type.BooleanFormType;
import org.finos.fluxnova.bpm.engine.impl.form.type.DateFormType;
import org.finos.fluxnova.bpm.engine.impl.form.type.FormTypes;
import org.finos.fluxnova.bpm.engine.impl.form.type.LongFormType;
import org.finos.fluxnova.bpm.engine.impl.form.type.StringFormType;
import org.finos.fluxnova.bpm.engine.impl.form.validator.FormFieldValidator;
import org.finos.fluxnova.bpm.engine.impl.form.validator.FormValidators;
import org.finos.fluxnova.bpm.engine.impl.form.validator.MaxLengthValidator;
import org.finos.fluxnova.bpm.engine.impl.form.validator.MaxValidator;
import org.finos.fluxnova.bpm.engine.impl.form.validator.MinLengthValidator;
import org.finos.fluxnova.bpm.engine.impl.form.validator.MinValidator;
import org.finos.fluxnova.bpm.engine.impl.form.validator.ReadOnlyValidator;
import org.finos.fluxnova.bpm.engine.impl.form.validator.RequiredValidator;
...
import org.finos.fluxnova.bpm.engine.impl.history.HistoryRemovalTimeProvider;
import org.finos.fluxnova.bpm.engine.impl.history.event.HistoricDecisionInstanceManager;
import org.finos.fluxnova.bpm.engine.impl.history.event.HostnameProvider;
import org.finos.fluxnova.bpm.engine.impl.history.event.SimpleIpBasedProvider;
import org.finos.fluxnova.bpm.engine.impl.history.handler.CompositeDbHistoryEventHandler;
import org.finos.fluxnova.bpm.engine.impl.history.handler.CompositeHistoryEventHandler;
...
import org.finos.fluxnova.bpm.engine.impl.history.parser.HistoryParseListener;
import org.finos.fluxnova.bpm.engine.impl.history.producer.CacheAwareCmmnHistoryEventProducer;
import org.finos.fluxnova.bpm.engine.impl.history.producer.CacheAwareHistoryEventProducer;
import org.finos.fluxnova.bpm.engine.impl.history.producer.CmmnHistoryEventProducer;
import org.finos.fluxnova.bpm.engine.impl.history.producer.DefaultDmnHistoryEventProducer;
import org.finos.fluxnova.bpm.engine.impl.history.producer.DmnHistoryEventProducer;
import org.finos.fluxnova.bpm.engine.impl.history.producer.HistoryEventProducer;
import org.finos.fluxnova.bpm.engine.impl.history.transformer.CmmnHistoryTransformListener;
import org.finos.fluxnova.bpm.engine.impl.identity.DefaultPasswordPolicyImpl;
import org.finos.fluxnova.bpm.engine.impl.identity.ReadOnlyIdentityProvider;
import org.finos.fluxnova.bpm.engine.impl.identity.WritableIdentityProvider;
import org.finos.fluxnova.bpm.engine.impl.identity.db.DbIdentityServiceProvider;
...
import org.finos.fluxnova.bpm.engine.impl.jobexecutor.DefaultJobPriorityProvider;
import org.finos.fluxnova.bpm.engine.impl.jobexecutor.FailedJobCommandFactory;
import org.finos.fluxnova.bpm.engine.impl.jobexecutor.JobDeclaration;
...
import org.finos.fluxnova.bpm.engine.impl.jobexecutor.ProcessEventJobHandler;
import org.finos.fluxnova.bpm.engine.impl.jobexecutor.RejectedJobsHandler;
import org.finos.fluxnova.bpm.engine.impl.jobexecutor.TimerActivateJobDefinitionHandler;
import org.finos.fluxnova.bpm.engine.impl.jobexecutor.TimerActivateProcessDefinitionHandler;
...
import org.finos.fluxnova.bpm.engine.impl.jobexecutor.TimerStartEventJobHandler;
import org.finos.fluxnova.bpm.engine.impl.jobexecutor.TimerStartEventSubprocessJobHandler;
import org.finos.fluxnova.bpm.engine.impl.jobexecutor.TimerSuspendJobDefinitionHandler;
import org.finos.fluxnova.bpm.engine.impl.jobexecutor.TimerSuspendProcessDefinitionHandler;
...
import org.finos.fluxnova.bpm.engine.impl.jobexecutor.historycleanup.DefaultBatchWindowManager;
import org.finos.fluxnova.bpm.engine.impl.jobexecutor.historycleanup.HistoryCleanupBatch;
import org.finos.fluxnova.bpm.engine.impl.jobexecutor.historycleanup.HistoryCleanupHandler;
import org.finos.fluxnova.bpm.engine.impl.jobexecutor.historycleanup.HistoryCleanupHelper;
...
import org.finos.fluxnova.bpm.engine.impl.metrics.parser.MetricsBpmnParseListener;
import org.finos.fluxnova.bpm.engine.impl.metrics.parser.MetricsCmmnTransformListener;
import org.finos.fluxnova.bpm.engine.impl.metrics.reporter.DbMetricsReporter;
import org.finos.fluxnova.bpm.engine.impl.migration.DefaultMigrationActivityMatcher;
import org.finos.fluxnova.bpm.engine.impl.migration.DefaultMigrationInstructionGenerator;
import org.finos.fluxnova.bpm.engine.impl.migration.MigrationActivityMatcher;
import org.finos.fluxnova.bpm.engine.impl.migration.MigrationInstructionGenerator;
import org.finos.fluxnova.bpm.engine.impl.migration.batch.MigrationBatchJobHandler;
import org.finos.fluxnova.bpm.engine.impl.migration.validation.activity.MigrationActivityValidator;
import org.finos.fluxnova.bpm.engine.impl.migration.validation.activity.NoCompensationHandlerActivityValidator;
import org.finos.fluxnova.bpm.engine.impl.migration.validation.activity.SupportedActivityValidator;
import org.finos.fluxnova.bpm.engine.impl.migration.validation.activity.SupportedPassiveEventTriggerActivityValidator;
import org.finos.fluxnova.bpm.engine.impl.migration.validation.instance.AsyncAfterMigrationValidator;
import org.finos.fluxnova.bpm.engine.impl.migration.validation.instance.AsyncMigrationValidator;
import org.finos.fluxnova.bpm.engine.impl.migration.validation.instance.AsyncProcessStartMigrationValidator;
import org.finos.fluxnova.bpm.engine.impl.migration.validation.instance.MigratingActivityInstanceValidator;
import org.finos.fluxnova.bpm.engine.impl.migration.validation.instance.MigratingCompensationInstanceValidator;
import org.finos.fluxnova.bpm.engine.impl.migration.validation.instance.MigratingTransitionInstanceValidator;
import org.finos.fluxnova.bpm.engine.impl.migration.validation.instance.NoUnmappedCompensationStartEventValidator;
import org.finos.fluxnova.bpm.engine.impl.migration.validation.instance.NoUnmappedLeafInstanceValidator;
import org.finos.fluxnova.bpm.engine.impl.migration.validation.instance.SupportedActivityInstanceValidator;
import org.finos.fluxnova.bpm.engine.impl.migration.validation.instance.VariableConflictActivityInstanceValidator;
import org.finos.fluxnova.bpm.engine.impl.migration.validation.instruction.AdditionalFlowScopeInstructionValidator;
import org.finos.fluxnova.bpm.engine.impl.migration.validation.instruction.CannotAddMultiInstanceBodyValidator;
import org.finos.fluxnova.bpm.engine.impl.migration.validation.instruction.CannotAddMultiInstanceInnerActivityValidator;
import org.finos.fluxnova.bpm.engine.impl.migration.validation.instruction.CannotRemoveMultiInstanceInnerActivityValidator;
import org.finos.fluxnova.bpm.engine.impl.migration.validation.instruction.ConditionalEventUpdateEventTriggerValidator;
import org.finos.fluxnova.bpm.engine.impl.migration.validation.instruction.GatewayMappingValidator;
import org.finos.fluxnova.bpm.engine.impl.migration.validation.instruction.MigrationInstructionValidator;
import org.finos.fluxnova.bpm.engine.impl.migration.validation.instruction.OnlyOnceMappedActivityInstructionValidator;
import org.finos.fluxnova.bpm.engine.impl.migration.validation.instruction.SameBehaviorInstructionValidator;
import org.finos.fluxnova.bpm.engine.impl.migration.validation.instruction.SameEventScopeInstructionValidator;
import org.finos.fluxnova.bpm.engine.impl.migration.validation.instruction.SameEventTypeValidator;
import org.finos.fluxnova.bpm.engine.impl.migration.validation.instruction.UpdateEventTriggersValidator;
import org.finos.fluxnova.bpm.engine.impl.optimize.OptimizeManager;
import org.finos.fluxnova.bpm.engine.impl.persistence.GenericManagerFactory;
import org.finos.fluxnova.bpm.engine.impl.persistence.deploy.Deployer;
import org.finos.fluxnova.bpm.engine.impl.persistence.deploy.cache.CacheFactory;
import org.finos.fluxnova.bpm.engine.impl.persistence.deploy.cache.DefaultCacheFactory;
...
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.CommentManager;
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.DeploymentManager;
...
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.HistoricCaseActivityInstanceManager;
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.HistoricCaseInstanceManager;
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.HistoricDetailManager;
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.HistoricExternalTaskLogManager;
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.HistoricIdentityLinkLogManager;
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.HistoricIncidentManager;
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.HistoricJobLogManager;
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.HistoricProcessInstanceManager;
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.HistoricStatisticsManager;
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.HistoricTaskInstanceManager;
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.HistoricVariableInstanceManager;
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.IdentityInfoManager;
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.IdentityLinkManager;
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.IncidentManager;
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.JobDefinitionManager;
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.JobManager;
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.MeterLogManager;
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.ProcessDefinitionManager;
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.PropertyManager;
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.ReportManager;
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.ResourceManager;
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.SchemaLogManager;
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.StatisticsManager;
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.TableDataManager;
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.TaskManager;
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.TaskReportManager;
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.TenantManager;
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.UserOperationLogManager;
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.VariableInstanceManager;
import org.finos.fluxnova.bpm.engine.impl.repository.DefaultDeploymentHandlerFactory;
import org.finos.fluxnova.bpm.engine.impl.runtime.ConditionHandler;
import org.finos.fluxnova.bpm.engine.impl.runtime.CorrelationHandler;
import org.finos.fluxnova.bpm.engine.impl.runtime.DefaultConditionHandler;
import org.finos.fluxnova.bpm.engine.impl.runtime.DefaultCorrelationHandler;
import org.finos.fluxnova.bpm.engine.impl.runtime.DefaultDeserializationTypeValidator;
import org.finos.fluxnova.bpm.engine.impl.scripting.ScriptFactory;
import org.finos.fluxnova.bpm.engine.impl.scripting.engine.BeansResolverFactory;
import org.finos.fluxnova.bpm.engine.impl.scripting.engine.FluxnovaScriptEngineManager;
import org.finos.fluxnova.bpm.engine.impl.scripting.engine.DefaultScriptEngineResolver;
import org.finos.fluxnova.bpm.engine.impl.scripting.engine.ResolverFactory;
import org.finos.fluxnova.bpm.engine.impl.scripting.engine.ScriptBindingsFactory;
...
import org.finos.fluxnova.bpm.engine.impl.telemetry.dto.ProductImpl;
...
import org.finos.fluxnova.bpm.engine.impl.util.ParseUtil;
...
import org.finos.fluxnova.bpm.engine.impl.variable.serializer.BooleanValueSerializer;
import org.finos.fluxnova.bpm.engine.impl.variable.serializer.ByteArrayValueSerializer;
import org.finos.fluxnova.bpm.engine.impl.variable.serializer.DateValueSerializer;
import org.finos.fluxnova.bpm.engine.impl.variable.serializer.DefaultVariableSerializers;
import org.finos.fluxnova.bpm.engine.impl.variable.serializer.DoubleValueSerializer;
import org.finos.fluxnova.bpm.engine.impl.variable.serializer.FileValueSerializer;
import org.finos.fluxnova.bpm.engine.impl.variable.serializer.IntegerValueSerializer;
import org.finos.fluxnova.bpm.engine.impl.variable.serializer.JavaObjectSerializer;
import org.finos.fluxnova.bpm.engine.impl.variable.serializer.LongValueSerlializer;
import org.finos.fluxnova.bpm.engine.impl.variable.serializer.NullValueSerializer;
import org.finos.fluxnova.bpm.engine.impl.variable.serializer.ShortValueSerializer;
import org.finos.fluxnova.bpm.engine.impl.variable.serializer.StringValueSerializer;
...
import org.finos.fluxnova.bpm.engine.repository.DeploymentHandlerFactory;
import org.finos.fluxnova.bpm.engine.runtime.Incident;
import org.finos.fluxnova.bpm.engine.runtime.WhitelistingDeserializationTypeValidator;
import org.finos.fluxnova.bpm.engine.task.TaskQuery;
import org.finos.fluxnova.bpm.engine.test.mock.MocksResolverFactory;
...
public abstract class ProcessEngineConfigurationImpl extends ProcessEngineConfiguration {
  ...
  public static final String DEFAULT_WS_SYNC_FACTORY = "org.finos.fluxnova.bpm.engine.impl.webservice.CxfWebServiceClientFactory";

  public static final String DEFAULT_MYBATIS_MAPPING_FILE = "org/finos/fluxnova/bpm/engine/impl/mapping/mappings.xml";
  ...
  /**
   * As an instance of {@link org.finos.fluxnova.bpm.engine.impl.history.handler.CompositeHistoryEventHandler}
    ...
    synchronized (ProcessEngineConfigurationImpl.class) {
      ...
      if (sqlSessionFactory == null) {
        ...
        try {
          ...
          if (isUseSharedSqlSessionFactory) {
            properties.put("prefix", "${@org.finos.fluxnova.bpm.engine.impl.context.Context@getProcessEngineConfiguration().databaseTablePrefix}");
          } else {
  ...
  protected void initSessionFactories() {
    if (sessionFactories == null) {
      ...
      addSessionFactory(new GenericManagerFactory(FluxnovaFormDefinitionManager.class));
  ...
  protected Collection<? extends Deployer> getDefaultDeployers() {
    ...
    defaultDeployers.add(getFluxnovaFormDeployer());
  ...
  protected FluxnovaFormDefinitionDeployer getFluxnovaFormDeployer() {
    FluxnovaFormDefinitionDeployer deployer = new FluxnovaFormDefinitionDeployer();
  ...
  protected void initScripting() {
    ...
    if (scriptEngineResolver == null) {
      scriptEngineResolver = new DefaultScriptEngineResolver(new FluxnovaScriptEngineManager());
    }
  ...
  protected void initTelemetryData() {
    ...
    String camundaIntegration = diagnosticsRegistry.getFluxnovaIntegration();
    if (camundaIntegration != null && !camundaIntegration.isEmpty()) {
      internals.getFluxnovaIntegration().add(camundaIntegration);
    }
  ...
  public ProcessEngineConfigurationImpl setDisableStrictFluxnovaFormParsing(boolean disableStrictCamundaFormParsing) {
    this.disableStrictCamundaFormParsing = disableStrictCamundaFormParsing;
    return this;
  }

  public boolean isDisableStrictFluxnovaFormParsing() {
