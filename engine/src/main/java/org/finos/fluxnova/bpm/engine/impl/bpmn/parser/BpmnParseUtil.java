...
public final class BpmnParseUtil {
  ...
  public static IoMapping parseInputOutput(Element element) {
    ...
    if(inputOutputElement != null) {
      ...
      parseFluxnovaInputParameters(inputOutputElement, ioMapping);
      parseFluxnovaOutputParameters(inputOutputElement, ioMapping);
      return ioMapping;
    }
    return null;
  }
   ...
   */
  public static void parseFluxnovaInputParameters(Element inputOutputElement, IoMapping ioMapping) {
   ...
   */
  public static void parseFluxnovaOutputParameters(Element inputOutputElement, IoMapping ioMapping) {
  ...
  protected static ParameterValueProvider parseParamValueProvider(Element parameterElement) {
    ...
    if("script".equals(parameterElement.getTagName())) {
      ExecutableScript executableScript = parseFluxnovaScript(parameterElement);
   ...
   */
  public static ExecutableScript parseFluxnovaScript(Element scriptElement) {
