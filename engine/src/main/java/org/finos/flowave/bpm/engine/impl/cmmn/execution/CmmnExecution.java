 ...
 */
package org.finos.flowave.bpm.engine.impl.cmmn.execution;

import static org.finos.flowave.bpm.engine.impl.cmmn.execution.CaseExecutionState.ACTIVE;
import static org.finos.flowave.bpm.engine.impl.cmmn.execution.CaseExecutionState.AVAILABLE;
import static org.finos.flowave.bpm.engine.impl.cmmn.execution.CaseExecutionState.CLOSED;
import static org.finos.flowave.bpm.engine.impl.cmmn.execution.CaseExecutionState.COMPLETED;
import static org.finos.flowave.bpm.engine.impl.cmmn.execution.CaseExecutionState.DISABLED;
import static org.finos.flowave.bpm.engine.impl.cmmn.execution.CaseExecutionState.ENABLED;
import static org.finos.flowave.bpm.engine.impl.cmmn.execution.CaseExecutionState.FAILED;
import static org.finos.flowave.bpm.engine.impl.cmmn.execution.CaseExecutionState.NEW;
import static org.finos.flowave.bpm.engine.impl.cmmn.execution.CaseExecutionState.SUSPENDED;
import static org.finos.flowave.bpm.engine.impl.cmmn.execution.CaseExecutionState.SUSPENDING_ON_PARENT_SUSPENSION;
import static org.finos.flowave.bpm.engine.impl.cmmn.execution.CaseExecutionState.SUSPENDING_ON_SUSPENSION;
import static org.finos.flowave.bpm.engine.impl.cmmn.execution.CaseExecutionState.TERMINATED;
import static org.finos.flowave.bpm.engine.impl.cmmn.execution.CaseExecutionState.TERMINATING_ON_EXIT;
import static org.finos.flowave.bpm.engine.impl.cmmn.execution.CaseExecutionState.TERMINATING_ON_PARENT_TERMINATION;
import static org.finos.flowave.bpm.engine.impl.cmmn.execution.CaseExecutionState.TERMINATING_ON_TERMINATION;
import static org.finos.flowave.bpm.engine.impl.cmmn.model.CmmnSentryDeclaration.IF_PART;
import static org.finos.flowave.bpm.engine.impl.cmmn.model.CmmnSentryDeclaration.PLAN_ITEM_ON_PART;
import static org.finos.flowave.bpm.engine.impl.cmmn.model.CmmnSentryDeclaration.VARIABLE_ON_PART;
import static org.finos.flowave.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_COMPLETE;
import static org.finos.flowave.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_CREATE;
import static org.finos.flowave.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_DELETE_CASCADE;
import static org.finos.flowave.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_DISABLE;
import static org.finos.flowave.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_ENABLE;
import static org.finos.flowave.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_EXIT;
import static org.finos.flowave.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_FIRE_ENTRY_CRITERIA;
import static org.finos.flowave.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_FIRE_EXIT_CRITERIA;
import static org.finos.flowave.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_MANUAL_COMPLETE;
import static org.finos.flowave.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_MANUAL_START;
import static org.finos.flowave.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_OCCUR;
import static org.finos.flowave.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_PARENT_RESUME;
import static org.finos.flowave.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_PARENT_SUSPEND;
import static org.finos.flowave.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_PARENT_TERMINATE;
import static org.finos.flowave.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_RESUME;
import static org.finos.flowave.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_RE_ACTIVATE;
import static org.finos.flowave.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_RE_ENABLE;
import static org.finos.flowave.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_START;
import static org.finos.flowave.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_SUSPEND;
import static org.finos.flowave.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_SUSPENDING_ON_PARENT_SUSPENSION;
import static org.finos.flowave.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_SUSPENDING_ON_SUSPENSION;
import static org.finos.flowave.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_TERMINATE;
import static org.finos.flowave.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_TERMINATING_ON_EXIT;
import static org.finos.flowave.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_TERMINATING_ON_PARENT_TERMINATION;
import static org.finos.flowave.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_TERMINATING_ON_TERMINATION;
import static org.finos.flowave.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_INSTANCE_CLOSE;
import static org.finos.flowave.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_INSTANCE_CREATE;
import static org.finos.flowave.bpm.engine.impl.util.EnsureUtil.ensureInstanceOf;
...
import org.finos.flowave.bpm.engine.delegate.CaseVariableListener;
...
import org.finos.flowave.bpm.engine.impl.cmmn.behavior.CmmnBehaviorLogger;
import org.finos.flowave.bpm.engine.impl.cmmn.entity.runtime.CaseExecutionEntity;
import org.finos.flowave.bpm.engine.impl.cmmn.entity.runtime.CaseSentryPartEntity;
import org.finos.flowave.bpm.engine.impl.cmmn.model.CmmnActivity;
import org.finos.flowave.bpm.engine.impl.cmmn.model.CmmnCaseDefinition;
import org.finos.flowave.bpm.engine.impl.cmmn.model.CmmnIfPartDeclaration;
import org.finos.flowave.bpm.engine.impl.cmmn.model.CmmnOnPartDeclaration;
import org.finos.flowave.bpm.engine.impl.cmmn.model.CmmnSentryDeclaration;
import org.finos.flowave.bpm.engine.impl.cmmn.model.CmmnVariableOnPartDeclaration;
import org.finos.flowave.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation;
import org.finos.flowave.bpm.engine.impl.context.Context;
import org.finos.flowave.bpm.engine.impl.core.instance.CoreExecution;
import org.finos.flowave.bpm.engine.impl.core.variable.event.VariableEvent;
import org.finos.flowave.bpm.engine.impl.core.variable.scope.AbstractVariableScope;
import org.finos.flowave.bpm.engine.impl.persistence.entity.TaskEntity;
import org.finos.flowave.bpm.engine.impl.persistence.entity.TaskEntity.TaskState;
import org.finos.flowave.bpm.engine.impl.pvm.PvmException;
import org.finos.flowave.bpm.engine.impl.pvm.PvmProcessDefinition;
import org.finos.flowave.bpm.engine.impl.pvm.runtime.PvmExecutionImpl;
import org.finos.flowave.bpm.engine.impl.task.TaskDecorator;
import org.finos.flowave.bpm.engine.impl.variable.listener.CaseVariableListenerInvocation;
import org.finos.flowave.bpm.engine.impl.variable.listener.DelegateCaseVariableInstanceImpl;
