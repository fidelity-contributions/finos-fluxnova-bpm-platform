...
import org.finos.flowave.bpm.engine.impl.cmd.AddCommentCmd;
import org.finos.flowave.bpm.engine.impl.cmd.AddGroupIdentityLinkCmd;
import org.finos.flowave.bpm.engine.impl.cmd.AddUserIdentityLinkCmd;
import org.finos.flowave.bpm.engine.impl.cmd.AssignTaskCmd;
import org.finos.flowave.bpm.engine.impl.cmd.ClaimTaskCmd;
import org.finos.flowave.bpm.engine.impl.cmd.CompleteTaskCmd;
import org.finos.flowave.bpm.engine.impl.cmd.CreateAttachmentCmd;
import org.finos.flowave.bpm.engine.impl.cmd.CreateTaskCmd;
import org.finos.flowave.bpm.engine.impl.cmd.DelegateTaskCmd;
import org.finos.flowave.bpm.engine.impl.cmd.DeleteAttachmentCmd;
import org.finos.flowave.bpm.engine.impl.cmd.DeleteGroupIdentityLinkCmd;
import org.finos.flowave.bpm.engine.impl.cmd.DeleteProcessInstanceCommentCmd;
import org.finos.flowave.bpm.engine.impl.cmd.DeleteTaskCmd;
import org.finos.flowave.bpm.engine.impl.cmd.DeleteTaskCommentCmd;
import org.finos.flowave.bpm.engine.impl.cmd.DeleteUserIdentityLinkCmd;
import org.finos.flowave.bpm.engine.impl.cmd.GetAttachmentCmd;
import org.finos.flowave.bpm.engine.impl.cmd.GetAttachmentContentCmd;
import org.finos.flowave.bpm.engine.impl.cmd.GetIdentityLinksForTaskCmd;
import org.finos.flowave.bpm.engine.impl.cmd.GetProcessInstanceAttachmentsCmd;
import org.finos.flowave.bpm.engine.impl.cmd.GetProcessInstanceCommentsCmd;
import org.finos.flowave.bpm.engine.impl.cmd.GetSubTasksCmd;
import org.finos.flowave.bpm.engine.impl.cmd.GetTaskAttachmentCmd;
import org.finos.flowave.bpm.engine.impl.cmd.GetTaskAttachmentContentCmd;
import org.finos.flowave.bpm.engine.impl.cmd.GetTaskAttachmentsCmd;
import org.finos.flowave.bpm.engine.impl.cmd.GetTaskCommentCmd;
import org.finos.flowave.bpm.engine.impl.cmd.GetTaskCommentsCmd;
import org.finos.flowave.bpm.engine.impl.cmd.GetTaskEventsCmd;
import org.finos.flowave.bpm.engine.impl.cmd.GetTaskVariableCmd;
import org.finos.flowave.bpm.engine.impl.cmd.GetTaskVariableCmdTyped;
import org.finos.flowave.bpm.engine.impl.cmd.GetTaskVariablesCmd;
import org.finos.flowave.bpm.engine.impl.cmd.HandleTaskBpmnErrorCmd;
import org.finos.flowave.bpm.engine.impl.cmd.HandleTaskEscalationCmd;
import org.finos.flowave.bpm.engine.impl.cmd.PatchTaskVariablesCmd;
import org.finos.flowave.bpm.engine.impl.cmd.RemoveTaskVariablesCmd;
import org.finos.flowave.bpm.engine.impl.cmd.ResolveTaskCmd;
import org.finos.flowave.bpm.engine.impl.cmd.SaveAttachmentCmd;
import org.finos.flowave.bpm.engine.impl.cmd.SaveTaskCmd;
import org.finos.flowave.bpm.engine.impl.cmd.SetTaskDescriptionCmd;
import org.finos.flowave.bpm.engine.impl.cmd.SetTaskDueDateCmd;
import org.finos.flowave.bpm.engine.impl.cmd.SetTaskFollowUpDateCmd;
import org.finos.flowave.bpm.engine.impl.cmd.SetTaskNameCmd;
import org.finos.flowave.bpm.engine.impl.cmd.SetTaskOwnerCmd;
import org.finos.flowave.bpm.engine.impl.cmd.SetTaskPriorityCmd;
import org.finos.flowave.bpm.engine.impl.cmd.SetTaskVariablesCmd;
import org.finos.flowave.bpm.engine.impl.cmd.UpdateCommentCmd;
import org.finos.flowave.bpm.engine.impl.util.ExceptionUtil;
import org.finos.flowave.bpm.engine.task.Attachment;
import org.finos.flowave.bpm.engine.task.Comment;
import org.finos.flowave.bpm.engine.task.Event;
import org.finos.flowave.bpm.engine.task.IdentityLink;
import org.finos.flowave.bpm.engine.task.IdentityLinkType;
import org.finos.flowave.bpm.engine.task.NativeTaskQuery;
import org.finos.flowave.bpm.engine.task.Task;
import org.finos.flowave.bpm.engine.task.TaskQuery;
import org.finos.flowave.bpm.engine.task.TaskReport;
