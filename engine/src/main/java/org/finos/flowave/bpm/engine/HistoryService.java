 ...
 */
package org.finos.flowave.bpm.engine;

import org.finos.flowave.bpm.engine.authorization.BatchPermissions;
...
public interface HistoryService {
  ...
  /**
   * Creates a query to search for {@link org.finos.flowave.bpm.engine.batch.history.HistoricBatch} instances.
   *
   * @since 7.5
   */
