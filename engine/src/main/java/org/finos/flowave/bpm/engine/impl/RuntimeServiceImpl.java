...
import org.finos.flowave.bpm.engine.impl.cmd.CreateIncidentCmd;
import org.finos.flowave.bpm.engine.impl.cmd.DeleteProcessInstanceCmd;
import org.finos.flowave.bpm.engine.impl.cmd.DeleteProcessInstancesCmd;
import org.finos.flowave.bpm.engine.impl.cmd.FindActiveActivityIdsCmd;
import org.finos.flowave.bpm.engine.impl.cmd.GetActivityInstanceCmd;
import org.finos.flowave.bpm.engine.impl.cmd.GetExecutionVariableCmd;
import org.finos.flowave.bpm.engine.impl.cmd.GetExecutionVariableTypedCmd;
import org.finos.flowave.bpm.engine.impl.cmd.GetExecutionVariablesCmd;
import org.finos.flowave.bpm.engine.impl.cmd.GetStartFormCmd;
import org.finos.flowave.bpm.engine.impl.cmd.MessageEventReceivedCmd;
import org.finos.flowave.bpm.engine.impl.cmd.PatchExecutionVariablesCmd;
import org.finos.flowave.bpm.engine.impl.cmd.RemoveExecutionVariablesCmd;
import org.finos.flowave.bpm.engine.impl.cmd.ResolveIncidentCmd;
import org.finos.flowave.bpm.engine.impl.cmd.SetAnnotationForIncidentCmd;
import org.finos.flowave.bpm.engine.impl.cmd.SetExecutionVariablesCmd;
import org.finos.flowave.bpm.engine.impl.cmd.SignalCmd;
import org.finos.flowave.bpm.engine.impl.cmd.batch.DeleteProcessInstanceBatchCmd;
import org.finos.flowave.bpm.engine.impl.cmd.batch.variables.SetVariablesToProcessInstancesBatchCmd;
import org.finos.flowave.bpm.engine.impl.migration.MigrationPlanBuilderImpl;
import org.finos.flowave.bpm.engine.impl.migration.MigrationPlanExecutionBuilderImpl;
import org.finos.flowave.bpm.engine.impl.runtime.UpdateProcessInstanceSuspensionStateBuilderImpl;
...
import org.finos.flowave.bpm.engine.runtime.ConditionEvaluationBuilder;
import org.finos.flowave.bpm.engine.runtime.EventSubscriptionQuery;
import org.finos.flowave.bpm.engine.runtime.ExecutionQuery;
import org.finos.flowave.bpm.engine.runtime.Incident;
import org.finos.flowave.bpm.engine.runtime.IncidentQuery;
import org.finos.flowave.bpm.engine.runtime.MessageCorrelationAsyncBuilder;
import org.finos.flowave.bpm.engine.runtime.MessageCorrelationBuilder;
import org.finos.flowave.bpm.engine.runtime.ModificationBuilder;
import org.finos.flowave.bpm.engine.runtime.NativeExecutionQuery;
import org.finos.flowave.bpm.engine.runtime.NativeProcessInstanceQuery;
import org.finos.flowave.bpm.engine.runtime.ProcessInstance;
import org.finos.flowave.bpm.engine.runtime.ProcessInstanceModificationBuilder;
import org.finos.flowave.bpm.engine.runtime.ProcessInstanceQuery;
import org.finos.flowave.bpm.engine.runtime.ProcessInstantiationBuilder;
import org.finos.flowave.bpm.engine.runtime.RestartProcessInstanceBuilder;
import org.finos.flowave.bpm.engine.runtime.SignalEventReceivedBuilder;
