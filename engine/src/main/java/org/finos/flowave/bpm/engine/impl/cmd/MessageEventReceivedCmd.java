...
import static org.finos.flowave.bpm.engine.impl.util.EnsureUtil.ensureNumberOfElements;
...
public class MessageEventReceivedCmd implements Command<Void>, Serializable {
  ...
  public Void execute(CommandContext commandContext) {
    ...
    eventSubscriptionEntity.eventReceived(processVariables, processVariablesLocal, processVariablesToTriggeredScope, null, false);
