 ...
 */
package org.finos.flowave.bpm.engine.impl.db.entitymanager;

import static org.finos.flowave.bpm.engine.impl.db.entitymanager.cache.DbEntityState.DELETED_MERGED;
import static org.finos.flowave.bpm.engine.impl.db.entitymanager.cache.DbEntityState.DELETED_PERSISTENT;
import static org.finos.flowave.bpm.engine.impl.db.entitymanager.cache.DbEntityState.DELETED_TRANSIENT;
import static org.finos.flowave.bpm.engine.impl.db.entitymanager.cache.DbEntityState.MERGED;
import static org.finos.flowave.bpm.engine.impl.db.entitymanager.cache.DbEntityState.PERSISTENT;
import static org.finos.flowave.bpm.engine.impl.db.entitymanager.cache.DbEntityState.TRANSIENT;
import static org.finos.flowave.bpm.engine.impl.db.entitymanager.operation.DbOperationType.DELETE;
import static org.finos.flowave.bpm.engine.impl.db.entitymanager.operation.DbOperationType.DELETE_BULK;
import static org.finos.flowave.bpm.engine.impl.db.entitymanager.operation.DbOperationType.INSERT;
import static org.finos.flowave.bpm.engine.impl.db.entitymanager.operation.DbOperationType.UPDATE;
import static org.finos.flowave.bpm.engine.impl.db.entitymanager.operation.DbOperationType.UPDATE_BULK;
...
import org.finos.flowave.bpm.engine.impl.ExecutionQueryImpl;
import org.finos.flowave.bpm.engine.impl.GroupQueryImpl;
...
import org.finos.flowave.bpm.engine.impl.Page;
...
import org.finos.flowave.bpm.engine.impl.UserQueryImpl;
...
import org.finos.flowave.bpm.engine.impl.db.DbEntityLifecycleAware;
import org.finos.flowave.bpm.engine.impl.db.EnginePersistenceLogger;
import org.finos.flowave.bpm.engine.impl.db.EntityLoadListener;
import org.finos.flowave.bpm.engine.impl.db.FlushResult;
import org.finos.flowave.bpm.engine.impl.db.HistoricEntity;
import org.finos.flowave.bpm.engine.impl.db.ListQueryParameterObject;
import org.finos.flowave.bpm.engine.impl.db.PersistenceSession;
import org.finos.flowave.bpm.engine.impl.db.entitymanager.cache.CachedDbEntity;
import org.finos.flowave.bpm.engine.impl.db.entitymanager.cache.DbEntityCache;
import org.finos.flowave.bpm.engine.impl.db.entitymanager.cache.DbEntityState;
import org.finos.flowave.bpm.engine.impl.db.entitymanager.operation.DbBulkOperation;
import org.finos.flowave.bpm.engine.impl.db.entitymanager.operation.DbEntityOperation;
import org.finos.flowave.bpm.engine.impl.db.entitymanager.operation.DbOperation;
import org.finos.flowave.bpm.engine.impl.db.entitymanager.operation.DbOperation.State;
import org.finos.flowave.bpm.engine.impl.db.entitymanager.operation.DbOperationManager;
import org.finos.flowave.bpm.engine.impl.db.entitymanager.operation.DbOperationType;
import org.finos.flowave.bpm.engine.impl.identity.db.DbGroupQueryImpl;
import org.finos.flowave.bpm.engine.impl.identity.db.DbUserQueryImpl;
import org.finos.flowave.bpm.engine.impl.interceptor.Session;
import org.finos.flowave.bpm.engine.impl.jobexecutor.JobExecutorContext;
...
import org.finos.flowave.bpm.engine.impl.util.EnsureUtil;
import org.finos.flowave.bpm.engine.repository.ResourceTypes;
