 ...
 */
package org.finos.flowave.bpm.engine.test;
...
import org.finos.flowave.bpm.engine.impl.diagnostics.PlatformDiagnosticsRegistry;
 ...
 * {@link ProcessEngineRule#manageDeployment(org.finos.flowave.bpm.engine.repository.Deployment)}
...
public class ProcessEngineRule extends TestWatcher implements ProcessEngineServices {
  ...
  public void manageDeployment(org.finos.flowave.bpm.engine.repository.Deployment deployment) {
