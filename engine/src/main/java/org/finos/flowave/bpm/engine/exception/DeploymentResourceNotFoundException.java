 ...
 */
package org.finos.flowave.bpm.engine.exception;
...
public class DeploymentResourceNotFoundException extends ProcessEngineException {
  ...
  public DeploymentResourceNotFoundException(String message, Throwable cause) {
    super(message, cause);
  }
  ...
  public DeploymentResourceNotFoundException(Throwable cause) {
    super(cause);
  }
