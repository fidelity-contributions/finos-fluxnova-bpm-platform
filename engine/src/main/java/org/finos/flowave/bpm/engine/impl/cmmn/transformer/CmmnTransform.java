 ...
 */
package org.finos.flowave.bpm.engine.impl.cmmn.transformer;
...
import org.finos.flowave.bpm.engine.impl.cmmn.handler.CmmnElementHandler;
import org.finos.flowave.bpm.engine.impl.cmmn.handler.CmmnHandlerContext;
import org.finos.flowave.bpm.engine.impl.cmmn.handler.DefaultCmmnElementHandlerRegistry;
import org.finos.flowave.bpm.engine.impl.cmmn.handler.ItemHandler;
...
import org.finos.flowave.bpm.engine.impl.core.transformer.Transform;
...
import org.finos.flowave.bpm.model.cmmn.CmmnModelException;
...
import org.finos.flowave.bpm.model.cmmn.instance.Definitions;
import org.finos.flowave.bpm.model.cmmn.instance.EventListener;
import org.finos.flowave.bpm.model.cmmn.instance.HumanTask;
import org.finos.flowave.bpm.model.cmmn.instance.Milestone;
import org.finos.flowave.bpm.model.cmmn.instance.PlanFragment;
...
public class CmmnTransform implements Transform<CaseDefinitionEntity> {
  ...
  protected void transformCasePlanModel(CasePlanModel casePlanModel) {
    ...
    for (CmmnTransformListener transformListener : transformListeners) {
      transformListener.transformCasePlanModel((org.finos.flowave.bpm.model.cmmn.impl.instance.CasePlanModel) casePlanModel, newActivity);
    }
  }
