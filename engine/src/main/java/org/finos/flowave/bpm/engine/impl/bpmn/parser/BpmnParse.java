...
import org.finos.flowave.bpm.engine.ActivityTypes;
...
import org.finos.flowave.bpm.engine.delegate.VariableListener;
import org.finos.flowave.bpm.engine.impl.Condition;
import org.finos.flowave.bpm.engine.impl.HistoryTimeToLiveParser;
import org.finos.flowave.bpm.engine.impl.ProcessEngineLogger;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.BoundaryConditionalEventActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.BoundaryEventActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.CallActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.CallableElementActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.CancelBoundaryEventActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.CancelEndEventActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.CaseCallActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.ClassDelegateActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.CompensationEventActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.DmnBusinessRuleTaskActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.ErrorEndEventActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.EventBasedGatewayActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.EventSubProcessActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.EventSubProcessStartConditionalEventActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.EventSubProcessStartEventActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.ExclusiveGatewayActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.ExternalTaskActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.InclusiveGatewayActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.IntermediateCatchEventActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.IntermediateCatchLinkEventActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.IntermediateConditionalEventBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.IntermediateThrowNoneEventActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.MailActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.ManualTaskActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.MultiInstanceActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.NoneEndEventActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.NoneStartEventActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.ParallelGatewayActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.ParallelMultiInstanceActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.ReceiveTaskActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.ScriptTaskActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.SequentialMultiInstanceActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.ServiceTaskDelegateExpressionActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.ServiceTaskExpressionActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.ShellActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.SubProcessActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.TaskActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.TerminateEndEventActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.ThrowEscalationEventActivityBehavior;
import org.finos.flowave.bpm.engine.impl.bpmn.behavior.ThrowSignalEventActivityBehavior;
...
import org.finos.flowave.bpm.engine.impl.bpmn.listener.ClassDelegateExecutionListener;
import org.finos.flowave.bpm.engine.impl.bpmn.listener.DelegateExpressionExecutionListener;
import org.finos.flowave.bpm.engine.impl.bpmn.listener.ExpressionExecutionListener;
import org.finos.flowave.bpm.engine.impl.bpmn.listener.ScriptExecutionListener;
import org.finos.flowave.bpm.engine.impl.context.Context;
import org.finos.flowave.bpm.engine.impl.core.model.BaseCallableElement;
import org.finos.flowave.bpm.engine.impl.core.model.BaseCallableElement.CallableElementBinding;
...
import org.finos.flowave.bpm.engine.impl.core.variable.mapping.IoMapping;
import org.finos.flowave.bpm.engine.impl.core.variable.mapping.value.ConstantValueProvider;
import org.finos.flowave.bpm.engine.impl.core.variable.mapping.value.NullValueProvider;
import org.finos.flowave.bpm.engine.impl.core.variable.mapping.value.ParameterValueProvider;
import org.finos.flowave.bpm.engine.impl.dmn.result.DecisionResultMapper;
import org.finos.flowave.bpm.engine.impl.el.ElValueProvider;
import org.finos.flowave.bpm.engine.impl.el.Expression;
import org.finos.flowave.bpm.engine.impl.el.ExpressionManager;
import org.finos.flowave.bpm.engine.impl.el.FixedValue;
import org.finos.flowave.bpm.engine.impl.el.UelExpressionCondition;
import org.finos.flowave.bpm.engine.impl.event.EventType;
import org.finos.flowave.bpm.engine.impl.form.FormDefinition;
import org.finos.flowave.bpm.engine.impl.form.handler.DefaultStartFormHandler;
import org.finos.flowave.bpm.engine.impl.form.handler.DefaultTaskFormHandler;
import org.finos.flowave.bpm.engine.impl.form.handler.DelegateStartFormHandler;
import org.finos.flowave.bpm.engine.impl.form.handler.DelegateTaskFormHandler;
import org.finos.flowave.bpm.engine.impl.form.handler.StartFormHandler;
import org.finos.flowave.bpm.engine.impl.form.handler.TaskFormHandler;
import org.finos.flowave.bpm.engine.impl.jobexecutor.AsyncAfterMessageJobDeclaration;
import org.finos.flowave.bpm.engine.impl.jobexecutor.AsyncBeforeMessageJobDeclaration;
import org.finos.flowave.bpm.engine.impl.jobexecutor.EventSubscriptionJobDeclaration;
import org.finos.flowave.bpm.engine.impl.jobexecutor.JobDeclaration;
import org.finos.flowave.bpm.engine.impl.jobexecutor.MessageJobDeclaration;
import org.finos.flowave.bpm.engine.impl.jobexecutor.TimerCatchIntermediateEventJobHandler;
import org.finos.flowave.bpm.engine.impl.jobexecutor.TimerDeclarationImpl;
import org.finos.flowave.bpm.engine.impl.jobexecutor.TimerDeclarationType;
import org.finos.flowave.bpm.engine.impl.jobexecutor.TimerEventJobHandler;
...
import org.finos.flowave.bpm.engine.impl.persistence.entity.DeploymentEntity;
import org.finos.flowave.bpm.engine.impl.persistence.entity.JobEntity;
import org.finos.flowave.bpm.engine.impl.persistence.entity.ProcessDefinitionEntity;
import org.finos.flowave.bpm.engine.impl.pvm.PvmTransition;
import org.finos.flowave.bpm.engine.impl.pvm.delegate.ActivityBehavior;
import org.finos.flowave.bpm.engine.impl.pvm.process.ActivityImpl;
import org.finos.flowave.bpm.engine.impl.pvm.process.ActivityStartBehavior;
import org.finos.flowave.bpm.engine.impl.pvm.process.HasDIBounds;
import org.finos.flowave.bpm.engine.impl.pvm.process.Lane;
import org.finos.flowave.bpm.engine.impl.pvm.process.LaneSet;
import org.finos.flowave.bpm.engine.impl.pvm.process.ParticipantProcess;
import org.finos.flowave.bpm.engine.impl.pvm.process.ProcessDefinitionImpl;
import org.finos.flowave.bpm.engine.impl.pvm.process.ScopeImpl;
import org.finos.flowave.bpm.engine.impl.pvm.process.TransitionImpl;
import org.finos.flowave.bpm.engine.impl.pvm.runtime.LegacyBehavior;
import org.finos.flowave.bpm.engine.impl.scripting.ExecutableScript;
import org.finos.flowave.bpm.engine.impl.scripting.ScriptCondition;
import org.finos.flowave.bpm.engine.impl.scripting.engine.ScriptingEngines;
import org.finos.flowave.bpm.engine.impl.task.TaskDecorator;
import org.finos.flowave.bpm.engine.impl.task.TaskDefinition;
import org.finos.flowave.bpm.engine.impl.task.listener.ClassDelegateTaskListener;
import org.finos.flowave.bpm.engine.impl.task.listener.DelegateExpressionTaskListener;
import org.finos.flowave.bpm.engine.impl.task.listener.ExpressionTaskListener;
import org.finos.flowave.bpm.engine.impl.task.listener.ScriptTaskListener;
import org.finos.flowave.bpm.engine.impl.util.DecisionEvaluationUtil;
import org.finos.flowave.bpm.engine.impl.util.ReflectUtil;
import org.finos.flowave.bpm.engine.impl.util.ScriptUtil;
import org.finos.flowave.bpm.engine.impl.util.StringUtil;
import org.finos.flowave.bpm.engine.impl.util.xml.Element;
import org.finos.flowave.bpm.engine.impl.util.xml.Namespace;
import org.finos.flowave.bpm.engine.impl.util.xml.Parse;
import org.finos.flowave.bpm.engine.impl.variable.VariableDeclaration;
