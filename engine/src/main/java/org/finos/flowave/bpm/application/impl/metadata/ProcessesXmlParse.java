 ...
 */
package org.finos.flowave.bpm.application.impl.metadata;

import static org.finos.flowave.bpm.container.impl.metadata.DeploymentMetadataConstants.NAME;
import static org.finos.flowave.bpm.container.impl.metadata.DeploymentMetadataConstants.PROCESS;
import static org.finos.flowave.bpm.container.impl.metadata.DeploymentMetadataConstants.PROCESS_ARCHIVE;
import static org.finos.flowave.bpm.container.impl.metadata.DeploymentMetadataConstants.PROCESS_ENGINE;
import static org.finos.flowave.bpm.container.impl.metadata.DeploymentMetadataConstants.PROPERTIES;
import static org.finos.flowave.bpm.container.impl.metadata.DeploymentMetadataConstants.RESOURCE;
import static org.finos.flowave.bpm.container.impl.metadata.DeploymentMetadataConstants.TENANT_ID;
...
import org.finos.flowave.bpm.application.impl.metadata.spi.ProcessArchiveXml;
import org.finos.flowave.bpm.application.impl.metadata.spi.ProcessesXml;
import org.finos.flowave.bpm.container.impl.metadata.DeploymentMetadataParse;
import org.finos.flowave.bpm.container.impl.metadata.spi.ProcessEngineXml;
import org.finos.flowave.bpm.engine.impl.util.xml.Element;
import org.finos.flowave.bpm.engine.impl.util.xml.Parse;
import org.finos.flowave.bpm.engine.impl.util.xml.Parser;
