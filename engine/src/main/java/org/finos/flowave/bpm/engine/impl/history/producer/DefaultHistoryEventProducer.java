 ...
 */
package org.finos.flowave.bpm.engine.impl.history.producer;

import static org.finos.flowave.bpm.engine.ProcessEngineConfiguration.HISTORY_REMOVAL_TIME_STRATEGY_END;
import static org.finos.flowave.bpm.engine.ProcessEngineConfiguration.HISTORY_REMOVAL_TIME_STRATEGY_START;
import static org.finos.flowave.bpm.engine.impl.util.ExceptionUtil.createJobExceptionByteArray;
import static org.finos.flowave.bpm.engine.impl.util.ExceptionUtil.getExceptionStacktrace;
import static org.finos.flowave.bpm.engine.impl.util.StringUtil.toByteArray;
...
import org.finos.flowave.bpm.engine.delegate.VariableScope;
import org.finos.flowave.bpm.engine.externaltask.ExternalTask;
import org.finos.flowave.bpm.engine.history.ExternalTaskState;
import org.finos.flowave.bpm.engine.history.HistoricProcessInstance;
import org.finos.flowave.bpm.engine.history.IncidentState;
import org.finos.flowave.bpm.engine.history.JobState;
...
import org.finos.flowave.bpm.engine.impl.cmmn.entity.repository.CaseDefinitionEntity;
...
import org.finos.flowave.bpm.engine.impl.history.event.HistoricActivityInstanceEventEntity;
import org.finos.flowave.bpm.engine.impl.history.event.HistoricExternalTaskLogEntity;
import org.finos.flowave.bpm.engine.impl.history.event.HistoricFormPropertyEventEntity;
import org.finos.flowave.bpm.engine.impl.history.event.HistoricIdentityLinkLogEventEntity;
import org.finos.flowave.bpm.engine.impl.history.event.HistoricIncidentEventEntity;
import org.finos.flowave.bpm.engine.impl.history.event.HistoricProcessInstanceEventEntity;
import org.finos.flowave.bpm.engine.impl.history.event.HistoricTaskInstanceEventEntity;
import org.finos.flowave.bpm.engine.impl.history.event.HistoricVariableUpdateEventEntity;
...
import org.finos.flowave.bpm.engine.impl.migration.instance.MigratingActivityInstance;
import org.finos.flowave.bpm.engine.impl.oplog.UserOperationLogContext;
import org.finos.flowave.bpm.engine.impl.oplog.UserOperationLogContextEntry;
...
import org.finos.flowave.bpm.engine.impl.persistence.entity.ExternalTaskEntity;
import org.finos.flowave.bpm.engine.impl.persistence.entity.HistoricJobLogEventEntity;
import org.finos.flowave.bpm.engine.impl.persistence.entity.IncidentEntity;
...
import org.finos.flowave.bpm.engine.impl.persistence.entity.PropertyChange;
...
import org.finos.flowave.bpm.engine.impl.pvm.PvmScope;
import org.finos.flowave.bpm.engine.impl.pvm.runtime.CompensationBehavior;
