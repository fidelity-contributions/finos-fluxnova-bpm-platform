...
import org.finos.flowave.bpm.engine.batch.history.HistoricBatchQuery;
import org.finos.flowave.bpm.engine.history.CleanableHistoricBatchReport;
...
import org.finos.flowave.bpm.engine.history.CleanableHistoricProcessInstanceReport;
import org.finos.flowave.bpm.engine.history.HistoricActivityInstanceQuery;
import org.finos.flowave.bpm.engine.history.HistoricActivityStatisticsQuery;
import org.finos.flowave.bpm.engine.history.HistoricCaseActivityInstanceQuery;
import org.finos.flowave.bpm.engine.history.HistoricCaseActivityStatisticsQuery;
import org.finos.flowave.bpm.engine.history.HistoricCaseInstanceQuery;
import org.finos.flowave.bpm.engine.history.HistoricDecisionInstanceQuery;
import org.finos.flowave.bpm.engine.history.HistoricDecisionInstanceStatisticsQuery;
import org.finos.flowave.bpm.engine.history.HistoricDetailQuery;
import org.finos.flowave.bpm.engine.history.HistoricExternalTaskLogQuery;
import org.finos.flowave.bpm.engine.history.HistoricIncidentQuery;
import org.finos.flowave.bpm.engine.history.HistoricJobLogQuery;
...
import org.finos.flowave.bpm.engine.history.HistoricTaskInstanceQuery;
import org.finos.flowave.bpm.engine.history.HistoricTaskInstanceReport;
import org.finos.flowave.bpm.engine.history.HistoricVariableInstanceQuery;
import org.finos.flowave.bpm.engine.history.NativeHistoricActivityInstanceQuery;
import org.finos.flowave.bpm.engine.history.NativeHistoricCaseActivityInstanceQuery;
import org.finos.flowave.bpm.engine.history.NativeHistoricCaseInstanceQuery;
import org.finos.flowave.bpm.engine.history.NativeHistoricDecisionInstanceQuery;
import org.finos.flowave.bpm.engine.history.NativeHistoricProcessInstanceQuery;
import org.finos.flowave.bpm.engine.history.NativeHistoricTaskInstanceQuery;
import org.finos.flowave.bpm.engine.history.NativeHistoricVariableInstanceQuery;
import org.finos.flowave.bpm.engine.history.SetRemovalTimeSelectModeForHistoricBatchesBuilder;
import org.finos.flowave.bpm.engine.history.SetRemovalTimeSelectModeForHistoricDecisionInstancesBuilder;
import org.finos.flowave.bpm.engine.history.SetRemovalTimeSelectModeForHistoricProcessInstancesBuilder;
import org.finos.flowave.bpm.engine.history.SetRemovalTimeToHistoricBatchesBuilder;
import org.finos.flowave.bpm.engine.history.SetRemovalTimeToHistoricDecisionInstancesBuilder;
import org.finos.flowave.bpm.engine.history.UserOperationLogQuery;
import org.finos.flowave.bpm.engine.impl.batch.history.DeleteHistoricBatchCmd;
import org.finos.flowave.bpm.engine.impl.batch.history.HistoricBatchQueryImpl;
import org.finos.flowave.bpm.engine.impl.cmd.DeleteHistoricCaseInstanceCmd;
import org.finos.flowave.bpm.engine.impl.cmd.DeleteHistoricCaseInstancesBulkCmd;
import org.finos.flowave.bpm.engine.impl.cmd.DeleteHistoricProcessInstancesCmd;
import org.finos.flowave.bpm.engine.impl.cmd.DeleteHistoricTaskInstanceCmd;
import org.finos.flowave.bpm.engine.impl.cmd.DeleteHistoricVariableInstanceCmd;
import org.finos.flowave.bpm.engine.impl.cmd.DeleteHistoricVariableInstancesByProcessInstanceIdCmd;
import org.finos.flowave.bpm.engine.impl.cmd.DeleteUserOperationLogEntryCmd;
import org.finos.flowave.bpm.engine.impl.cmd.FindHistoryCleanupJobsCmd;
import org.finos.flowave.bpm.engine.impl.cmd.GetHistoricExternalTaskLogErrorDetailsCmd;
import org.finos.flowave.bpm.engine.impl.cmd.GetHistoricJobLogExceptionStacktraceCmd;
import org.finos.flowave.bpm.engine.impl.cmd.HistoryCleanupCmd;
import org.finos.flowave.bpm.engine.impl.cmd.batch.DeleteHistoricProcessInstancesBatchCmd;
import org.finos.flowave.bpm.engine.impl.dmn.cmd.DeleteHistoricDecisionInstanceByDefinitionIdCmd;
import org.finos.flowave.bpm.engine.impl.dmn.cmd.DeleteHistoricDecisionInstanceByInstanceIdCmd;
import org.finos.flowave.bpm.engine.impl.dmn.cmd.DeleteHistoricDecisionInstancesBatchCmd;
import org.finos.flowave.bpm.engine.impl.dmn.cmd.DeleteHistoricDecisionInstancesBulkCmd;
import org.finos.flowave.bpm.engine.history.SetRemovalTimeToHistoricProcessInstancesBuilder;
import org.finos.flowave.bpm.engine.impl.history.SetRemovalTimeToHistoricBatchesBuilderImpl;
import org.finos.flowave.bpm.engine.impl.history.SetRemovalTimeToHistoricDecisionInstancesBuilderImpl;
import org.finos.flowave.bpm.engine.impl.history.SetRemovalTimeToHistoricProcessInstancesBuilderImpl;
