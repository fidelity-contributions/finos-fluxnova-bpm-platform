...
import org.finos.flowave.bpm.engine.impl.ProcessEngineInfoImpl;
 ...
 * (<code>org.finos.flowave.bpm.engine.test..impl.servlet.listener.ProcessEnginesServletContextListener</code>).  That way,
...
public abstract class ProcessEngines {
  ...
  protected static void initProcessEngineFromSpringResource(URL resource) {
    try {
      Class< ? > springConfigurationHelperClass = ReflectUtil.loadClass("org.finos.flowave.bpm.engine.spring.SpringConfigurationHelper");
