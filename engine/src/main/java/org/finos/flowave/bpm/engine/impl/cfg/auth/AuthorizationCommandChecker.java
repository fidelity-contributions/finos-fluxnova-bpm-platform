 ...
 */
package org.finos.flowave.bpm.engine.impl.cfg.auth;

import static org.finos.flowave.bpm.engine.authorization.Authorization.ANY;
import static org.finos.flowave.bpm.engine.authorization.Permissions.CREATE;
import static org.finos.flowave.bpm.engine.authorization.Permissions.CREATE_INSTANCE;
import static org.finos.flowave.bpm.engine.authorization.Permissions.DELETE;
import static org.finos.flowave.bpm.engine.authorization.Permissions.DELETE_HISTORY;
import static org.finos.flowave.bpm.engine.authorization.Permissions.DELETE_INSTANCE;
...
import static org.finos.flowave.bpm.engine.authorization.Permissions.TASK_ASSIGN;
import static org.finos.flowave.bpm.engine.authorization.Permissions.TASK_WORK;
...
import static org.finos.flowave.bpm.engine.authorization.Permissions.UPDATE_TASK;
...
import org.finos.flowave.bpm.engine.authorization.ProcessDefinitionPermissions;
import org.finos.flowave.bpm.engine.authorization.ProcessInstancePermissions;
import org.finos.flowave.bpm.engine.authorization.Resources;
import org.finos.flowave.bpm.engine.authorization.SystemPermissions;
import org.finos.flowave.bpm.engine.authorization.TaskPermissions;
import org.finos.flowave.bpm.engine.authorization.UserOperationLogCategoryPermissions;
...
import org.finos.flowave.bpm.engine.impl.batch.history.HistoricBatchEntity;
...
import org.finos.flowave.bpm.engine.impl.dmn.entity.repository.DecisionRequirementsDefinitionEntity;
import org.finos.flowave.bpm.engine.impl.history.event.HistoricExternalTaskLogEntity;
...
import org.finos.flowave.bpm.engine.impl.persistence.entity.HistoricJobLogEventEntity;
import org.finos.flowave.bpm.engine.impl.persistence.entity.HistoricProcessInstanceEntity;
import org.finos.flowave.bpm.engine.impl.persistence.entity.HistoricTaskInstanceEntity;
import org.finos.flowave.bpm.engine.impl.persistence.entity.HistoricVariableInstanceEntity;
