 ...
 */
package org.finos.flowave.bpm.engine.impl.persistence.entity;

import static org.finos.flowave.bpm.engine.authorization.Permissions.CREATE;
import static org.finos.flowave.bpm.engine.authorization.Permissions.DELETE;
import static org.finos.flowave.bpm.engine.authorization.Permissions.READ;
import static org.finos.flowave.bpm.engine.authorization.Permissions.READ_HISTORY;
import static org.finos.flowave.bpm.engine.authorization.Permissions.READ_INSTANCE;
import static org.finos.flowave.bpm.engine.authorization.Permissions.READ_TASK;
import static org.finos.flowave.bpm.engine.authorization.Permissions.UPDATE;
import static org.finos.flowave.bpm.engine.authorization.Permissions.UPDATE_INSTANCE;
import static org.finos.flowave.bpm.engine.authorization.ProcessDefinitionPermissions.READ_INSTANCE_VARIABLE;
import static org.finos.flowave.bpm.engine.authorization.Resources.AUTHORIZATION;
import static org.finos.flowave.bpm.engine.authorization.Resources.BATCH;
import static org.finos.flowave.bpm.engine.authorization.Resources.DECISION_DEFINITION;
import static org.finos.flowave.bpm.engine.authorization.Resources.DECISION_REQUIREMENTS_DEFINITION;
import static org.finos.flowave.bpm.engine.authorization.Resources.DEPLOYMENT;
import static org.finos.flowave.bpm.engine.authorization.Resources.HISTORIC_PROCESS_INSTANCE;
import static org.finos.flowave.bpm.engine.authorization.Resources.HISTORIC_TASK;
import static org.finos.flowave.bpm.engine.authorization.Resources.PROCESS_DEFINITION;
import static org.finos.flowave.bpm.engine.authorization.Resources.PROCESS_INSTANCE;
import static org.finos.flowave.bpm.engine.authorization.Resources.TASK;
import static org.finos.flowave.bpm.engine.authorization.TaskPermissions.READ_VARIABLE;
...
import org.finos.flowave.bpm.engine.AuthorizationException;
...
import org.finos.flowave.bpm.engine.authorization.HistoricProcessInstancePermissions;
import org.finos.flowave.bpm.engine.authorization.HistoricTaskPermissions;
import org.finos.flowave.bpm.engine.authorization.MissingAuthorization;
...
import org.finos.flowave.bpm.engine.authorization.Resource;
import org.finos.flowave.bpm.engine.authorization.Resources;
import org.finos.flowave.bpm.engine.impl.AbstractQuery;
import org.finos.flowave.bpm.engine.impl.ActivityStatisticsQueryImpl;
import org.finos.flowave.bpm.engine.impl.AuthorizationQueryImpl;
import org.finos.flowave.bpm.engine.impl.DeploymentQueryImpl;
import org.finos.flowave.bpm.engine.impl.DeploymentStatisticsQueryImpl;
import org.finos.flowave.bpm.engine.impl.EventSubscriptionQueryImpl;
import org.finos.flowave.bpm.engine.impl.ExternalTaskQueryImpl;
import org.finos.flowave.bpm.engine.impl.HistoricActivityInstanceQueryImpl;
import org.finos.flowave.bpm.engine.impl.HistoricDecisionInstanceQueryImpl;
import org.finos.flowave.bpm.engine.impl.HistoricDetailQueryImpl;
import org.finos.flowave.bpm.engine.impl.HistoricExternalTaskLogQueryImpl;
import org.finos.flowave.bpm.engine.impl.HistoricIdentityLinkLogQueryImpl;
import org.finos.flowave.bpm.engine.impl.HistoricIncidentQueryImpl;
import org.finos.flowave.bpm.engine.impl.HistoricJobLogQueryImpl;
import org.finos.flowave.bpm.engine.impl.HistoricProcessInstanceQueryImpl;
import org.finos.flowave.bpm.engine.impl.HistoricTaskInstanceQueryImpl;
import org.finos.flowave.bpm.engine.impl.HistoricVariableInstanceQueryImpl;
import org.finos.flowave.bpm.engine.impl.IncidentQueryImpl;
import org.finos.flowave.bpm.engine.impl.JobDefinitionQueryImpl;
import org.finos.flowave.bpm.engine.impl.JobQueryImpl;
import org.finos.flowave.bpm.engine.impl.ProcessDefinitionQueryImpl;
import org.finos.flowave.bpm.engine.impl.ProcessDefinitionStatisticsQueryImpl;
import org.finos.flowave.bpm.engine.impl.ProcessEngineLogger;
import org.finos.flowave.bpm.engine.impl.TaskQueryImpl;
import org.finos.flowave.bpm.engine.impl.UserOperationLogQueryImpl;
import org.finos.flowave.bpm.engine.impl.VariableInstanceQueryImpl;
import org.finos.flowave.bpm.engine.impl.batch.BatchQueryImpl;
import org.finos.flowave.bpm.engine.impl.batch.BatchStatisticsQueryImpl;
import org.finos.flowave.bpm.engine.impl.batch.history.HistoricBatchQueryImpl;
import org.finos.flowave.bpm.engine.impl.cfg.CommandChecker;
import org.finos.flowave.bpm.engine.impl.context.Context;
import org.finos.flowave.bpm.engine.impl.db.AuthorizationCheck;
import org.finos.flowave.bpm.engine.impl.db.CompositePermissionCheck;
import org.finos.flowave.bpm.engine.impl.db.DbEntity;
import org.finos.flowave.bpm.engine.impl.db.EnginePersistenceLogger;
import org.finos.flowave.bpm.engine.impl.db.ListQueryParameterObject;
import org.finos.flowave.bpm.engine.impl.db.PermissionCheck;
import org.finos.flowave.bpm.engine.impl.db.PermissionCheckBuilder;
import org.finos.flowave.bpm.engine.impl.db.entitymanager.operation.DbOperation;
import org.finos.flowave.bpm.engine.impl.dmn.entity.repository.DecisionDefinitionQueryImpl;
import org.finos.flowave.bpm.engine.impl.dmn.entity.repository.DecisionRequirementsDefinitionQueryImpl;
...
import org.finos.flowave.bpm.engine.impl.persistence.entity.util.AuthManagerUtil;
import org.finos.flowave.bpm.engine.impl.persistence.entity.util.AuthManagerUtil.VariablePermissions;
import org.finos.flowave.bpm.engine.impl.util.ResourceTypeUtil;
