 ...
 */
package org.finos.flowave.bpm.engine.test.api.history.removaltime.cleanup;
...
import static org.finos.flowave.bpm.engine.impl.jobexecutor.historycleanup.HistoryCleanupHandler.MAX_BATCH_SIZE;
...
import org.finos.flowave.bpm.engine.history.CleanableHistoricBatchReportResult;
import org.finos.flowave.bpm.engine.history.CleanableHistoricDecisionInstanceReportResult;
import org.finos.flowave.bpm.engine.history.CleanableHistoricProcessInstanceReportResult;
...
public class HistoryCleanupRemovalTimeTest {
  ...
  @Deployment(resources = {
    "org/finos/flowave/bpm/engine/test/dmn/deployment/drdDish.dmn11.xml"
  })
