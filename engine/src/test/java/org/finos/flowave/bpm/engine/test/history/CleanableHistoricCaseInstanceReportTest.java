...
public class CleanableHistoricCaseInstanceReportTest {
  ...
  public void setUp() {
    ...
    testRule.deploy("org/finos/flowave/bpm/engine/test/repository/one.cmmn");
  }
  ...
  public void testReportComplex() {
    // given
    testRule.deploy("org/finos/flowave/bpm/engine/test/api/cmmn/oneCaseTaskCase.cmmn", "org/finos/flowave/bpm/engine/test/api/cmmn/oneTaskCase.cmmn",
        "org/finos/flowave/bpm/engine/test/api/cmmn/oneTaskCaseWithHistoryTimeToLive.cmmn");
