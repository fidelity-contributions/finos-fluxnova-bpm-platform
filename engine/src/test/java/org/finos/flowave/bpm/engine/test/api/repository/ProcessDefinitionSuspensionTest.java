...
public class ProcessDefinitionSuspensionTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources={"org/finos/flowave/bpm/engine/test/api/repository/processOne.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources={
          "org/finos/flowave/bpm/engine/test/api/repository/processOne.bpmn20.xml",
          "org/finos/flowave/bpm/engine/test/api/repository/processTwo.bpmn20.xml"
          })
  @Test
  ...
  public void testSuspendMultipleProcessDefinitionsByKey () {
    ...
    for (int i=0; i<nrOfProcessDefinitions; i++) {
      repositoryService.createDeployment()
        .addClasspathResource("org/finos/flowave/bpm/engine/test/api/runtime/oneTaskProcess.bpmn20.xml").deploy();
    }
  ...
  public void testDelayedSuspendMultipleProcessDefinitionsByKey () {
    ...
    assertEquals(latestProcessDefinition.getDeploymentId(), job.getDeploymentId());
    // execute job
    managementService.executeJob(job.getId());
  ...
  public void testMultipleSuspendByKey_shouldSuspendJobDefinitionAndRetainJob() {
    ...
    for (int i=0; i<nrOfProcessDefinitions; i++) {
      repositoryService.createDeployment()
        .addClasspathResource("org/finos/flowave/bpm/engine/test/api/repository/ProcessDefinitionSuspensionTest.testWithOneAsyncServiceTask.bpmn").deploy();
  ...
  @Deployment(resources = {"org/finos/flowave/bpm/engine/test/api/repository/ProcessDefinitionSuspensionTest.testSuspendStartTimerOnProcessDefinitionSuspension.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources={"org/finos/flowave/bpm/engine/test/api/repository/processOne.bpmn20.xml"})
  @Test
  public void testDelayedSuspendAndActivateProcessDefinitionByKeyUsingBuilder() {
