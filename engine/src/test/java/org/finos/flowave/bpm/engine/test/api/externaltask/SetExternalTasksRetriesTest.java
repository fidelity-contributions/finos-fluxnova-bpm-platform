...
import org.finos.flowave.bpm.engine.test.api.AbstractAsyncOperationsTest;
...
public class SetExternalTasksRetriesTest extends AbstractAsyncOperationsTest {
  ...
  protected void deployTestProcesses() {
    org.finos.flowave.bpm.engine.repository.Deployment deployment = engineRule.getRepositoryService().createDeployment()
      ...
      .addClasspathResource("org/finos/flowave/bpm/engine/test/api/externaltask/externalTaskPriorityExpression.bpmn20.xml")
      .deploy();
