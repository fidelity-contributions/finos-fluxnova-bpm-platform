...
import static org.finos.flowave.bpm.engine.test.util.MigrationPlanValidationReportAssert.assertThat;
...
public class MigrationExternalTaskTest {
  ...
  @Test
  @Deployment(resources = {"org/finos/flowave/bpm/engine/test/api/externaltask/ExternalTaskWithoutIdTest.bpmn"})
  public void testProcessDefinitionWithoutIdField() {
     // given

    ProcessDefinition sourceProcessDefinition = testHelper.deploy("org/finos/flowave/bpm/engine/test/api/externaltask/ExternalTaskWithoutIdTest.bpmn").getDeployedProcessDefinitions().get(0);
    ProcessDefinition targetProcessDefinition = testHelper.deploy("org/finos/flowave/bpm/engine/test/api/externaltask/ExternalTaskWithoutIdTest.bpmn").getDeployedProcessDefinitions().get(0);
  ...
  public void testProcessDefinitionWithIdField() {
    ...
    ProcessDefinition sourceProcessDefinition = testHelper.deploy("org/finos/flowave/bpm/engine/test/api/externaltask/ExternalTaskWithIdTest.bpmn").getDeployedProcessDefinitions().get(0);
    ProcessDefinition targetProcessDefinition = testHelper.deploy("org/finos/flowave/bpm/engine/test/api/externaltask/ExternalTaskWithIdTest.bpmn").getDeployedProcessDefinitions().get(0);
