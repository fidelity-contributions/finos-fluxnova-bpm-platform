...
public class ExecutionVariablesTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources = "org/finos/flowave/bpm/engine/test/api/variables/ExecutionVariablesTest.testTreeCompactionWithLocalVariableOnConcurrentExecution.bpmn20.xml")
  @Test
  ...
  @Deployment(resources = "org/finos/flowave/bpm/engine/test/api/variables/ExecutionVariablesTest.testTreeCompactionForkParallelGateway.bpmn20.xml")
  @Test
