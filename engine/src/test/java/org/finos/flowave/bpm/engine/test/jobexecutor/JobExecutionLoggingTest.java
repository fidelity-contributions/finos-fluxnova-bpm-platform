...
public class JobExecutionLoggingTest {
  ...
  public ProcessEngineLoggingRule loggingRule = new ProcessEngineLoggingRule().watch(
      "org.finos.flowave.bpm.engine.jobexecutor", Level.DEBUG);
  ...
  @Test
  @Deployment(resources = { "org/finos/flowave/bpm/engine/test/jobexecutor/SimpleAsyncDelayProcess.bpmn20.xml" })
  ...
  @Test
  @Deployment(resources = { "org/finos/flowave/bpm/engine/test/jobexecutor/delegateThrowsException.bpmn20.xml" })
