 ...
 */
package org.finos.flowave.bpm.engine.test.standalone.db.entitymanager;
...
import static org.finos.flowave.bpm.engine.impl.test.TestHelper.assertAndEnsureCleanDbAndCache;
...
import org.finos.flowave.bpm.engine.impl.management.DatabasePurgeReport;
import org.finos.flowave.bpm.engine.impl.management.PurgeReport;
import org.finos.flowave.bpm.engine.impl.persistence.deploy.cache.CachePurgeReport;
...
public class PurgeDatabaseTest {
  ...
  public void testPurgeCmmnProcess() {
    ...
    engineRule.getRepositoryService()
      .createDeployment()
      .addClasspathResource("org/finos/flowave/bpm/engine/test/standalone/db/entitymanager/PurgeDatabaseTest.testPurgeCmmnProcess.cmmn")
      .deploy();
    VariableMap variables = Variables.createVariables();
    variables.put("key", "value");
  ...
  public void testPurgeDmnProcess() {
    ...
    engineRule.getRepositoryService()
      .createDeployment()
      .addClasspathResource("org/finos/flowave/bpm/engine/test/standalone/db/entitymanager/PurgeDatabaseTest.testPurgeDmnProcess.dmn")
      .deploy();
    VariableMap variables = Variables.createVariables()
      .putValue("key", "value")
