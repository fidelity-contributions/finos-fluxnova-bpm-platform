...
import static org.finos.flowave.bpm.engine.test.api.runtime.migration.models.ConditionalModels.BOUNDARY_ID;
import static org.finos.flowave.bpm.engine.test.api.runtime.migration.models.ConditionalModels.CONDITIONAL_PROCESS_KEY;
import static org.finos.flowave.bpm.engine.test.api.runtime.migration.models.ConditionalModels.CONDITION_ID;
import static org.finos.flowave.bpm.engine.test.api.runtime.migration.models.EventSubProcessModels.EVENT_SUB_PROCESS_ID;
import static org.finos.flowave.bpm.engine.test.api.runtime.migration.models.EventSubProcessModels.EVENT_SUB_PROCESS_START_ID;
import static org.finos.flowave.bpm.engine.test.api.runtime.migration.models.EventSubProcessModels.EVENT_SUB_PROCESS_TASK_ID;
import static org.finos.flowave.bpm.engine.test.api.runtime.migration.models.EventSubProcessModels.USER_TASK_ID;
import static org.finos.flowave.bpm.engine.test.api.runtime.migration.models.EventSubProcessModels.VAR_CONDITION;
import static org.finos.flowave.bpm.engine.test.util.MigrationPlanAssert.assertThat;
import static org.finos.flowave.bpm.engine.test.util.MigrationPlanAssert.migrate;
import static org.junit.Assert.assertNotNull;

import org.finos.flowave.bpm.engine.migration.MigrationInstructionsBuilder;
...
import org.finos.flowave.bpm.engine.test.api.runtime.migration.models.EventBasedGatewayModels;
import org.finos.flowave.bpm.engine.test.api.runtime.migration.models.EventSubProcessModels;
import org.finos.flowave.bpm.engine.test.api.runtime.migration.models.ExternalTaskModels;
import org.finos.flowave.bpm.engine.test.api.runtime.migration.models.GatewayModels;
import org.finos.flowave.bpm.engine.test.api.runtime.migration.models.MessageReceiveModels;
import org.finos.flowave.bpm.engine.test.api.runtime.migration.models.MultiInstanceProcessModels;
import org.finos.flowave.bpm.engine.test.api.runtime.migration.models.ProcessModels;
import org.finos.flowave.bpm.engine.test.api.runtime.migration.models.ServiceTaskModels;
import org.finos.flowave.bpm.engine.test.api.runtime.migration.models.TransactionModels;
import org.finos.flowave.bpm.engine.test.util.MigrationPlanAssert;
