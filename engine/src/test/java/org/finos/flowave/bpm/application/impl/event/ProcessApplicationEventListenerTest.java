...
public class ProcessApplicationEventListenerTest {
  ...
  public static ProcessEngineBootstrapRule bootstrapRule = new ProcessEngineBootstrapRule(
      "org/finos/flowave/bpm/application/impl/event/pa.event.listener.camunda.cfg.xml");
  @Rule
  ...
  @Test
  @Deployment(resources = { "org/finos/flowave/bpm/application/impl/event/ProcessApplicationEventListenerTest.testExecutionListener.bpmn20.xml" })
