 ...
 */
package org.finos.flowave.bpm.engine.test.cmmn.transformer;
...
import org.finos.flowave.bpm.engine.impl.cmmn.transformer.CmmnTransform;
...
public class CmmnTransformerTest {
  ...
  protected List<CaseDefinitionEntity> transform() {
    ...
    byte[] model = org.finos.flowave.bpm.engine.impl.util.IoUtil.readInputStream(inputStream, "model");
