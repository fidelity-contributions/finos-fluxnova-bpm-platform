...
public class BPMNParseListenerTest {
  ...
  public static ProcessEngineBootstrapRule bootstrapRule = new ProcessEngineBootstrapRule(
      "org/finos/flowave/bpm/engine/test/standalone/deploy/bpmn.parse.listener.camunda.cfg.xml");
  ...
  public void testAlterProcessDefinitionKeyWhenDeploying() throws Exception {
    ...
    // when
    engineTestRule.deploy("org/finos/flowave/bpm/engine/test/standalone/deploy/"
