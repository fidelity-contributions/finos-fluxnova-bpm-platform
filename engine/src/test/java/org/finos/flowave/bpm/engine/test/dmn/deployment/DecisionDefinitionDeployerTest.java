 ...
 */
package org.finos.flowave.bpm.engine.test.dmn.deployment;
...
import org.finos.flowave.bpm.engine.repository.DeploymentQuery;
...
import org.finos.flowave.bpm.model.dmn.Dmn;
import org.finos.flowave.bpm.model.dmn.DmnModelInstance;
import org.finos.flowave.bpm.model.dmn.HitPolicy;
import org.finos.flowave.bpm.model.dmn.impl.DmnModelConstants;
import org.finos.flowave.bpm.model.dmn.instance.Decision;
import org.finos.flowave.bpm.model.dmn.instance.DecisionTable;
import org.finos.flowave.bpm.model.dmn.instance.Definitions;
import org.finos.flowave.bpm.model.dmn.instance.Input;
import org.finos.flowave.bpm.model.dmn.instance.InputExpression;
import org.finos.flowave.bpm.model.dmn.instance.Output;
import org.finos.flowave.bpm.model.dmn.instance.Text;
...
public class DecisionDefinitionDeployerTest {
  ...
  protected static final String DMN_CHECK_ORDER_RESOURCE = "org/finos/flowave/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testDmnDeployment.dmn11.xml";
  protected static final String DMN_CHECK_ORDER_RESOURCE_DMN_SUFFIX = "org/finos/flowave/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testDmnDeployment.dmn";
  protected static final String DMN_SCORE_RESOURCE = "org/finos/flowave/bpm/engine/test/dmn/deployment/dmnScore.dmn11.xml";

  protected static final String DMN_DECISION_LITERAL_EXPRESSION = "org/finos/flowave/bpm/engine/test/dmn/deployment/DecisionWithLiteralExpression.dmn";

  protected static final String DRD_SCORE_RESOURCE = "org/finos/flowave/bpm/engine/test/dmn/deployment/drdScore.dmn11.xml";
  protected static final String DRD_SCORE_V2_RESOURCE = "org/finos/flowave/bpm/engine/test/dmn/deployment/drdScore_v2.dmn11.xml";
  protected static final String DRD_DISH_RESOURCE = "org/finos/flowave/bpm/engine/test/dmn/deployment/drdDish.dmn11.xml";
  ...
  public void duplicateIdInDeployment() {
    String resourceName1 = "org/finos/flowave/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testDuplicateIdInDeployment.dmn11.xml";
    String resourceName2 = "org/finos/flowave/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testDuplicateIdInDeployment2.dmn11.xml";
  ...
  @Deployment(resources = {
    "org/finos/flowave/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testDecisionDiagramResource.dmn11.xml",
    "org/finos/flowave/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testDecisionDiagramResource.png"
  })
  @Test
  public void getDecisionDiagramResource() {
    String resourcePrefix = "org/finos/flowave/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testDecisionDiagramResource";
  ...
  @Deployment(resources = {
    "org/finos/flowave/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testMultipleDecisionDiagramResource.dmn11.xml",
    "org/finos/flowave/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testMultipleDecisionDiagramResource.decision1.png",
    "org/finos/flowave/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testMultipleDecisionDiagramResource.decision2.png",
    "org/finos/flowave/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testMultipleDecisionDiagramResource.decision3.png"
  })
  @Test
  public void multipleDiagramResourcesProvided() {
    String resourcePrefix = "org/finos/flowave/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testMultipleDecisionDiagramResource.";
  ...
  public void testDeployDecisionDefinitionWithIntegerHistoryTimeToLive() {
    // when
    DeploymentWithDefinitions deployment = testRule.deploy("org/finos/flowave/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testDecisionDefinitionWithIntegerHistoryTimeToLive.dmn11.xml");
  ...
  public void testDeployDecisionDefinitionWithStringHistoryTimeToLive() {
    // when
    DeploymentWithDefinitions deployment = testRule.deploy("org/finos/flowave/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testDecisionDefinitionWithStringHistoryTimeToLive.dmn11.xml");
  ...
  public void testDeployDecisionDefinitionWithMalformedStringHistoryTimeToLive() {
    try {
      testRule.deploy("org/finos/flowave/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testDecisionDefinitionWithMalformedHistoryTimeToLive.dmn11.xml");
  ...
  public void testDeployDecisionDefinitionWithEmptyHistoryTimeToLive() {
      DeploymentWithDefinitions deployment = testRule.deploy("org/finos/flowave/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testDecisionDefinitionWithEmptyHistoryTimeToLive.dmn11.xml");
