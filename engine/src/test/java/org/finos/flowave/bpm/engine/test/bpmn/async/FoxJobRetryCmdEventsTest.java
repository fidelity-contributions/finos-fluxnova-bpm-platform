...
import static org.finos.flowave.bpm.engine.test.bpmn.async.RetryCmdDeployment.deployment;
import static org.finos.flowave.bpm.engine.test.bpmn.async.RetryCmdDeployment.prepareCompensationEventProcess;
import static org.finos.flowave.bpm.engine.test.bpmn.async.RetryCmdDeployment.prepareEscalationEventProcess;
import static org.finos.flowave.bpm.engine.test.bpmn.async.RetryCmdDeployment.prepareMessageEventProcess;
import static org.finos.flowave.bpm.engine.test.bpmn.async.RetryCmdDeployment.prepareSignalEventProcess;
