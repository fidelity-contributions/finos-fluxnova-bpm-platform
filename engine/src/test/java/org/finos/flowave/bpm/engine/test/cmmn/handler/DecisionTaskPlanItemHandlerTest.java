 ...
 */
package org.finos.flowave.bpm.engine.test.cmmn.handler;

import static org.finos.flowave.bpm.engine.impl.cmmn.handler.ItemHandler.PROPERTY_ACTIVITY_DESCRIPTION;
import static org.finos.flowave.bpm.engine.impl.cmmn.handler.ItemHandler.PROPERTY_ACTIVITY_TYPE;
import static org.finos.flowave.bpm.engine.impl.cmmn.handler.ItemHandler.PROPERTY_IS_BLOCKING;
import static org.finos.flowave.bpm.engine.impl.cmmn.handler.ItemHandler.PROPERTY_MANUAL_ACTIVATION_RULE;
import static org.finos.flowave.bpm.engine.impl.cmmn.handler.ItemHandler.PROPERTY_REQUIRED_RULE;
...
import org.finos.flowave.bpm.engine.impl.bpmn.helper.CmmnProperties;
import org.finos.flowave.bpm.engine.impl.cmmn.CaseControlRule;
import org.finos.flowave.bpm.engine.impl.cmmn.behavior.CmmnActivityBehavior;
import org.finos.flowave.bpm.engine.impl.cmmn.behavior.DecisionTaskActivityBehavior;
import org.finos.flowave.bpm.engine.impl.cmmn.behavior.DmnDecisionTaskActivityBehavior;
import org.finos.flowave.bpm.engine.impl.cmmn.handler.CasePlanModelHandler;
import org.finos.flowave.bpm.engine.impl.cmmn.handler.DecisionTaskItemHandler;
import org.finos.flowave.bpm.engine.impl.cmmn.handler.SentryHandler;
...
import org.finos.flowave.bpm.engine.impl.dmn.result.ResultListDecisionTableResultMapper;
import org.finos.flowave.bpm.engine.impl.dmn.result.SingleResultDecisionResultMapper;
import org.finos.flowave.bpm.engine.impl.el.ElValueProvider;
import org.finos.flowave.bpm.model.cmmn.Cmmn;
import org.finos.flowave.bpm.model.cmmn.instance.Body;
import org.finos.flowave.bpm.model.cmmn.instance.ConditionExpression;
import org.finos.flowave.bpm.model.cmmn.instance.DecisionRefExpression;
import org.finos.flowave.bpm.model.cmmn.instance.DecisionTask;
import org.finos.flowave.bpm.model.cmmn.instance.DefaultControl;
import org.finos.flowave.bpm.model.cmmn.instance.Documentation;
import org.finos.flowave.bpm.model.cmmn.instance.EntryCriterion;
import org.finos.flowave.bpm.model.cmmn.instance.ExitCriterion;
import org.finos.flowave.bpm.model.cmmn.instance.IfPart;
import org.finos.flowave.bpm.model.cmmn.instance.ItemControl;
import org.finos.flowave.bpm.model.cmmn.instance.ManualActivationRule;
import org.finos.flowave.bpm.model.cmmn.instance.PlanItem;
import org.finos.flowave.bpm.model.cmmn.instance.PlanItemControl;
