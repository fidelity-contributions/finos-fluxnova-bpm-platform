...
public class CaseServiceStageTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources={"org/finos/flowave/bpm/engine/test/api/cmmn/oneStageCaseWithManualActivation.cmmn"})
  @Test
  ...
  @Deployment(resources={"org/finos/flowave/bpm/engine/test/api/cmmn/oneTaskAndOneStageCase.cmmn"})
  @Test
