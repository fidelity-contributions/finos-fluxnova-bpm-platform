...
public class JobDefinitionPriorityTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources = "org/finos/flowave/bpm/engine/test/api/mgmt/jobPrioProcess.bpmn20.xml")
  @Test
  ...
  public void testRedeployOverridesSetJobDefinitionPriority() {
    ...
    String secondDeploymentId = repositoryService.createDeployment().addClasspathResource("org/finos/flowave/bpm/engine/test/api/mgmt/jobPrioProcess.bpmn20.xml").deploy().getId();
