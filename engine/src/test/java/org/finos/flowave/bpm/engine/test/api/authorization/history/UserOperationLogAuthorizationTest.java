 ...
 */
package org.finos.flowave.bpm.engine.test.api.authorization.history;
...
import static org.finos.flowave.bpm.engine.authorization.ProcessDefinitionPermissions.UPDATE_HISTORY;
import static org.finos.flowave.bpm.engine.authorization.Resources.HISTORIC_TASK;
import static org.finos.flowave.bpm.engine.authorization.Resources.OPERATION_LOG_CATEGORY;
import static org.finos.flowave.bpm.engine.authorization.Resources.PROCESS_DEFINITION;
import static org.finos.flowave.bpm.engine.authorization.UserOperationLogCategoryPermissions.DELETE;
import static org.finos.flowave.bpm.engine.authorization.UserOperationLogCategoryPermissions.READ;
import static org.finos.flowave.bpm.engine.history.UserOperationLogEntry.CATEGORY_ADMIN;
import static org.finos.flowave.bpm.engine.history.UserOperationLogEntry.CATEGORY_OPERATOR;
import static org.finos.flowave.bpm.engine.history.UserOperationLogEntry.CATEGORY_TASK_WORKER;
...
import org.finos.flowave.bpm.engine.test.api.authorization.AuthorizationTest;
...
public class UserOperationLogAuthorizationTest extends AuthorizationTest {
  ...
  public void setUp() throws Exception {
    deploymentId = testRule.deploy(
        ...
        "org/finos/flowave/bpm/engine/test/api/authorization/timerBoundaryEventProcess.bpmn20.xml")
            .getId();
    super.setUp();
  }
