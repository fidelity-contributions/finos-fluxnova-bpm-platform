...
public class CleanableHistoricDecisionInstanceReportTest {
  ...
  public void setUp() {
    ...
    testRule.deploy("org/finos/flowave/bpm/engine/test/repository/one.dmn");
  }
  ...
  public void testReportComplex() {
    // given
    testRule.deploy("org/finos/flowave/bpm/engine/test/repository/two.dmn", "org/finos/flowave/bpm/engine/test/api/dmn/Another_Example.dmn",
