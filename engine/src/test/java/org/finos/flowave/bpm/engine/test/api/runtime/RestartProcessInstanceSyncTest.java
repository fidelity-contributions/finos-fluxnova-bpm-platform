...
import org.finos.flowave.bpm.engine.test.api.runtime.migration.models.AsyncProcessModels;
import org.finos.flowave.bpm.engine.test.api.runtime.migration.models.ProcessModels;
import org.finos.flowave.bpm.engine.test.api.runtime.util.IncrementCounterListener;
import org.finos.flowave.bpm.engine.test.bpmn.async.AsyncListener;
...
public class RestartProcessInstanceSyncTest {
  ...
  public void shouldNotSetInitialVersionOfVariables() {
    ...
    assertEquals("foo", detail.getTextValue());
  }
  ...
  @Test
  @Deployment(resources = {"org/finos/flowave/bpm/engine/test/bpmn/async/AsyncStartEventTest.testAsyncStartEventListeners.bpmn20.xml"})
  ...
  @Deployment(resources = {
      "org/finos/flowave/bpm/engine/test/bpmn/async/AsyncStartEventTest.testCallActivity-super.bpmn20.xml",
      "org/finos/flowave/bpm/engine/test/bpmn/async/AsyncStartEventTest.testCallActivity-sub.bpmn20.xml"
  })
