...
public class TestHelperTest {
  ...
  public void shouldGetPublicMethod() throws NoSuchMethodException {
    ...
    assertThat(methodName.toString()).isEqualTo("public void org.finos.flowave.bpm.engine.impl.test.TestHelperTest$SomeTestClass.testSomethingWithPublicAccessor()");
  }
  ...
  public void shouldGetPackagePrivateMethod() throws NoSuchMethodException {
    ...
    assertThat(methodName.toString()).isEqualTo("void org.finos.flowave.bpm.engine.impl.test.TestHelperTest$SomeTestClass.testSomethingWithPackagePrivateAccessor()");
  }
  ...
  public void shouldGetProtectedMethod() throws NoSuchMethodException {
    ...
    assertThat(methodName.toString()).isEqualTo("protected void org.finos.flowave.bpm.engine.impl.test.TestHelperTest$SomeTestClass.testSomethingWithProtected()");
  }
