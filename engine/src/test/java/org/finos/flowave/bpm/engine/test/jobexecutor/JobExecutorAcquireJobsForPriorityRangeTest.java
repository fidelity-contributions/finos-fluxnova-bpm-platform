...
@Deployment(resources = "org/finos/flowave/bpm/engine/test/jobexecutor/JobExecutorAcquireJobsForPriorityRangeTest.jobPrioProcess.bpmn20.xml")
public class JobExecutorAcquireJobsForPriorityRangeTest extends AbstractJobExecutorAcquireJobsTest {
  ...
  @Test
  @WatchLogger(loggerNames = "org.finos.flowave.bpm.engine.impl.persistence.entity.JobEntity", level = "debug")
