 ...
 */
package org.finos.flowave.bpm.engine.test.cmmn.stage;
...
public class AutoCompleteTest extends CmmnTest {
  ...
  @Deployment(resources = {"org/finos/flowave/bpm/engine/test/cmmn/stage/AutoCompleteTest.testRequiredEnabled.cmmn"})
  @Test
  ...
  @Deployment(resources = {
    "org/finos/flowave/bpm/engine/test/cmmn/stage/AutoCompleteTest.testProcessTasksOnStage.cmmn",
    "org/finos/flowave/bpm/engine/test/cmmn/stage/AutoCompleteTest.testProcessTasksOnStage.bpmn"
  })
