...
import org.finos.flowave.bpm.engine.test.api.delegate.AssertingTaskListener;
import org.finos.flowave.bpm.engine.test.api.delegate.AssertingTaskListener.DelegateTaskAsserter;
...
public class MultiTenancyDelegateTaskTest extends PluggableProcessEngineTest {
  ...
  protected static final String BPMN = "org/finos/flowave/bpm/engine/test/api/multitenancy/taskListener.bpmn";
