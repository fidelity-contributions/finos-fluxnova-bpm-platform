...
public class UserOperationLogJobTest extends AbstractUserOperationLogTest {
  ...
  @Deployment(resources = {"org/finos/flowave/bpm/engine/test/history/asyncTaskProcess.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources = {"org/finos/flowave/bpm/engine/test/bpmn/event/timer/TimerRecalculationTest.testFinishedJob.bpmn20.xml"})
  @Test
