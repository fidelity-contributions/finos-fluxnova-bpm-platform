...
import org.finos.flowave.bpm.engine.test.bpmn.async.FailingDelegate;
...
public class RemovalTimeStrategyStartTest extends AbstractRemovalTimeTest {
  ...
  @Test
  @Deployment( resources = {
    "org/finos/flowave/bpm/engine/test/api/history/removaltime/HistoricRootProcessInstanceTest.shouldResolveByteArray_DecisionOutputLiteralExpression.dmn"
  })
