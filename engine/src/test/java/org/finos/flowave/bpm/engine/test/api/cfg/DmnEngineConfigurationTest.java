 ...
 */
package org.finos.flowave.bpm.engine.test.api.cfg;
...
public class DmnEngineConfigurationTest {
  ...
  protected final static String CONFIGURATION_XML = "org/finos/flowave/bpm/engine/test/api/cfg/custom-dmn-camunda.cfg.xml";
