...
public class PvmEventTest {
  ...
  public void testStartEndEvents() {
    ...
    PvmProcessDefinition processDefinition = new ProcessDefinitionBuilder("events")
      .executionListener(org.finos.flowave.bpm.engine.impl.pvm.PvmEvent.EVENTNAME_START, eventCollector)
      .executionListener(org.finos.flowave.bpm.engine.impl.pvm.PvmEvent.EVENTNAME_END, eventCollector)
