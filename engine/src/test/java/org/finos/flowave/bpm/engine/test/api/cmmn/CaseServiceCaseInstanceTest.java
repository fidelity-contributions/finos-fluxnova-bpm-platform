...
public class CaseServiceCaseInstanceTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources={"org/finos/flowave/bpm/engine/test/api/cmmn/oneStageCase.cmmn"})
  @Test
  ...
  @Deployment(resources={"org/finos/flowave/bpm/engine/test/api/cmmn/emptyCasePlanModelCase.cmmn"})
  @Test
