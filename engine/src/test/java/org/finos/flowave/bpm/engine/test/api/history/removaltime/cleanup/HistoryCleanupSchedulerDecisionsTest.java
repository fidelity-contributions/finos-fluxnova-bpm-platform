...
import static org.finos.flowave.bpm.engine.impl.jobexecutor.historycleanup.HistoryCleanupJobHandlerConfiguration.START_DELAY;
...
public class HistoryCleanupSchedulerDecisionsTest extends AbstractHistoryCleanupSchedulerTest {
  ...
  @Test
  @Deployment(resources = {
    "org/finos/flowave/bpm/engine/test/api/history/removaltime/cleanup/decisonWithThreeOutputs.dmn11.xml"
  })
