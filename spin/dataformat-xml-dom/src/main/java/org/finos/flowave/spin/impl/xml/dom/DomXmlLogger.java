...
import org.finos.flowave.spin.impl.logging.SpinLogger;
import org.finos.flowave.spin.xml.SpinXPathException;
import org.finos.flowave.spin.xml.SpinXmlAttribute;
import org.finos.flowave.spin.xml.SpinXmlAttributeException;
import org.finos.flowave.spin.xml.SpinXmlDataFormatException;
import org.finos.flowave.spin.xml.SpinXmlElement;
import org.finos.flowave.spin.xml.SpinXmlElementException;
import org.finos.flowave.spin.xml.SpinXmlElementImplementationException;
...
public class DomXmlLogger extends SpinLogger {
  ...
  public static final DomXmlLogger XML_DOM_LOGGER = BaseLogger.createLogger(DomXmlLogger.class, PROJECT_CODE, "org.finos.flowave.spin.xml", "01");
