...
import org.finos.flowave.spin.json.SpinJsonPathException;
import org.finos.flowave.spin.json.SpinJsonPropertyException;
...
public class JacksonJsonLogger extends SpinLogger {
  ...
  public static final JacksonJsonLogger JSON_TREE_LOGGER = BaseLogger.createLogger(JacksonJsonLogger.class, PROJECT_CODE, "org.finos.flowave.spin.json", "01");
