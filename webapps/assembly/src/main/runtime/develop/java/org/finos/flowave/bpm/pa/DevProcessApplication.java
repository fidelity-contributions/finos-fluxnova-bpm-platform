...
import static org.finos.flowave.bpm.engine.variable.Variables.fileValue;
...
import org.finos.flowave.bpm.pa.demo.InvoiceDemoDataGenerator;
...
public class DevProcessApplication extends ServletProcessApplication {
  ...
  private void createExternalTaskDemoData(ProcessEngine engine) {
    ...
    String errorDetails = "java.lang.RuntimeException: A exception message!\n" +
      "  at org.finos.flowave.bpm.pa.service.FailingDelegate.execute(FailingDelegate.java:10)\n" +
      "  at org.finos.flowave.bpm.engine.impl.delegate.JavaDelegateInvocation.invoke(JavaDelegateInvocation.java:34)\n" +
      "  at org.finos.flowave.bpm.engine.impl.delegate.DelegateInvocation.proceed(DelegateInvocation.java:37)\n" +
      "  ...\n";
