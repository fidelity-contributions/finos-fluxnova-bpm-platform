 ...
 */
package org.finos.flowave.bpm.admin.impl;

import org.finos.flowave.bpm.admin.AdminRuntimeDelegate;
import org.finos.flowave.bpm.admin.plugin.spi.AdminPlugin;
import org.finos.flowave.bpm.webapp.db.CommandExecutor;
import org.finos.flowave.bpm.webapp.db.QueryService;
import org.finos.flowave.bpm.webapp.impl.db.CommandExecutorImpl;
import org.finos.flowave.bpm.webapp.impl.db.QueryServiceImpl;
...
public class DefaultAdminRuntimeDelegate extends AbstractAppRuntimeDelegate<AdminPlugin> implements AdminRuntimeDelegate {
  ...
  private static final List<String> MAPPING_FILES = List.of(
      "org/finos/flowave/bpm/admin/plugin/base/queries/metrics.xml"
  );
