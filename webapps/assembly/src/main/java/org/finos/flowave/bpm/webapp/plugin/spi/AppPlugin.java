 ...
 */
package org.finos.flowave.bpm.webapp.plugin.spi;

import java.util.List;
import java.util.Set;

import org.finos.flowave.bpm.webapp.plugin.resource.PluginResourceOverride;
import org.finos.flowave.bpm.webapp.plugin.spi.impl.AbstractAppPlugin;
...
public interface AppPlugin {
   ...
   * <p>
   *
   * Typically, a plugin publishes its API via a subclass of {@link org.finos.flowave.bpm.cockpit.plugin.resource.AbstractPluginRootResource}.
   *
