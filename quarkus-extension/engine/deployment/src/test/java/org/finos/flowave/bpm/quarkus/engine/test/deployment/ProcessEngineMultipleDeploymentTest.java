 ...
 */
package org.finos.flowave.bpm.quarkus.engine.test.deployment;
...
public class ProcessEngineMultipleDeploymentTest {
  ...
  protected static final QuarkusUnitTest unitTest = new ProcessEngineAwareExtension()
      .setArchiveProducer(() -> ShrinkWrap.create(JavaArchive.class)
          .addAsResource("org/finos/flowave/bpm/quarkus/engine/test/deployment/simpleServiceTaskProcess.bpmn"));
