 ...
 */
package org.finos.flowave.bpm.quarkus.engine.test;

import static org.assertj.core.api.Assertions.assertThat;
import static org.finos.flowave.bpm.engine.impl.test.TestHelper.waitForJobExecutorToProcessAllJobs;
...
import org.finos.flowave.bpm.quarkus.engine.extension.impl.ManagedJobExecutor;
...
public class ManagedJobExecutorTest {
  ...
  static final QuarkusUnitTest unitTest = new ProcessEngineAwareExtension()
      .withConfigurationResource("org/finos/flowave/bpm/quarkus/engine/test/config/" +
