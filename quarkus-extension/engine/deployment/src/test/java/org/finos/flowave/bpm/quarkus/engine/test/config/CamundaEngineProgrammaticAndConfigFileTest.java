 ...
 */
package org.finos.flowave.bpm.quarkus.engine.test.config;
...
public class CamundaEngineProgrammaticAndConfigFileTest {
  ...
  static final QuarkusUnitTest unitTest = new ProcessEngineAwareExtension()
      .withConfigurationResource("org/finos/flowave/bpm/quarkus/engine/test/config/mixed-application.properties")
