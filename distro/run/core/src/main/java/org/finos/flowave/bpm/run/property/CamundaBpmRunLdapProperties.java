  ...
  public String toString() {
    return "CamundaBpmRunLdapProperty [enabled=" + enabled +
        ...
        ", userEmailAttribute=" + userEmailAttribute +
            // code ql fix for Insertion of sensitive information into log files at delegateLogger.info(msg, parameters) line in
            // commons/logging/src/main/java/org/finos/flowave/commons/logging/BaseLogger.java
