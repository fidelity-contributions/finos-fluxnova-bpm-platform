 ...
 */
package org.finos.flowave.bpm.run.test.config.cors;
...
@TestPropertySource(properties = {CamundaBpmRunCorsProperty.PREFIX + ".allowed-headers=Origin,Accept"})
public class CorsConfigAllowedHeadersTest extends AbstractRestTest {
