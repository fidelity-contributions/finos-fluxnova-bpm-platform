 ...
 */
package org.finos.flowave.bpm.container.impl.jboss.test;
...
import org.finos.flowave.bpm.container.impl.jboss.config.ManagedProcessEngineMetadata;
import org.finos.flowave.bpm.container.impl.jboss.extension.Attribute;
import org.finos.flowave.bpm.container.impl.jboss.extension.BpmPlatformExtension;
import org.finos.flowave.bpm.container.impl.jboss.extension.Element;
import org.finos.flowave.bpm.container.impl.jboss.extension.ModelConstants;
import org.finos.flowave.bpm.container.impl.jboss.extension.SubsystemAttributeDefinitons;
import org.finos.flowave.bpm.container.impl.jboss.service.MscManagedProcessEngineController;
import org.finos.flowave.bpm.container.impl.jboss.service.ServiceNames;
import org.finos.flowave.bpm.container.impl.metadata.spi.ProcessEnginePluginXml;
import org.finos.flowave.bpm.container.impl.plugin.BpmPlatformPlugin;
import org.finos.flowave.bpm.container.impl.plugin.BpmPlatformPlugins;
...
public class JBossSubsystemXMLTest extends AbstractSubsystemTest {
  ...
  public static final ServiceName PROCESS_ENGINE_SERVICE_BINDING_SERVICE_NAME = ContextNames.GLOBAL_CONTEXT_SERVICE_NAME
    .append("flowave-bpm-platform")
    .append("process-engine")
    .append("ProcessEngineService!org.finos.flowave.bpm.ProcessEngineService");
  ...
  static {
    ...
    EXPRESSION_PROPERTIES.put("org.camunda.bpm.jboss.process-engine.test.configuration", "org.finos.flowave.bpm.container.impl.jboss.config.ManagedJtaProcessEngineConfiguration");
    EXPRESSION_PROPERTIES.put("org.camunda.bpm.jboss.process-engine.test.property.job-acquisition-name", "default");
    EXPRESSION_PROPERTIES.put("org.camunda.bpm.jboss.process-engine.test.plugin.ldap.class", "org.finos.flowave.bpm.identity.impl.ldap.plugin.LdapIdentityProviderPlugin");
  ...
  public void testInstallSubsystemWithEnginesPropertiesPlugins() throws Exception {
    ...
    assertEquals("org.finos.flowave.bpm.identity.impl.ldap.plugin.LdapIdentityProviderPlugin", processEnginePluginXml.getPluginClass());
...
//    System.out.println(operations);
  ...
  public void testInstallSubsystemWithJobExecutorAndPropertiesXml() throws Exception {
    ...
    // ServiceName: 'org.finos.flowave.bpm.platform.job-executor.job-executor-tp'
