 ...
 */
package org.finos.flowave.connect.plugin;
...
import org.finos.flowave.connect.ConnectorException;
import org.finos.flowave.connect.Connectors;
import org.finos.flowave.connect.httpclient.HttpConnector;
import org.finos.flowave.connect.httpclient.soap.SoapHttpConnector;
import org.finos.flowave.connect.plugin.util.TestConnector;
import org.finos.flowave.connect.spi.Connector;
...
public class ConnectProcessEnginePluginTest extends PluggableProcessEngineTestCase {
  ...
  public void testConnectorIdMissing() {
    try {
      repositoryService.createDeployment().addClasspathResource("org/finos/flowave/connect/plugin/ConnectProcessEnginePluginTest.testConnectorIdMissing.bpmn")
        .deploy();
  ...
  @Deployment(resources= "org/finos/flowave/connect/plugin/ConnectProcessEnginePluginTest.testConnectorWithThrownExceptionInScriptInputOutputMapping.bpmn")
  ...
  @Deployment(resources= "org/finos/flowave/connect/plugin/ConnectProcessEnginePluginTest.testConnectorWithThrownExceptionInScriptResourceInputOutputMapping.bpmn")
  ...
  @Deployment(resources= "org/finos/flowave/connect/plugin/ConnectProcessEnginePluginTest.testConnectorBpmnErrorThrownInScriptResourceNoAsyncAfterJobIsCreated.bpmn")
