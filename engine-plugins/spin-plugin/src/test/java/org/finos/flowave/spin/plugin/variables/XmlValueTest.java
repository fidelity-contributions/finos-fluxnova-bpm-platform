...
import static org.finos.flowave.spin.DataFormats.xml;
import static org.finos.flowave.spin.plugin.variable.SpinValues.xmlValue;
import static org.finos.flowave.spin.plugin.variable.type.SpinValueType.XML;
...
import org.finos.flowave.spin.plugin.variable.value.XmlValue;
import org.finos.flowave.spin.plugin.variable.value.builder.XmlValueBuilder;
...
public class XmlValueTest extends PluggableProcessEngineTestCase {
  ...
  @Deployment(resources = "org/finos/flowave/spin/plugin/xmlConditionProcess.bpmn20.xml")
