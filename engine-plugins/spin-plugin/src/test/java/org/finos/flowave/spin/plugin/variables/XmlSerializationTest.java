 ...
 */
package org.finos.flowave.spin.plugin.variables;
...
import static org.finos.flowave.spin.plugin.variables.TypedValueAssert.assertObjectValueDeserializedNull;
import static org.finos.flowave.spin.plugin.variables.TypedValueAssert.assertObjectValueSerializedNull;
import static org.finos.flowave.spin.plugin.variables.TypedValueAssert.assertUntypedNullValue;
...
import org.finos.flowave.spin.impl.util.SpinIoUtil;
import org.finos.flowave.spin.xml.SpinXmlElement;

public class XmlSerializationTest extends PluggableProcessEngineTestCase {

  protected static final String ONE_TASK_PROCESS = "org/finos/flowave/spin/plugin/oneTaskProcess.bpmn20.xml";
  ...
  public void testOverloadedAppendMethod() {
    ...
    Reader xmlInput = SpinIoUtil.classpathResourceAsReader("org/finos/flowave/spin/plugin/XmlSerializationTest-input.xml");
    String expectedOutput = SpinIoUtil.fileAsString("org/finos/flowave/spin/plugin/XmlSerializationTest-output.xml");
