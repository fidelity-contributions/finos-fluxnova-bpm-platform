...
import static org.finos.flowave.spin.plugin.variable.SpinValues.jsonValue;
import static org.finos.flowave.spin.plugin.variable.type.SpinValueType.JSON;
...
import org.finos.flowave.spin.SpinRuntimeException;
import org.finos.flowave.spin.json.SpinJsonNode;
import org.finos.flowave.spin.plugin.variable.type.SpinValueType;
import org.finos.flowave.spin.plugin.variable.value.JsonValue;
import org.finos.flowave.spin.plugin.variable.value.builder.JsonValueBuilder;
...
public class JsonValueTest extends PluggableProcessEngineTestCase {
  ...
  @Deployment(resources = "org/finos/flowave/spin/plugin/jsonConditionProcess.bpmn20.xml")
