...
import org.finos.flowave.bpm.engine.impl.test.ResourceProcessEngineTestCase;
...
public class DmnBusinessRuleTaskResultMappingTest extends ResourceProcessEngineTestCase {
  ...
  protected static final String TEST_DECISION = "org/finos/flowave/spin/plugin/DmnBusinessRuleTaskResultMappingTest.dmn11.xml";
  protected static final String CUSTOM_MAPPING_BPMN = "org/finos/flowave/spin/plugin/DmnBusinessRuleTaskResultMappingTest.testCustomOutputMapping.bpmn20.xml";
  protected static final String SINGLE_ENTRY_BPMN = "org/finos/flowave/spin/plugin/DmnBusinessRuleTaskResultMappingTest.testSingleEntry.bpmn20.xml";
  protected static final String DEFAULT_MAPPING_BPMN = "org/finos/flowave/spin/plugin/DmnBusinessRuleTaskResultMappingTest.testDefaultMapping.bpmn20.xml";
  protected static final String STORE_DECISION_RESULT_BPMN = "org/finos/flowave/spin/plugin/DmnBusinessRuleTaskResultMappingTest.testStoreDecisionResult.bpmn20.xml";

  public DmnBusinessRuleTaskResultMappingTest() {
    super("org/finos/flowave/spin/plugin/json.camunda.cfg.xml");
  }
