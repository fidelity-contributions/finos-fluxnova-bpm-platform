...
public class CaseTaskAssert extends AbstractCaseAssert<CaseTaskAssert, CaseExecution> {
  ...
  /**
   * Verifies the expectation that the {@link org.finos.flowave.bpm.model.cmmn.instance.CaseTask} holds no
  ...
  /**
   * Verifies the expectation that the {@link org.finos.flowave.bpm.model.cmmn.instance.CaseTask} holds one or
