...
A Jakarta JAX-RS-based REST API for Flowave Platform.

> This module copies and transforms the `flowave-engine-rest-core` module.  
...
See the `flowave-engine-rest-core` module's README about writing tests and add your test in that module.
