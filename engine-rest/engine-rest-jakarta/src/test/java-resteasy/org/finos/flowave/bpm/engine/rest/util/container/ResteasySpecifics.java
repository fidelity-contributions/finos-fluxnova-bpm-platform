 ...
 */
package org.finos.flowave.bpm.engine.rest.util.container;
...
import org.finos.flowave.bpm.engine.rest.CustomJacksonDateFormatTest;
import org.finos.flowave.bpm.engine.rest.ExceptionHandlerTest;
import org.finos.flowave.bpm.engine.rest.application.TestCustomResourceApplication;
import org.finos.flowave.bpm.engine.rest.security.auth.ProcessEngineAuthenticationFilter;
import org.finos.flowave.bpm.engine.rest.standalone.NoServletAuthenticationFilterTest;
import org.finos.flowave.bpm.engine.rest.standalone.NoServletEmptyBodyFilterTest;
import org.finos.flowave.bpm.engine.rest.standalone.ServletAuthenticationFilterTest;
import org.finos.flowave.bpm.engine.rest.standalone.ServletEmptyBodyFilterTest;
  ...
  static {
        ...
        Servlets.deployment()
            ...
            .addFilter(Servlets.filter("camunda-auth", ProcessEngineAuthenticationFilter.class)
                .addInitParam("authentication-provider",
                    "org.finos.flowave.bpm.engine.rest.security.auth.impl.HttpBasicAuthenticationProvider"))
            ...
            .addServlet(Servlets.servlet("camunda-app", HttpServletDispatcher.class)
                ...
                .addInitParam("jakarta.ws.rs.Application",
                    "org.finos.flowave.bpm.engine.rest.util.container.JaxrsApplication"))));
    ...
    TEST_RULE_FACTORIES.put(ServletEmptyBodyFilterTest.class, new UndertowServletContainerRuleFactory(
        Servlets.deployment()
            ...
            .setClassLoader(ResteasyUndertowServerBootstrap.class.getClassLoader())
            .addListener(Servlets.listener(ResteasyBootstrap.class))
            .addFilter(Servlets.filter("EmptyBodyFilter", org.finos.flowave.bpm.engine.rest.filter.EmptyBodyFilter.class)
                .addInitParam("rest-url-pattern-prefix", ""))
    ...
    TEST_RULE_FACTORIES.put(CustomJacksonDateFormatTest.class, new UndertowServletContainerRuleFactory(
        Servlets.deployment()
            ...
            .setClassLoader(ResteasyUndertowServerBootstrap.class.getClassLoader())
            .addListener(Servlets.listener(ResteasyBootstrap.class))
            .addListener(Servlets.listener(org.finos.flowave.bpm.engine.rest.CustomJacksonDateFormatListener.class))
            .addInitParameter("org.finos.flowave.bpm.engine.rest.jackson.dateFormat", "yyyy-MM-dd'T'HH:mm:ss")
            .addFilter(Servlets.filter("Resteasy", FilterDispatcher.class)
                .addInitParam("jakarta.ws.rs.Application",
                    "org.finos.flowave.bpm.engine.rest.util.container.JaxrsApplication"))
            .addFilterUrlMapping("Resteasy", "/*", DispatcherType.REQUEST)));
