...
<#assign docsUrl = "https://docs.fluxnova.finos.org/manual/${docsVersion}">
{
  "openapi": "3.0.2",
  "info": {
    "title": "Fluxnova Platform REST API",
    "description": "OpenApi Spec for Fluxnova Platform REST API.",
  ...
  "externalDocs": {
    "description": "Find out more about Fluxnova Rest API",
