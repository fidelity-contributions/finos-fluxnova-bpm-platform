 ...
 */
package org.finos.flowave.bpm.engine.rest.impl;

import static org.finos.flowave.bpm.engine.rest.util.EngineUtil.getProcessEngineProvider;
...
import org.finos.flowave.bpm.engine.rest.AuthorizationRestService;
import org.finos.flowave.bpm.engine.rest.BatchRestService;
...
import org.finos.flowave.bpm.engine.rest.ConditionRestService;
import org.finos.flowave.bpm.engine.rest.DecisionDefinitionRestService;
import org.finos.flowave.bpm.engine.rest.DecisionRequirementsDefinitionRestService;
import org.finos.flowave.bpm.engine.rest.DeploymentRestService;
import org.finos.flowave.bpm.engine.rest.EventSubscriptionRestService;
import org.finos.flowave.bpm.engine.rest.ExecutionRestService;
import org.finos.flowave.bpm.engine.rest.ExternalTaskRestService;
import org.finos.flowave.bpm.engine.rest.FilterRestService;
import org.finos.flowave.bpm.engine.rest.GroupRestService;
import org.finos.flowave.bpm.engine.rest.IdentityRestService;
import org.finos.flowave.bpm.engine.rest.IncidentRestService;
import org.finos.flowave.bpm.engine.rest.JobDefinitionRestService;
import org.finos.flowave.bpm.engine.rest.JobRestService;
import org.finos.flowave.bpm.engine.rest.MessageRestService;
import org.finos.flowave.bpm.engine.rest.MetricsRestService;
import org.finos.flowave.bpm.engine.rest.MigrationRestService;
import org.finos.flowave.bpm.engine.rest.ModificationRestService;
import org.finos.flowave.bpm.engine.rest.ProcessDefinitionRestService;
import org.finos.flowave.bpm.engine.rest.ProcessInstanceRestService;
import org.finos.flowave.bpm.engine.rest.SchemaLogRestService;
import org.finos.flowave.bpm.engine.rest.SignalRestService;
import org.finos.flowave.bpm.engine.rest.TaskRestService;
import org.finos.flowave.bpm.engine.rest.TelemetryRestService;
import org.finos.flowave.bpm.engine.rest.TenantRestService;
import org.finos.flowave.bpm.engine.rest.UserRestService;
import org.finos.flowave.bpm.engine.rest.VariableInstanceRestService;
import org.finos.flowave.bpm.engine.rest.dto.ProcessEngineDto;
import org.finos.flowave.bpm.engine.rest.history.HistoryRestService;
import org.finos.flowave.bpm.engine.rest.impl.optimize.OptimizeRestService;
import org.finos.flowave.bpm.engine.rest.spi.ProcessEngineProvider;
