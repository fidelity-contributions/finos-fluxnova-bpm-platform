 ...
 */
package org.finos.flowave.bpm.engine.rest.dto.migration;
...
public class MigratingProcessInstanceValidationExceptionDto extends ExceptionDto {
  ...
  public void setValidationReport(MigratingProcessInstanceValidationReportDto validationReport) {
  ...
  public static MigratingProcessInstanceValidationExceptionDto from(MigratingProcessInstanceValidationException exception) {
    ...
    dto.setValidationReport(MigratingProcessInstanceValidationReportDto.from(exception.getValidationReport()));
    return dto;
  }
