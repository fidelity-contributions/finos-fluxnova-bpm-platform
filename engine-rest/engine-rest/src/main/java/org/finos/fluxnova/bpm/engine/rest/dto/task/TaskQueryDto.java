...
import org.finos.fluxnova.bpm.engine.impl.QueryEntityRelationCondition;
import org.finos.fluxnova.bpm.engine.impl.QueryOrderingProperty;
import org.finos.fluxnova.bpm.engine.impl.TaskQueryImpl;
import org.finos.fluxnova.bpm.engine.impl.TaskQueryProperty;
import org.finos.fluxnova.bpm.engine.impl.TaskQueryVariableValue;
import org.finos.fluxnova.bpm.engine.impl.VariableInstanceQueryProperty;
import org.finos.fluxnova.bpm.engine.impl.VariableOrderProperty;
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.SuspensionState;
import org.finos.fluxnova.bpm.engine.query.Query;
import org.finos.fluxnova.bpm.engine.query.QueryProperty;
...
import org.finos.fluxnova.bpm.engine.rest.dto.SortingDto;
...
public class TaskQueryDto extends AbstractQueryDto<TaskQuery> {
  ...
  @FluxnovaQueryParam(value = "processInstanceBusinessKeyIn", converter = StringArrayConverter.class)
  ...
  @FluxnovaQueryParam("executionId")
  ...
  @FluxnovaQueryParam(value="tenantIdIn", converter = StringArrayConverter.class)
  ...
  @FluxnovaQueryParam("processInstanceId")
  ...
  @FluxnovaQueryParam(value = "includeAssignedTasks", converter = BooleanConverter.class)
  public void setIncludeAssignedTasks(Boolean includeAssignedTasks){
    this.includeAssignedTasks = includeAssignedTasks;
  }

  @FluxnovaQueryParam("taskId")
  public void setTaskId(String taskId) {
    this.taskId = taskId;
  }

  @FluxnovaQueryParam(value = "taskIdIn", converter= StringArrayConverter.class)
  public void setTaskIdIn(String[] taskIdIn) {
    this.taskIdIn = taskIdIn;
  }

  @FluxnovaQueryParam("taskDefinitionKey")
  public void setTaskDefinitionKey(String taskDefinitionKey) {
    this.taskDefinitionKey = taskDefinitionKey;
  }

  @FluxnovaQueryParam(value = "taskDefinitionKeyIn", converter= StringArrayConverter.class)
  public void setTaskDefinitionKeyIn(String[] taskDefinitionKeyIn) {
    this.taskDefinitionKeyIn = taskDefinitionKeyIn;
  }

  @FluxnovaQueryParam(value = "taskDefinitionKeyNotIn", converter= StringArrayConverter.class)
  public void setTaskDefinitionKeyNotIn(String[] taskDefinitionKeyNotIn) {
    this.taskDefinitionKeyNotIn = taskDefinitionKeyNotIn;
  }

  @FluxnovaQueryParam("taskDefinitionKeyLike")
  public void setTaskDefinitionKeyLike(String taskDefinitionKeyLike) {
    this.taskDefinitionKeyLike = taskDefinitionKeyLike;
  }

  @FluxnovaQueryParam("description")
  public void setDescription(String description) {
    this.description = description;
  }

  @FluxnovaQueryParam("descriptionLike")
  public void setDescriptionLike(String descriptionLike) {
    this.descriptionLike = descriptionLike;
  }

  @FluxnovaQueryParam("involvedUser")
  public void setInvolvedUser(String involvedUser) {
    this.involvedUser = involvedUser;
  }

  @FluxnovaQueryParam("involvedUserExpression")
  public void setInvolvedUserExpression(String involvedUserExpression) {
    this.involvedUserExpression = involvedUserExpression;
  }

  @FluxnovaQueryParam(value = "maxPriority", converter = IntegerConverter.class)
  public void setMaxPriority(Integer maxPriority) {
    this.maxPriority = maxPriority;
  }

  @FluxnovaQueryParam(value = "minPriority", converter = IntegerConverter.class)
  ...
  @FluxnovaQueryParam("nameNotEqual")
  ...
  @FluxnovaQueryParam("nameNotLike")
  public void setNameNotLike(String nameNotLike) {
    this.nameNotLike = nameNotLike;
  }

  @FluxnovaQueryParam("owner")
  public void setOwner(String owner) {
    this.owner = owner;
  }

  @FluxnovaQueryParam("ownerExpression")
  public void setOwnerExpression(String ownerExpression) {
    this.ownerExpression = ownerExpression;
  }

  @FluxnovaQueryParam(value = "priority", converter = IntegerConverter.class)
  public void setPriority(Integer priority) {
    this.priority = priority;
  }

  @FluxnovaQueryParam("parentTaskId")
  public void setParentTaskId(String parentTaskId) {
    this.parentTaskId = parentTaskId;
  }

  @FluxnovaQueryParam(value = "assigned", converter = BooleanConverter.class)
  public void setAssigned(Boolean assigned) {
    this.assigned = assigned;
  }

  @FluxnovaQueryParam(value = "unassigned", converter = BooleanConverter.class)
  ...
  @FluxnovaQueryParam(value = "suspended", converter = BooleanConverter.class)
  public void setSuspended(Boolean suspended) {
    this.suspended = suspended;
  }

  @FluxnovaQueryParam(value = "dueAfter", converter = DateConverter.class)
  public void setDueAfter(Date dueAfter) {
    this.dueAfter = dueAfter;
  }

  @FluxnovaQueryParam(value = "dueAfterExpression")
  public void setDueAfterExpression(String dueAfterExpression) {
    this.dueAfterExpression = dueAfterExpression;
  }

  @FluxnovaQueryParam(value = "dueBefore", converter = DateConverter.class)
  public void setDueBefore(Date dueBefore) {
    this.dueBefore = dueBefore;
  }

  @FluxnovaQueryParam(value = "dueBeforeExpression")
  public void setDueBeforeExpression(String dueBeforeExpression) {
    this.dueBeforeExpression = dueBeforeExpression;
  }

  @FluxnovaQueryParam(value = "dueDate", converter = DateConverter.class)
  public void setDueDate(Date dueDate) {
    this.dueDate = dueDate;
  }

  @Deprecated
  @FluxnovaQueryParam(value = "due", converter = DateConverter.class)
  public void setDue(Date dueDate) {
    this.dueDate = dueDate;
  }

  @FluxnovaQueryParam(value = "dueDateExpression")
  public void setDueDateExpression(String dueDateExpression) {
    this.dueDateExpression = dueDateExpression;
  }

  @FluxnovaQueryParam(value = "withoutDueDate", converter = BooleanConverter.class)
  public void setWithoutDueDate(Boolean withoutDueDate) {
    this.withoutDueDate = withoutDueDate;
  }

  @FluxnovaQueryParam(value = "followUpAfter", converter = DateConverter.class)
  public void setFollowUpAfter(Date followUpAfter) {
    this.followUpAfter = followUpAfter;
  }

  @FluxnovaQueryParam(value = "followUpAfterExpression")
  ...
  @FluxnovaQueryParam(value = "followUpBefore", converter = DateConverter.class)
  public void setFollowUpBefore(Date followUpBefore) {
    this.followUpBefore = followUpBefore;
  }

  @FluxnovaQueryParam(value = "followUpBeforeOrNotExistentExpression")
  ...
  @FluxnovaQueryParam(value = "followUpBeforeOrNotExistent", converter = DateConverter.class)
  public void setFollowUpBeforeOrNotExistent(Date followUpBefore) {
    this.followUpBeforeOrNotExistent = followUpBefore;
  }

  @FluxnovaQueryParam(value = "followUpBeforeExpression")
  ...
  @FluxnovaQueryParam(value = "followUpDate", converter = DateConverter.class)
  public void setFollowUpDate(Date followUpDate) {
    this.followUpDate = followUpDate;
  }

  @Deprecated
  @FluxnovaQueryParam(value = "followUp", converter = DateConverter.class)
  public void setFollowUp(Date followUpDate) {
    this.followUpDate = followUpDate;
  }

  @FluxnovaQueryParam(value = "followUpDateExpression")
  public void setFollowUpDateExpression(String followUpDateExpression) {
    this.followUpDateExpression = followUpDateExpression;
  }

  @FluxnovaQueryParam(value = "createdAfter", converter = DateConverter.class)
  public void setCreatedAfter(Date createdAfter) {
    this.createdAfter = createdAfter;
  }

  @FluxnovaQueryParam(value = "createdAfterExpression")
  public void setCreatedAfterExpression(String createdAfterExpression) {
    this.createdAfterExpression = createdAfterExpression;
  }

  @FluxnovaQueryParam(value = "createdBefore", converter = DateConverter.class)
  public void setCreatedBefore(Date createdBefore) {
    this.createdBefore = createdBefore;
  }

  @FluxnovaQueryParam(value = "createdBeforeExpression")
  ...
  @FluxnovaQueryParam(value = "createdOn", converter = DateConverter.class)
  public void setCreatedOn(Date createdOn) {
    this.createdOn = createdOn;
  }

  @Deprecated
  @FluxnovaQueryParam(value = "created", converter = DateConverter.class)
  public void setCreated(Date createdOn) {
    this.createdOn = createdOn;
  }

  @FluxnovaQueryParam(value = "createdOnExpression")
  public void setCreatedOnExpression(String createdOnExpression) {
    this.createdOnExpression = createdOnExpression;
  }

  @FluxnovaQueryParam(value = "updatedAfter", converter = DateConverter.class)
  public void setUpdatedAfter(Date updatedAfter) {
    this.updatedAfter = updatedAfter;
  }

  @FluxnovaQueryParam(value = "updatedAfterExpression")
  public void setUpdatedAfterExpression(String updatedAfterExpression) {
    this.updatedAfterExpression = updatedAfterExpression;
  }

  @FluxnovaQueryParam(value = "delegationState")
  public void setDelegationState(String taskDelegationState) {
    this.delegationState = taskDelegationState;
  }

  @FluxnovaQueryParam(value = "candidateGroups", converter = StringListConverter.class)
  public void setCandidateGroups(List<String> candidateGroups) {
    this.candidateGroups = candidateGroups;
  }

  @FluxnovaQueryParam(value = "candidateGroupsExpression")
  ...
  @FluxnovaQueryParam(value = "taskVariables", converter = VariableListConverter.class)
  ...
  @FluxnovaQueryParam("caseDefinitionId")
  public void setCaseDefinitionId(String caseDefinitionId) {
    this.caseDefinitionId = caseDefinitionId;
  }

  @FluxnovaQueryParam("caseDefinitionKey")
  public void setCaseDefinitionKey(String caseDefinitionKey) {
    this.caseDefinitionKey = caseDefinitionKey;
  }

  @FluxnovaQueryParam("caseDefinitionName")
  public void setCaseDefinitionName(String caseDefinitionName) {
    this.caseDefinitionName = caseDefinitionName;
  }

  @FluxnovaQueryParam("caseDefinitionNameLike")
  public void setCaseDefinitionNameLike(String caseDefinitionNameLike) {
    this.caseDefinitionNameLike = caseDefinitionNameLike;
  }

  @FluxnovaQueryParam("caseExecutionId")
  public void setCaseExecutionId(String caseExecutionId) {
    this.caseExecutionId = caseExecutionId;
  }

  @FluxnovaQueryParam("caseInstanceBusinessKey")
  ...
  @FluxnovaQueryParam("caseInstanceBusinessKeyLike")
  ...
  @FluxnovaQueryParam("caseInstanceId")
  public void setCaseInstanceId(String caseInstanceId) {
    this.caseInstanceId = caseInstanceId;
  }

  @FluxnovaQueryParam(value = "caseInstanceVariables", converter = VariableListConverter.class)
  ...
  @FluxnovaQueryParam(value = "withCommentAttachmentInfo", converter = BooleanConverter.class)
