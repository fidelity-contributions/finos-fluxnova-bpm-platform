...
public class VariableInstanceQueryDto extends AbstractQueryDto<VariableInstanceQuery> {
  ...
  @FluxnovaQueryParam("variableName")
  public void setVariableName(String variableName) {
    this.variableName = variableName;
  }

  @FluxnovaQueryParam("variableNameLike")
  public void setVariableNameLike(String variableNameLike) {
    this.variableNameLike = variableNameLike;
  }

  @FluxnovaQueryParam(value = "variableValues", converter = VariableListConverter.class)
  ...
  @FluxnovaQueryParam(value="executionIdIn", converter = StringArrayConverter.class)
  ...
  @FluxnovaQueryParam(value="caseInstanceIdIn", converter = StringArrayConverter.class)
  ...
  @FluxnovaQueryParam(value="batchIdIn", converter = StringArrayConverter.class)
  public void setBatchIdIn(String[] batchIdIn) {
    this.batchIdIn = batchIdIn;
  }

  @FluxnovaQueryParam(value="variableScopeIdIn", converter = StringArrayConverter.class)
