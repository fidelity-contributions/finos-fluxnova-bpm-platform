...
import static org.finos.fluxnova.bpm.engine.rest.util.EngineUtil.getProcessEngineProvider;
...
import org.finos.fluxnova.bpm.engine.rest.DecisionDefinitionRestService;
import org.finos.fluxnova.bpm.engine.rest.DecisionRequirementsDefinitionRestService;
import org.finos.fluxnova.bpm.engine.rest.DeploymentRestService;
import org.finos.fluxnova.bpm.engine.rest.EventSubscriptionRestService;
import org.finos.fluxnova.bpm.engine.rest.ExecutionRestService;
import org.finos.fluxnova.bpm.engine.rest.ExternalTaskRestService;
import org.finos.fluxnova.bpm.engine.rest.FilterRestService;
import org.finos.fluxnova.bpm.engine.rest.GroupRestService;
import org.finos.fluxnova.bpm.engine.rest.IdentityRestService;
import org.finos.fluxnova.bpm.engine.rest.IncidentRestService;
import org.finos.fluxnova.bpm.engine.rest.JobDefinitionRestService;
import org.finos.fluxnova.bpm.engine.rest.JobRestService;
import org.finos.fluxnova.bpm.engine.rest.MessageRestService;
import org.finos.fluxnova.bpm.engine.rest.MetricsRestService;
import org.finos.fluxnova.bpm.engine.rest.MigrationRestService;
import org.finos.fluxnova.bpm.engine.rest.ModificationRestService;
import org.finos.fluxnova.bpm.engine.rest.ProcessDefinitionRestService;
import org.finos.fluxnova.bpm.engine.rest.ProcessInstanceRestService;
import org.finos.fluxnova.bpm.engine.rest.SchemaLogRestService;
...
import org.finos.fluxnova.bpm.engine.rest.dto.ProcessEngineDto;
import org.finos.fluxnova.bpm.engine.rest.history.HistoryRestService;
