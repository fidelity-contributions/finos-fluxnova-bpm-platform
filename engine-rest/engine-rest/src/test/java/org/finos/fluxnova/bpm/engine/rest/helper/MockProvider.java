...
import org.finos.fluxnova.bpm.engine.form.FormField;
import org.finos.fluxnova.bpm.engine.form.FormProperty;
import org.finos.fluxnova.bpm.engine.form.FormType;
...
import org.finos.fluxnova.bpm.engine.history.HistoricCaseActivityStatistics;
...
import org.finos.fluxnova.bpm.engine.history.HistoricDecisionInstanceStatistics;
...
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.MetricIntervalEntity;
...
import org.finos.fluxnova.bpm.engine.impl.telemetry.dto.CommandImpl;
...
import org.finos.fluxnova.bpm.engine.impl.telemetry.dto.MetricImpl;
...
import org.finos.fluxnova.bpm.engine.management.SetJobRetriesBuilder;
import org.finos.fluxnova.bpm.engine.management.SetJobRetriesByJobsAsyncBuilder;
import org.finos.fluxnova.bpm.engine.management.SetJobRetriesByProcessAsyncBuilder;
...
public abstract class MockProvider {
  ...
  public static TaskFormData createMockTaskFormDataUsingFormRef() {
    ...
    FluxnovaFormRefImpl formRef = new FluxnovaFormRefImpl(EXAMPLE_FORM_KEY, EXAMPLE_FORM_REF_BINDING);
    formRef.setVersion(EXAMPLE_FORM_REF_VERSION);
    when(mockFormData.getFluxnovaFormRef()).thenReturn(formRef);
  ...
  public static Resource createMockDeploymentFluxnovaFormResource() {
    Resource mockResource = mock(ResourceEntity.class);
