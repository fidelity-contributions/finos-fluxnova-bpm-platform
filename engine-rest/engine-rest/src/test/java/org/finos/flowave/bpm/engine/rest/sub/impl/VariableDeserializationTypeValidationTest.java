...
public class VariableDeserializationTypeValidationTest {
  ...
  public void shouldValidateBaseTypeOnlyForComplexClass() {
    ...
    // then
    Mockito.verify(validator).validate("org.finos.flowave.bpm.engine.rest.sub.impl.VariableDeserializationTypeValidationTest$Complex");
    Mockito.verifyNoMoreInteractions(validator);
  }
  ...
  public void shouldFailForComplexClass() {
    ...
    // then
    thrown.expect(IllegalArgumentException.class);
    thrown.expectMessage("[org.finos.flowave.bpm.engine.rest.sub.impl.VariableDeserializationTypeValidationTest$Complex]");
