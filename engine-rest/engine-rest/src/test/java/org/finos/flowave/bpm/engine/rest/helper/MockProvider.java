 ...
 */
package org.finos.flowave.bpm.engine.rest.helper;

import static org.finos.flowave.bpm.engine.rest.util.DateTimeUtils.withTimezone;
...
import org.finos.flowave.bpm.application.ProcessApplicationInfo;
import org.finos.flowave.bpm.dmn.engine.DmnDecisionResult;
...
import org.finos.flowave.bpm.engine.batch.BatchStatistics;
import org.finos.flowave.bpm.engine.batch.history.HistoricBatch;
import org.finos.flowave.bpm.engine.exception.NotValidException;
import org.finos.flowave.bpm.engine.externaltask.ExternalTask;
import org.finos.flowave.bpm.engine.externaltask.LockedExternalTask;
...
import org.finos.flowave.bpm.engine.form.FormType;
import org.finos.flowave.bpm.engine.form.StartFormData;
import org.finos.flowave.bpm.engine.form.TaskFormData;
import org.finos.flowave.bpm.engine.history.DurationReportResult;
import org.finos.flowave.bpm.engine.history.HistoricActivityInstance;
import org.finos.flowave.bpm.engine.history.HistoricActivityStatistics;
import org.finos.flowave.bpm.engine.history.HistoricCaseActivityInstance;
import org.finos.flowave.bpm.engine.history.HistoricCaseActivityStatistics;
import org.finos.flowave.bpm.engine.history.HistoricCaseInstance;
import org.finos.flowave.bpm.engine.history.HistoricDecisionInputInstance;
import org.finos.flowave.bpm.engine.history.HistoricDecisionInstance;
import org.finos.flowave.bpm.engine.history.HistoricDecisionInstanceStatistics;
import org.finos.flowave.bpm.engine.history.HistoricDecisionOutputInstance;
import org.finos.flowave.bpm.engine.history.HistoricDetail;
import org.finos.flowave.bpm.engine.history.HistoricExternalTaskLog;
import org.finos.flowave.bpm.engine.history.HistoricFormField;
import org.finos.flowave.bpm.engine.history.HistoricIdentityLinkLog;
import org.finos.flowave.bpm.engine.history.HistoricIncident;
import org.finos.flowave.bpm.engine.history.HistoricJobLog;
...
import org.finos.flowave.bpm.engine.history.HistoricVariableUpdate;
import org.finos.flowave.bpm.engine.history.UserOperationLogEntry;
import org.finos.flowave.bpm.engine.identity.Group;
import org.finos.flowave.bpm.engine.identity.Tenant;
...
import org.finos.flowave.bpm.engine.impl.telemetry.dto.CommandImpl;
...
import org.finos.flowave.bpm.engine.impl.telemetry.dto.LicenseKeyDataImpl;
import org.finos.flowave.bpm.engine.impl.telemetry.dto.MetricImpl;
...
import org.finos.flowave.bpm.engine.management.ActivityStatistics;
import org.finos.flowave.bpm.engine.management.IncidentStatistics;
import org.finos.flowave.bpm.engine.management.JobDefinition;
import org.finos.flowave.bpm.engine.management.MetricIntervalValue;
import org.finos.flowave.bpm.engine.management.MetricsQuery;
import org.finos.flowave.bpm.engine.management.ProcessDefinitionStatistics;
import org.finos.flowave.bpm.engine.management.SetJobRetriesBuilder;
import org.finos.flowave.bpm.engine.management.SetJobRetriesByJobsAsyncBuilder;
import org.finos.flowave.bpm.engine.management.SetJobRetriesByProcessAsyncBuilder;
import org.finos.flowave.bpm.engine.query.PeriodUnit;
import org.finos.flowave.bpm.engine.query.Query;
...
import org.finos.flowave.bpm.engine.repository.DeploymentWithDefinitions;
...
import org.finos.flowave.bpm.engine.runtime.CaseExecution;
import org.finos.flowave.bpm.engine.runtime.CaseInstance;
...
import org.finos.flowave.bpm.engine.runtime.MessageCorrelationResult;
import org.finos.flowave.bpm.engine.runtime.MessageCorrelationResultType;
import org.finos.flowave.bpm.engine.runtime.MessageCorrelationResultWithVariables;
import org.finos.flowave.bpm.engine.runtime.ProcessInstance;
import org.finos.flowave.bpm.engine.runtime.ProcessInstanceWithVariables;
import org.finos.flowave.bpm.engine.runtime.VariableInstance;
import org.finos.flowave.bpm.engine.task.Attachment;
import org.finos.flowave.bpm.engine.task.Comment;
import org.finos.flowave.bpm.engine.task.DelegationState;
import org.finos.flowave.bpm.engine.task.IdentityLink;
import org.finos.flowave.bpm.engine.task.IdentityLinkType;
import org.finos.flowave.bpm.engine.task.Task;
import org.finos.flowave.bpm.engine.task.TaskCountByCandidateGroupResult;
import org.finos.flowave.bpm.engine.variable.VariableMap;
import org.finos.flowave.bpm.engine.variable.Variables;
import org.finos.flowave.bpm.engine.variable.impl.value.ObjectValueImpl;
import org.finos.flowave.bpm.engine.variable.value.BytesValue;
import org.finos.flowave.bpm.engine.variable.value.ObjectValue;
