...
public class OptimizeRunningProcessInstanceRestServiceTest extends AbstractRestServiceTest {
  ...
  public static final String OPTIMIZE_RUNNING_PROCESS_INSTANCE_PATH =
    TEST_RESOURCE_ROOT_PATH + "/optimize/process-instance/running";
  ...
  public void testNoQueryParameters() {
    ...
    .when()
      .get(OPTIMIZE_RUNNING_PROCESS_INSTANCE_PATH);

    verify(mockedOptimizeService).getRunningHistoricProcessInstances(null, null, Integer.MAX_VALUE);
  ...
  public void testStartedAfterQueryParameter() {
    ...
    verify(mockedOptimizeService).getRunningHistoricProcessInstances(now, null, Integer.MAX_VALUE);
    verifyNoMoreInteractions(mockedOptimizeService);
  }
  ...
  public void testStartedAtQueryParameter() {
    ...
    verify(mockedOptimizeService).getRunningHistoricProcessInstances(null, now, Integer.MAX_VALUE);
    verifyNoMoreInteractions(mockedOptimizeService);
  }
