 ...
 */
package org.finos.flowave.bpm.engine.rest;

import static io.restassured.RestAssured.given;
import static io.restassured.path.json.JsonPath.from;
import static org.finos.flowave.bpm.engine.rest.helper.MockProvider.ANOTHER_EXAMPLE_ACTIVITY_ID;
import static org.finos.flowave.bpm.engine.rest.helper.MockProvider.ANOTHER_EXAMPLE_PROCESS_DEFINITION_ID;
import static org.finos.flowave.bpm.engine.rest.helper.MockProvider.ANOTHER_EXAMPLE_PROCESS_INSTANCE_ID;
import static org.finos.flowave.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_ID;
import static org.finos.flowave.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_JOBS_PER_SEED;
import static org.finos.flowave.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_JOB_DEFINITION_ID;
import static org.finos.flowave.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_TOTAL_JOBS;
import static org.finos.flowave.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_TYPE;
import static org.finos.flowave.bpm.engine.rest.helper.MockProvider.EXAMPLE_INVOCATIONS_PER_BATCH_JOB;
import static org.finos.flowave.bpm.engine.rest.helper.MockProvider.EXAMPLE_MONITOR_JOB_DEFINITION_ID;
import static org.finos.flowave.bpm.engine.rest.helper.MockProvider.EXAMPLE_SEED_JOB_DEFINITION_ID;
import static org.finos.flowave.bpm.engine.rest.helper.MockProvider.EXAMPLE_TENANT_ID;
import static org.finos.flowave.bpm.engine.rest.helper.MockProvider.NON_EXISTING_ACTIVITY_ID;
import static org.finos.flowave.bpm.engine.rest.helper.MockProvider.NON_EXISTING_PROCESS_DEFINITION_ID;
import static org.finos.flowave.bpm.engine.rest.helper.MockProvider.createMockBatch;
import static org.finos.flowave.bpm.engine.rest.helper.NoIntermediaryInvocation.immediatelyAfter;
import static org.assertj.core.api.Assertions.assertThat;
import static org.finos.flowave.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.*;
...
import org.finos.flowave.bpm.engine.impl.ProcessInstanceQueryImpl;
import org.finos.flowave.bpm.engine.migration.MigratingActivityInstanceValidationReport;
import org.finos.flowave.bpm.engine.migration.MigratingProcessInstanceValidationException;
import org.finos.flowave.bpm.engine.migration.MigratingProcessInstanceValidationReport;
import org.finos.flowave.bpm.engine.migration.MigratingTransitionInstanceValidationReport;
import org.finos.flowave.bpm.engine.migration.MigrationInstruction;
import org.finos.flowave.bpm.engine.migration.MigrationInstructionValidationReport;
import org.finos.flowave.bpm.engine.migration.MigrationPlan;
import org.finos.flowave.bpm.engine.migration.MigrationPlanBuilder;
import org.finos.flowave.bpm.engine.migration.MigrationPlanExecutionBuilder;
import org.finos.flowave.bpm.engine.migration.MigrationPlanValidationException;
import org.finos.flowave.bpm.engine.migration.MigrationPlanValidationReport;
import org.finos.flowave.bpm.engine.migration.MigrationVariableValidationReport;
import org.finos.flowave.bpm.engine.rest.dto.VariableValueDto;
import org.finos.flowave.bpm.engine.rest.dto.migration.MigrationInstructionDto;
import org.finos.flowave.bpm.engine.rest.dto.runtime.ProcessInstanceQueryDto;
import org.finos.flowave.bpm.engine.rest.helper.FluentAnswer;
import org.finos.flowave.bpm.engine.rest.helper.MockMigrationPlanBuilder;
import org.finos.flowave.bpm.engine.rest.helper.MockMigrationPlanBuilder.JoinedMigrationPlanBuilderMock;
import org.finos.flowave.bpm.engine.rest.util.container.TestContainerRule;
import org.finos.flowave.bpm.engine.rest.util.migration.MigrationExecutionDtoBuilder;
import org.finos.flowave.bpm.engine.rest.util.migration.MigrationPlanDtoBuilder;
...
import org.finos.flowave.bpm.engine.rest.util.migration.MigrationInstructionDtoBuilder;
...
public class MigrationRestServiceInteractionTest extends AbstractRestServiceTest {
  ...
  public void setUpRuntimeData() {
    ...
    when(migrationPlanExecutionBuilderMock.processInstanceIds(Mockito.<List<String>>any())).thenReturn(migrationPlanExecutionBuilderMock);

    when(runtimeServiceMock.newMigration(any())).thenReturn(migrationPlanExecutionBuilderMock);
  }
  ...
  public void generateMigrationPlanWithNullSourceProcessDefinition() {
    ...
    when(runtimeServiceMock.createMigrationPlan(isNull(), anyString()))
  ...
  public void generateMigrationPlanWithNullTargetProcessDefinition() {
    ...
    MigrationPlanBuilder migrationPlanBuilder = mock(MigrationPlanBuilder.class, Mockito.RETURNS_DEEP_STUBS);
    when(runtimeServiceMock.createMigrationPlan(anyString(), isNull()))
      .thenReturn(migrationPlanBuilder);
    when(
      migrationPlanBuilder
        .mapEqualActivities()
  ...
  public void executeMigrationPlanWithNullSourceActivityId() {
    ...
    when(migrationPlanBuilderMock.mapActivities(isNull(), anyString()))
      .thenThrow(new BadUserRequestException(message));
  ...
  public void executeMigrationPlanWithNullTargetActivityId() {
    ...
    when(migrationPlanBuilderMock.mapActivities(anyString(), isNull()))
      .thenThrow(new BadUserRequestException(message));
