 ...
 */
package org.finos.flowave.bpm.qa.rolling.update;
...
import org.finos.flowave.bpm.qa.rolling.update.scenarios.DeploymentWhichShouldBeDeletedScenario;
import org.finos.flowave.bpm.qa.rolling.update.scenarios.authorization.AuthorizationScenario;
import org.finos.flowave.bpm.qa.rolling.update.scenarios.batch.SetRemovalTimeToProcessInstanceScenario;
import org.finos.flowave.bpm.qa.rolling.update.scenarios.callactivity.ProcessWithCallActivityScenario;
import org.finos.flowave.bpm.qa.rolling.update.scenarios.cleanup.HistoryCleanupScenario;
import org.finos.flowave.bpm.qa.rolling.update.scenarios.eventSubProcess.ProcessWithEventSubProcessScenario;
import org.finos.flowave.bpm.qa.rolling.update.scenarios.externalTask.ProcessWithExternalTaskScenario;
import org.finos.flowave.bpm.qa.rolling.update.scenarios.mulltiInstance.ProcessWithMultiInstanceCallActivityScenario;
import org.finos.flowave.bpm.qa.rolling.update.scenarios.task.ProcessWithAsyncServiceTaskScenario;
import org.finos.flowave.bpm.qa.rolling.update.scenarios.task.ProcessWithParallelGatewayAndServiceTaskScenario;
import org.finos.flowave.bpm.qa.rolling.update.scenarios.task.ProcessWithParallelGatewayScenario;
import org.finos.flowave.bpm.qa.rolling.update.scenarios.task.ProcessWithUserTaskAndTimerScenario;
import org.finos.flowave.bpm.qa.rolling.update.scenarios.task.ProcessWithUserTaskScenario;
import org.finos.flowave.bpm.qa.rolling.update.scenarios.timestamp.IncidentTimestampUpdateScenario;
import org.finos.flowave.bpm.qa.rolling.update.scenarios.timestamp.JobTimestampsUpdateScenario;
import org.finos.flowave.bpm.qa.rolling.update.scenarios.variable.EmptyStringVariableScenario;
import org.finos.flowave.bpm.qa.upgrade.ScenarioRunner;
