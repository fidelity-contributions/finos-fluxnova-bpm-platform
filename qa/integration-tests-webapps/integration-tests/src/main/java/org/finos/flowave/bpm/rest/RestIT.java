...
import org.finos.flowave.bpm.AbstractWebIntegrationTest;
...
public class RestIT extends AbstractWebIntegrationTest {
  ...
  public void testComplexObjectJacksonSerialization() throws JSONException {
    ...
    for (int i = 0; i < definitionStatistics.length(); i++) {
      ...
      assertEquals("org.finos.flowave.bpm.engine.rest.dto.repository.ProcessDefinitionStatisticsResultDto", definitionStatistic.getString("@class"));
