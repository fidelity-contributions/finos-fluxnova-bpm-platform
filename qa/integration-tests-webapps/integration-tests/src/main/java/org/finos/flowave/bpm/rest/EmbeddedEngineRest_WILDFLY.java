 ...
 */
package org.finos.flowave.bpm.rest;

import org.finos.flowave.bpm.rest.beans.CustomProcessEngineProvider;
import org.finos.flowave.bpm.rest.beans.CustomRestApplication;
...
public class EmbeddedEngineRest_WILDFLY {
  ...
  public static WebArchive createDeployment() {
    ...
    WebArchive archive = ShrinkWrap.create(WebArchive.class, "embedded-engine-rest.war")
        ...
        .addAsManifestResource("org.finos.flowave.bpm.engine.rest.spi.ProcessEngineProvider", "META-INF/services/org.finos.flowave.bpm.engine.rest.spi.ProcessEngineProvider")
  ...
  private static JavaArchive[] getEngineRestClasses() {
    String coordinates = "org.finos.flowave.bpm:camunda-engine-rest:jar:classes:" + System.getProperty("projectversion");
