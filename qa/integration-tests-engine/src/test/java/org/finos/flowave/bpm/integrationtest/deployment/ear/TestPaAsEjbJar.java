...
import org.finos.flowave.bpm.application.impl.ejb.DefaultEjbProcessApplication;
...
import org.finos.flowave.bpm.integrationtest.deployment.ear.beans.NamedCdiBean;
...
public class TestPaAsEjbJar extends AbstractFoxPlatformIntegrationTest {
   ...
   *        |-- org/finos/flowave/bpm/integrationtest/deployment/ear/paAsEjbJar-process.bpmn20.xml
  ...
  public static EnterpriseArchive paAsEjbModule() throws Exception {
    ...
    JavaArchive processArchive1Jar = ShrinkWrap.create(JavaArchive.class, "pa.jar")
      ...
      .addAsResource("org/finos/flowave/bpm/integrationtest/deployment/ear/paAsEjbJar-process.bpmn20.xml")
      .addAsResource("META-INF/processes.xml", "META-INF/processes.xml")
      .addAsManifestResource("org/finos/flowave/bpm/integrationtest/beans.xml", "beans.xml");
