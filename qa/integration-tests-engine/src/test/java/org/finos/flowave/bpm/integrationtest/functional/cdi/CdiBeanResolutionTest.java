...
import org.finos.flowave.bpm.engine.cdi.CdiStandaloneProcessEngineConfiguration;
import org.finos.flowave.bpm.engine.cdi.impl.util.ProgrammaticBeanLookup;
import org.finos.flowave.bpm.integrationtest.functional.cdi.beans.ExampleBean;
...
public class CdiBeanResolutionTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
            ...
            .addAsResource("org/finos/flowave/bpm/integrationtest/functional/cdi/CdiBeanResolutionTest.testResolveBean.bpmn20.xml")
            .addAsResource("org/finos/flowave/bpm/integrationtest/functional/cdi/CdiBeanResolutionTest.testResolveBeanFromJobExecutor.bpmn20.xml");
  }
