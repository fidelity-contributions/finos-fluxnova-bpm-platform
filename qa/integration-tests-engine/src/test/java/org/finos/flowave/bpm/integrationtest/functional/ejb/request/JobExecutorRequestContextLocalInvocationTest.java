 ...
 */
package org.finos.flowave.bpm.integrationtest.functional.ejb.request;

import org.finos.flowave.bpm.engine.runtime.ProcessInstance;
import org.finos.flowave.bpm.engine.task.Task;
import org.finos.flowave.bpm.integrationtest.functional.cdi.beans.RequestScopedDelegateBean;
import org.finos.flowave.bpm.integrationtest.functional.ejb.request.beans.InvocationCounter;
import org.finos.flowave.bpm.integrationtest.functional.ejb.request.beans.InvocationCounterDelegateBean;
import org.finos.flowave.bpm.integrationtest.functional.ejb.request.beans.InvocationCounterDelegateBeanLocal;
import org.finos.flowave.bpm.integrationtest.functional.ejb.request.beans.InvocationCounterService;
import org.finos.flowave.bpm.integrationtest.functional.ejb.request.beans.InvocationCounterServiceBean;
import org.finos.flowave.bpm.integrationtest.functional.ejb.request.beans.InvocationCounterServiceLocal;
import org.finos.flowave.bpm.integrationtest.functional.ejb.request.beans.RequestScopedSFSBDelegate;
...
public class JobExecutorRequestContextLocalInvocationTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("org/finos/flowave/bpm/integrationtest/functional/ejb/request/JobExecutorRequestContextLocalInvocationTest.testContextPropagationEjbLocal.bpmn20.xml")
      .addAsWebInfResource("org/finos/flowave/bpm/integrationtest/functional/ejb/request/jboss-deployment-structure.xml","jboss-deployment-structure.xml");
  }
...
//    "global/" +
//    "service/" +
//    "InvocationCounterServiceBean!org.finos.flowave.bpm.integrationtest.functional.cdi.beans.InvocationCounterServiceLocal");
//
