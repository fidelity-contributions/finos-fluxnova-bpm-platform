 ...
 */
package org.finos.flowave.bpm.integrationtest.functional.spring;
...
import org.finos.flowave.bpm.integrationtest.functional.spring.beans.ErrorDelegate;
import org.finos.flowave.bpm.integrationtest.functional.spring.beans.RetryConfig;
...
public class SpringRetryConfigurationTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    ...
    return ShrinkWrap.create(WebArchive.class, "test.war")
      ...
      .addAsResource("org/finos/flowave/bpm/integrationtest/functional/RetryConfigurationTest.testResolveRetryConfigBean.bpmn20.xml")
      ...
      .addAsWebInfResource("org/finos/flowave/bpm/integrationtest/functional/spring/web.xml", "web.xml")

      // spring application context & libs
      .addAsWebInfResource("org/finos/flowave/bpm/integrationtest/functional/spring/SpringRetryConfigurationTest-context.xml", "applicationContext.xml")
      .addAsLibraries(DeploymentHelper.getEngineSpring())

      // adding module dependency on process engine module (jboss only)
      .addAsManifestResource("org/finos/flowave/bpm/integrationtest/functional/spring/jboss-deployment-structure.xml", "jboss-deployment-structure.xml");
  }
