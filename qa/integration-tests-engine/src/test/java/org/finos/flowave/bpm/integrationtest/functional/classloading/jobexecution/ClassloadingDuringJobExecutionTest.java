 ...
 */
package org.finos.flowave.bpm.integrationtest.functional.classloading.jobexecution;
...
public class ClassloadingDuringJobExecutionTest extends AbstractFoxPlatformIntegrationTest {
  protected static String process =
      ...
      "            <camunda:script scriptFormat=\"Javascript\">throw new org.finos.flowave.bpm.engine.delegate.BpmnError(\"Test error thrown\");</camunda:script>\r\n" +
