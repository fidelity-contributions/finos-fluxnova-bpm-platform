...
public class FeelEngineTest extends AbstractFoxPlatformIntegrationTest {
  ...
  protected static final String PATH = "org/finos/flowave/bpm/integrationtest/functional/spin/feel/";
  ...
  public void testFeelEngineComplexContext() {
    // Mapping complex FEEL context into Java requires the org.finos.flowave.feel.impl.JavaValueMapper SPI to be registered
    // when
