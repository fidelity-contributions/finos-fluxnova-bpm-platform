...
import org.finos.flowave.bpm.integrationtest.jobexecutor.beans.PriorityBean;
...
public class JobPrioritizationFailureJavaSerializationTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static final String VARIABLE_CLASS_NAME = "org.finos.flowave.bpm.integrationtest.jobexecutor.beans.PriorityBean";
  ...
  public static WebArchive createDeployment() {
    final WebArchive webArchive = initWebArchiveDeployment("paJavaSerialization1.war", "org/finos/flowave/bpm/integrationtest/processes-javaSerializationEnabled-pa1.xml")
      .addClass(PriorityBean.class)
      .addAsResource("org/finos/flowave/bpm/integrationtest/jobexecutor/JobPrioritizationTest.priorityProcess.bpmn20.xml");
  ...
  public static WebArchive createDummyClientDeployment() {
    final WebArchive webArchive = initWebArchiveDeployment("paJavaSerialization2.war", "org/finos/flowave/bpm/integrationtest/processes-javaSerializationEnabled-pa2.xml")
