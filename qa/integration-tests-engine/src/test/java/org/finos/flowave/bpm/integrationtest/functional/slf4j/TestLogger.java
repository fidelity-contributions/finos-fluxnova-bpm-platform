 ...
 */
package org.finos.flowave.bpm.integrationtest.functional.slf4j;
...
public class TestLogger extends BaseLogger {
  ...
  public static final TestLogger INSTANCE = BaseLogger.createLogger(TestLogger.class, "QA", "org.finos.flowave.bpm.qa", "01");
