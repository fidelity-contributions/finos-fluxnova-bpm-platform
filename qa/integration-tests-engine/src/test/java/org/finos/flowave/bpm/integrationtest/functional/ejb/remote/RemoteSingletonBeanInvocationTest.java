 ...
 */
package org.finos.flowave.bpm.integrationtest.functional.ejb.remote;

import org.finos.flowave.bpm.engine.runtime.ProcessInstance;
import org.finos.flowave.bpm.integrationtest.functional.ejb.remote.bean.BusinessInterface;
import org.finos.flowave.bpm.integrationtest.functional.ejb.remote.bean.RemoteSingletonBean;
import org.finos.flowave.bpm.integrationtest.functional.ejb.remote.bean.RemoteSingletonBeanClientDelegateBean;
...
public class RemoteSingletonBeanInvocationTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("org/finos/flowave/bpm/integrationtest/functional/ejb/remote/RemoteSingletonBeanInvocationTest.testInvokeBean.bpmn20.xml");
  }
