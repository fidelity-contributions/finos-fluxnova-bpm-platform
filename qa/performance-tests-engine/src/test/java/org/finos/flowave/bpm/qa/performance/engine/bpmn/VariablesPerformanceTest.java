 ...
 */
package org.finos.flowave.bpm.qa.performance.engine.bpmn;

import static org.finos.flowave.bpm.qa.performance.engine.steps.PerfTestConstants.VARIABLE1;
import static org.finos.flowave.bpm.qa.performance.engine.steps.PerfTestConstants.VARIABLE10;
import static org.finos.flowave.bpm.qa.performance.engine.steps.PerfTestConstants.VARIABLE2;
import static org.finos.flowave.bpm.qa.performance.engine.steps.PerfTestConstants.VARIABLE3;
import static org.finos.flowave.bpm.qa.performance.engine.steps.PerfTestConstants.VARIABLE4;
import static org.finos.flowave.bpm.qa.performance.engine.steps.PerfTestConstants.VARIABLE5;
import static org.finos.flowave.bpm.qa.performance.engine.steps.PerfTestConstants.VARIABLE6;
import static org.finos.flowave.bpm.qa.performance.engine.steps.PerfTestConstants.VARIABLE7;
import static org.finos.flowave.bpm.qa.performance.engine.steps.PerfTestConstants.VARIABLE8;
import static org.finos.flowave.bpm.qa.performance.engine.steps.PerfTestConstants.VARIABLE9;

import java.util.HashMap;
import org.finos.flowave.bpm.engine.test.Deployment;
import org.finos.flowave.bpm.qa.performance.engine.junit.ProcessEnginePerformanceTestCase;
import org.finos.flowave.bpm.qa.performance.engine.steps.StartProcessInstanceStep;
...
public class VariablesPerformanceTest extends ProcessEnginePerformanceTestCase {
  ...
  @Deployment(resources =
    {"org/finos/flowave/bpm/qa/performance/engine/bpmn/StartEventPerformanceTest.noneStartEvent.bpmn"})
