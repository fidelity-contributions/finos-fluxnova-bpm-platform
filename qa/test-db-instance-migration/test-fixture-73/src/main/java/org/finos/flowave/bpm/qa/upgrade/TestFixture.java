...
import org.finos.flowave.bpm.qa.upgrade.scenarios.compensation.InterruptingEventSubProcessNestedCompensationScenario;
import org.finos.flowave.bpm.qa.upgrade.scenarios.compensation.NestedCompensationScenario;
import org.finos.flowave.bpm.qa.upgrade.scenarios.compensation.NestedMultiInstanceCompensationScenario;
import org.finos.flowave.bpm.qa.upgrade.scenarios.compensation.NonInterruptingEventSubProcessCompensationScenario;
import org.finos.flowave.bpm.qa.upgrade.scenarios.compensation.ParallelMultiInstanceCompensationScenario;
import org.finos.flowave.bpm.qa.upgrade.scenarios.compensation.SequentialMultiInstanceCompensationScenario;
import org.finos.flowave.bpm.qa.upgrade.scenarios.compensation.SingleActivityCompensationScenario;
import org.finos.flowave.bpm.qa.upgrade.scenarios.compensation.SingleActivityConcurrentCompensationScenario;
import org.finos.flowave.bpm.qa.upgrade.scenarios.job.JobMigrationScenario;
import org.finos.flowave.bpm.qa.upgrade.scenarios.sentry.SentryScenario;
