...
public class MultiInstanceReceiveTaskScenario {
  ...
  public static String deployProcessParallel() {
    return "org/finos/flowave/bpm/qa/upgrade/multiinstance/parallelMultiInstanceReceiveTask.bpmn20.xml";
  }

  @Deployment
  public static String deployProcessSequential() {
    return "org/finos/flowave/bpm/qa/upgrade/multiinstance/sequentialMultiInstanceReceiveTask.bpmn20.xml";
  }
