 ...
 */
package org.finos.flowave.bpm.qa.upgrade.scenarios.boundary;
...
public class NestedNonInterruptingBoundaryEventOnInnerSubprocessScenario {
  ...
  public static String deployTimerBoundary() {
    return "org/finos/flowave/bpm/qa/upgrade/boundary/nestedNonInterruptingTimerBoundaryEventOnInnerSubprocess.bpmn20.xml";
  }

  @Deployment
  public static String deployMessageBoundary() {
    return "org/finos/flowave/bpm/qa/upgrade/boundary/nestedNonInterruptingMessageBoundaryEventOnInnerSubprocess.bpmn20.xml";
  }
  ...
  public static ScenarioSetup initMessage() {
    return new ScenarioSetup() {
      public void execute(ProcessEngine engine, String scenarioName) {
        engine
          .getRuntimeService()
          .startProcessInstanceByKey("NestedNonInterruptingMessageBoundaryEventOnInnerSubprocessScenario", scenarioName);
    ...
    return new ScenarioSetup() {
      public void execute(ProcessEngine engine, String scenarioName) {
        ProcessInstance instance = engine
          .getRuntimeService()
          .startProcessInstanceByKey("NestedNonInterruptingTimerBoundaryEventOnInnerSubprocessScenario", scenarioName);
