...
import org.finos.flowave.bpm.qa.upgrade.job.SetJobRetriesWithDueDateScenario;

public class TestFixture {

  public static final String ENGINE_VERSION = "7.18.0";
  ...
  public static void main(String... args) {
    ...
    // example scenario setup
     runner.setupScenarios(SetJobRetriesWithDueDateScenario.class);
